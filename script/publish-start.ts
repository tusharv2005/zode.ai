...
const skipNotes = process.env["ZODE_SKIP_NOTES"] === "1" // zodecode_change
if (skipNotes) console.log("changelog skipped: ZODE_SKIP_NOTES=1") // zodecode_change
...
if (!Script.preview) {
  ...
  // zodecode_change start - skip draft flag when ZODE_SKIP_NOTES=1 (used by publish-stable.yml which doesn't have a publish-complete step)
