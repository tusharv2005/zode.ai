...
Generates UPCOMING_CHANGELOG.md by running the zode changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for zode run (default: low)
      --quiet            Suppress zode command output unless it fails
...
const cmd = ["zode", "run"] // zodecode_change - opencode -> zode
