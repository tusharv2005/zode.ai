...
const forbidden: { pattern: string; reason: string; allow?: string[] }[] = [
  { pattern: "opncd.ai/s/", reason: "legacy upstream share URL pattern" },
  {
    ...
    reason: "upstream repo URL -- should be Zode-Org/zodecode",
    allow: [
      "AGENTS.md",
      "README.md",
      ".opencode/glossary/",
      "packages/zode-vscode/AGENTS.md",
      "packages/zode-docs/source-links.md",
      "patches/",
      "script/upstream/",
    ],
  },
  {
    ...
    reason: "old upstream org path -- should be Zode-Org/zodecode",
    allow: [".zode/agent/upstream-merge.md", "script/upstream/"],
  },
