...
import { getAvailableUpstreamVersions, getCurrentZodeVersion } from "./utils/version"
...
async function main() {
  ...
  const zodeVersion = await getCurrentZodeVersion()

  console.log()
  success(`Current Zode version: ${zodeVersion}`)
  console.log()
