...
export interface MergeConfig {
  /** Package name mappings from opencode to zode */
  packageMappings: PackageMapping[]

  /** Files to always keep Zode's version (never take upstream changes) */
  keepOurs: string[]

  /** Files to skip entirely (don't add from upstream, remove if added) */
  skipFiles: string[]

  /** Files that should take upstream version and apply Zode branding transforms */
  ...
  /** Directories that are Zode-specific and should be preserved */
  zodeDirectories: string[]
...
export const defaultConfig: MergeConfig = {
  packageMappings: [
    ...
    { from: "@opencode-ai/sdk", to: "@zodecode/sdk" },
    { from: "@opencode-ai/plugin", to: "@zodecode/plugin" },
  ],
  ...
  keepOurs: [
    ...
    // Zode-specific command files
    ".opencode/command/commit.md",
    // Zode-specific publish scripts
    ...
    // GitHub Action - Zode version is fully ported and complete
    "github/action.yml",
    "github/README.md",
  ...
  // Files that only exist in upstream and should NOT be added to Zode
  // These are removed during merge if they appear
  skipFiles: [
    // Translated README files (Zode doesn't have these)
    "README.ar.md",
    "README.bn.md",
    "README.br.md",
    "README.bs.md",
    ...
    // Stats file
    "STATS.md",
    // Team members file (Zode doesn't maintain this upstream list)
    ".github/TEAM_MEMBERS",
    // Workflows that don't exist in Zode
    ".github/workflows/update-nix-hashes.yml",
    ".github/workflows/deploy.yml",
    ".github/workflows/docs-update.yml",
    ".github/workflows/docs-locale-sync.yml",
    // Workflows deleted in Zode (replaced or no longer needed)
    ".github/workflows/opencode.yml",
    ".github/workflows/publish-vscode.yml",
    // VS Code example configs (Zode ships real .vscode/* files)
    ".vscode/launch.example.json",
    ".vscode/settings.example.json",
    // Nix files for packages Zode has removed / replaced with nix/zode.nix
    "nix/desktop.nix",
    "nix/opencode.nix",
    // opencode CLI bin (Zode uses its own build output)
    "packages/opencode/bin/opencode",
    // Removed prompt file
    "packages/opencode/src/session/prompt/build-switch.txt",
    // Vouch files (Zode doesn't use Vouch).
    ...
    // SST infrastructure files (Zode is CLI-only, no hosted platform)
    "sst.config.ts",
    "sst-env.d.ts",
  ...
  // i18n translation files that need Zode branding transforms
