 ...
 *
 * Transforms string literals containing opencode references to zode:
 * - "opencode-ai" -> "@zodecode/cli"
 * - "npx opencode" -> "npx @zodecode/cli"
 * - etc.
 *
 * Usage:
...
const STRING_REPLACEMENTS: StringReplacement[] = [
  ...
  { pattern: /\bopencode-ai\b/g, replacement: "@zodecode/cli" },
  ...
  // CLI commands
  { pattern: /\bnpx opencode\b/g, replacement: "npx @zodecode/cli" },
  { pattern: /\bbun add opencode\b/g, replacement: "bun add @zodecode/cli" },
  { pattern: /\bnpm install opencode\b/g, replacement: "npm install @zodecode/cli" },
  { pattern: /\bnpm i opencode\b/g, replacement: "npm i @zodecode/cli" },

  // Database filename
  { pattern: /\bopencode\.db\b/g, replacement: "zode.db" },

  // Binary name references (be careful with these)
  { pattern: /\bopencode upgrade\b/g, replacement: "zode upgrade" },
  ...
  { pattern: /\bVITE_OPENCODE_/g, replacement: "VITE_ZODE_" },
  { pattern: /\b_EXTENSION_OPENCODE_/g, replacement: "_EXTENSION_ZODE_" },
]
