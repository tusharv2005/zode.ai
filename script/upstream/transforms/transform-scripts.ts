 ...
 * by transforming them from anomalyco/opencode to Zode-Org/zodecode.
 */
...
const SCRIPT_REPLACEMENTS: ScriptReplacement[] = [
  // GitHub API URLs
  {
    ...
    replacement: "api.github.com/repos/Zode-Org/zodecode",
    description: "GitHub API URL",
  },
  {
    pattern: /\/repos\/anomalyco\/opencode/g,
    replacement: "/repos/Zode-Org/zodecode",
  ...
  // gh CLI commands
  {
    ...
    replacement: 'gh api "/repos/Zode-Org/zodecode',
