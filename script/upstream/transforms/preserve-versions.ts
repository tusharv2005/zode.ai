#!/usr/bin/env bun
/**
 * Preserve Zode package versions during upstream merge
 *
 * This script ensures that Zode's package versions are not overwritten
...
/**
 * Get the current Zode version from the main package.json
 */
