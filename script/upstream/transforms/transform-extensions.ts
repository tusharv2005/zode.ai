#!/usr/bin/env bun
/**
 * Transform extension files (Zed, etc.) with Zode branding
 *
 * This script handles extension configuration files by transforming
 * OpenCode references to Zode.
 */
...
const EXTENSION_REPLACEMENTS: ExtensionReplacement[] = [
  ...
  },
  {
    ...
    replacement: 'description = "Zode - AI coding assistant"',
  ...
  // GitHub/Repository references
  {
    ...
    replacement: 'repository = "https://github.com/Zode-Org/zodecode"',
  ...
  // Binary/command references
  {
    ...
    replacement: 'command = "zode"',
    description: "Command name",
    fileTypes: [".toml"],
  },

  // Generic OpenCode -> Zode in strings
  {
    pattern: /"OpenCode"/g,
    replacement: '"Zode"',
  ...
  },
  {
    ...
    replacement: "Zode language server",
