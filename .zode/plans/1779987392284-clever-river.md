...
## Findings
- Runtime colorization exists only in `frontend/src/main/kotlin/ai/zodecode/client/ui/SvgIconColorizer.kt`.
- The only production caller is `frontend/src/main/kotlin/ai/zodecode/client/session/scroll/ScrollButtonIcon.kt`.
...
- Other used frontend icons already have light/dark pairs:
  ...
  - `zode.svg` / `zode_dark.svg`
  - `zode-content.svg` / `zode-content_dark.svg`
  - `plus.svg` / `plus_dark.svg` exists, though no current direct source reference was found.
  - `zode@20x20.svg` / `zode@20x20_dark.svg` exists, though no current direct source reference was found.
...
2. Delete `frontend/src/main/kotlin/ai/zodecode/client/ui/SvgIconColorizer.kt` after confirming no callers remain.
...
6. Run the smallest relevant verification from `packages/zode-jetbrains/`:
   - `bun run typecheck` or `./gradlew typecheck`.

## Files Expected To Change
- `packages/zode-jetbrains/frontend/src/main/kotlin/ai/zodecode/client/session/scroll/ScrollButtonIcon.kt`
- `packages/zode-jetbrains/frontend/src/main/kotlin/ai/zodecode/client/session/ui/style/SessionUiStyle.kt`
- Delete `packages/zode-jetbrains/frontend/src/main/kotlin/ai/zodecode/client/ui/SvgIconColorizer.kt`
- Add `packages/zode-jetbrains/src/main/resources/META-INF/pluginIcon_dark.svg`
