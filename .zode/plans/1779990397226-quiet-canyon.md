...
- The relevant files are `packages/zode-jetbrains/frontend/src/main/kotlin/ai/zodecode/client/session/SessionUi.kt`, `.../scroll/SessionScroll.kt`, `.../views/question/QuestionView.kt`, `.../views/permission/PermissionView.kt`, `.../views/LoginRequiredView.kt`, `.../views/base/BaseQuestionView.kt`, and `frontend/src/test/kotlin/ai/zodecode/client/session/SessionScrollTest.kt`.
...
- From `packages/zode-jetbrains/`, run `./gradlew test --tests "ai.zodecode.client.session.SessionScrollTest"`.
- From `packages/zode-jetbrains/`, run `./gradlew typecheck`.
