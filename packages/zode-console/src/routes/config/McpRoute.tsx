...
import { Button } from "@zodecode/zode-web-ui/button"
import { Card } from "@zodecode/zode-web-ui/card"
import { IconButton } from "@zodecode/zode-web-ui/icon-button"
import { CountTag, Tag } from "@zodecode/zode-web-ui/tag"
import { StatusTag } from "@zodecode/zode-web-ui/status-tag"
    ...
    <Show when={state.snap()}>
      {(_data) => (
        <ConfigPage
          ...
          description="Install, configure, and manage Model Context Protocol servers available to Zode agents."
          actions={
            <>
            ...
            <aside class="provider-drawer mcp-drawer" aria-label="Install MCP server">
              <header class="drawer-header">
                <div>
                  ...
                  <span>Browse the Zode Marketplace MCP catalog and install into the current settings scope.</span>
                </div>
