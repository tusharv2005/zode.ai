export const dict = {
  ...
  "provider.connect.zodeGateway.byok.suffix": "をご利用ください。",

  // Provider dialog translations
  "dialog.provider.group.recommended": "おすすめ",
  "dialog.provider.zode.note": "500以上のAIモデルにアクセス",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "このプロジェクトでは Zode のスナップショットを無効にします。Zode による変更の取り消し/やり直しはできなくなりますが、git は引き続きすべてを追跡します。",
