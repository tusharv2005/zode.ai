export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway, kodlama ajanları için optimize edilmiş güvenilir modellere erişim sağlar.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "API anahtarınızı almak için ",
  "provider.connect.zodeGateway.visit.link": "kilo.ai",
  "provider.connect.zodeGateway.visit.suffix": " adresini ziyaret edin.",
  "provider.connect.zodeGateway.byok.prefix": "Daha fazla kullanım istatistiği için ",
  "provider.connect.zodeGateway.byok.link": "Zode's Gateway üzerinden BYOK",
  "provider.connect.zodeGateway.byok.suffix": " kullanın.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Önerilen",
  "dialog.provider.zode.note": "500+ AI modeline erişim",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Bu proje için Zode anlık görüntülerini kapat. Zode değişiklikleri için geri alma/yeniden yapmayı kaybedersiniz, ancak git her şeyi izlemeye devam eder.",
