export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway zapewnia dostęp do wyselekcjonowanego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodowania.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "Odwiedź ",
  "provider.connect.zodeGateway.visit.link": "__PRESERVE_ZODE_AI__",
  "provider.connect.zodeGateway.visit.suffix": ", aby otrzymać swój klucz API.",
  "provider.connect.zodeGateway.byok.prefix": "Aby uzyskać więcej statystyk użycia, użyj ",
  "provider.connect.zodeGateway.byok.link": "BYOK przez Zode's Gateway",
  "provider.connect.zodeGateway.byok.suffix": ".",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Polecane",
  "dialog.provider.zode.note": "Dostęp do ponad 500 modeli AI",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Wyłącz snapshoty Zode dla tego projektu. Stracisz cofanie/przywracanie zmian Zode, ale git nadal śledzi wszystko.",
