// Zode-specific translations and overrides
...
export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway ti offre una selezione curata di modelli affidabili e ottimizzati per agenti di coding.",
  "provider.connect.zodeGateway.line2":
    "Con una sola API key puoi accedere a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.zodeGateway.visit.prefix": "Visita ",
  "provider.connect.zodeGateway.visit.link": "__PRESERVE_ZODE_AI__",
  "provider.connect.zodeGateway.visit.suffix": " per ottenere la tua API key.",
  "provider.connect.zodeGateway.byok.prefix": "Per ulteriori statistiche sull'utilizzo, utilizza ",
  "provider.connect.zodeGateway.byok.link": "BYOK tramite Zode's Gateway",
  "provider.connect.zodeGateway.byok.suffix": ".",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Consigliati",
  "dialog.provider.zode.note": "Accesso a oltre 500 modelli AI",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Disattiva gli snapshot di Zode per questo progetto. Perderai annulla/ripeti sulle modifiche ai file fatte da Zode, ma git continuerà a tracciare tutto.",
