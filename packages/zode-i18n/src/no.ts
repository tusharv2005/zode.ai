export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway gir deg tilgang til et utvalgt sett med pålitelige, optimaliserte modeller for kodingsagenter.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "Besøk ",
  "provider.connect.zodeGateway.visit.link": "__PRESERVE_ZODE_AI__",
  "provider.connect.zodeGateway.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.zodeGateway.byok.prefix": "For mer bruksstatistikk, bruk ",
  ...
  "dialog.provider.zode.note": "Tilgang til 500+ AI-modeller",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå av Zodes snapshots for dette prosjektet. Du mister angre/gjør om for Zode-endringer, men git fortsetter å spore alt.",
