export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway надає доступ до добірки надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "Відвідайте ",
  "provider.connect.zodeGateway.visit.link": "__PRESERVE_ZODE_AI__",
  "provider.connect.zodeGateway.visit.suffix": " щоб отримати свій API-ключ.",
  "provider.connect.zodeGateway.byok.prefix": "Для отримання додаткової статистики використання використовуйте ",
  ...
  "dialog.provider.zode.note": "Доступ до 500+ моделей ШІ",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Вимкніть знімки Zode для цього проєкту. Ви втратите скасування/повторення для змін Zode, але git продовжить відстежувати все.",
