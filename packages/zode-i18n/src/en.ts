...
export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.zodeGateway.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.zodeGateway.visit.prefix": "Visit ",
  "provider.connect.zodeGateway.visit.link": "__PRESERVE_ZODE_AI__",
  "provider.connect.zodeGateway.visit.suffix": " to collect your API key.",
  "provider.connect.zodeGateway.byok.prefix": "For more usage stats, ",
  ...
  "dialog.provider.zode.note": "Access 500+ AI models",
  ...
  // are still what the backend matches on (see packages/opencode/src/zodecode/plan-followup.ts).
  ...
  // packages/opencode/src/zodecode/snapshot/track.ts.
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Turn off Zode's snapshots for this project. You will lose undo/redo of Zode file changes, but git still tracks everything.",
