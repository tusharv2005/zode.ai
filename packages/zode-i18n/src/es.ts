export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway te da acceso a un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación.",
  ...
  "provider.connect.zodeGateway.visit.suffix": " para obtener tu clave API.",
  "provider.connect.zodeGateway.byok.prefix": "Para más estadísticas de uso, utiliza ",
  "provider.connect.zodeGateway.byok.link": "BYOK a través de Zode's Gateway",
  "provider.connect.zodeGateway.byok.suffix": ".",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Recomendados",
  "dialog.provider.zode.note": "Acceso a más de 500 modelos de IA",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Apaga las instantáneas de Zode para este proyecto. Perderás deshacer/rehacer de los cambios de Zode, pero git seguirá rastreando todo.",
