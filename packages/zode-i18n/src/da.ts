export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway giver dig adgang til et udvalgt sæt pålidelige, optimerede modeller til kodningsagenter.",
  "provider.connect.zodeGateway.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.zodeGateway.visit.prefix": "Besøg ",
  "provider.connect.zodeGateway.visit.link": "kilo.ai",
  "provider.connect.zodeGateway.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.zodeGateway.byok.prefix": "For flere brugsstatistikker, brug ",
  ...
  "dialog.provider.zode.note": "Adgang til 500+ AI-modeller",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Slå Zodes snapshots fra for dette projekt. Du mister fortryd/gentag for Zode-ændringer, men git sporer stadig alt.",
