export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "O Zode Gateway oferece acesso a um conjunto selecionado de modelos confiáveis e otimizados para agentes de codificação.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "Visite ",
  "provider.connect.zodeGateway.visit.link": "kilo.ai",
  "provider.connect.zodeGateway.visit.suffix": " para obter sua chave de API.",
  "provider.connect.zodeGateway.byok.prefix": "Para mais estatísticas de uso, utilize ",
  ...
  "dialog.provider.zode.note": "Acesso a mais de 500 modelos de IA",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Desligue os snapshots do Zode para este projeto. Você perde desfazer/refazer das mudanças feitas pelo Zode, mas o git continua rastreando tudo.",
