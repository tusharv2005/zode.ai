export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway bietet Ihnen Zugang zu einer kuratierten Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.zodeGateway.byok.suffix": " nutzen.",

  // Provider dialog translations
  "dialog.provider.group.recommended": "Empfohlen",
  "dialog.provider.zode.note": "Zugriff auf 500+ KI-Modelle",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Zode-Snapshots für dieses Projekt ausschalten. Rückgängig/Wiederherstellen für Zode-Änderungen ist nicht mehr möglich, aber git verfolgt weiterhin alles.",
