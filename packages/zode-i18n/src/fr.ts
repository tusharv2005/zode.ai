export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway vous donne accès à une sélection de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "Visitez ",
  "provider.connect.zodeGateway.visit.link": "kilo.ai",
  "provider.connect.zodeGateway.visit.suffix": " pour obtenir votre clé API.",
  "provider.connect.zodeGateway.byok.prefix": "Pour plus de statistiques d'utilisation, utilisez ",
  ...
  "dialog.provider.zode.note": "Accès à plus de 500 modèles d'IA",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Désactivez les instantanés Zode pour ce projet. Vous perdez l'annulation/restauration des modifications faites par Zode, mais git continue de tout suivre.",
