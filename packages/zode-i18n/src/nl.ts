...
export const dict = {
  ...
  "provider.connect.zodeGateway.line1":
    "Zode Gateway geeft je toegang tot een gecureerde set van betrouwbare, geoptimaliseerde modellen voor coding agents.",
  ...
  "provider.connect.zodeGateway.visit.prefix": "Bezoek ",
  "provider.connect.zodeGateway.visit.link": "__PRESERVE_ZODE_AI__",
  "provider.connect.zodeGateway.visit.suffix": " om je API key op te halen.",
  "provider.connect.zodeGateway.byok.prefix": "Voor meer gebruiksstatistieken, gebruik ",
  ...
  "dialog.provider.zode.note": "Toegang tot 500+ AI modellen",
  ...
  "snapshot.slowRepo.answer.disable.description":
    "Zet Zode-snapshots uit voor dit project. Je verliest ongedaan maken/opnieuw doen van Zode-wijzigingen, maar git blijft alles volgen.",
