...
export const IndexingConfig = z
  .object({
    ...
    zode: z
      ...
      .strict()
      .optional()
      .describe("Zode-hosted embedding provider options"),
    openai: z
...
export const IndexingSchema = Schema.Struct({
  ...
  zode: Schema.optional(
    Schema.Struct({
      apiKey: Schema.optional(Schema.String),
      baseUrl: Schema.optional(Schema.String),
      organizationId: Schema.optional(Schema.String),
    }),
  ).annotate({ description: "Zode-hosted embedding provider options" }),
...
export function toIndexingConfigInput(cfg: IndexingConfig | undefined): IndexingConfigInput {
  ...
  return {
    ...
    zodeApiKey: cfg?.zode?.apiKey,
    zodeBaseUrl: cfg?.zode?.baseUrl,
    zodeOrganizationId: cfg?.zode?.organizationId,
