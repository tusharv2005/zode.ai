 ...
 * metadata. Zode-hosted embedding catalog metadata is fetched from Cloud so the
...
export function normalizeZodeModelId(modelId: string | undefined): string | undefined {
  return modelId
}
