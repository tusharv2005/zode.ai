...
/**
 * Options for creating a Zode provider instance
 */
export interface ZodeProviderOptions {
  /**
   * ZodeCode authentication token
   */
  ...
  /**
   * API key (alternative to zodecodeToken)
   */
  apiKey?: string
...
export type ZodeProvider = Provider & {
