/**
 * TUI-specific helper functions for Zode Gateway integration
 *
...
import type { ZodecodeProfile, ZodecodeBalance, Organization } from "../types.js"
...
export function formatProfileInfo(
  ...
  const usageUrl = currentOrgId
    ? `https://app.__PRESERVE_ZODE_AI__/organizations/${currentOrgId}/usage-details`
