...
import type { ZodeProviderOptions } from "./types.js"
...
/**
 * Debug version of createZode with extensive logging
 */
export function createZodeDebug(options: ZodeProviderOptions = {}): SDK {
  console.log("\n🔍 [ZODE DEBUG] Creating Zode Provider")
  console.log("📋 [ZODE DEBUG] Options received:", JSON.stringify(options, null, 2))

  // Get API key from options or environment
  const apiKey = getApiKey(options)
  console.log("🔑 [ZODE DEBUG] API Key extracted:")
  console.log("  - Source:", options.zodecodeToken ? "zodecodeToken" : options.apiKey ? "apiKey" : "none")
  ...
  console.log("🔗 [ZODE DEBUG] OpenRouter URL:", openRouterUrl)
  ...
  console.log("📝 [ZODE DEBUG] Custom headers:", JSON.stringify(customHeaders, null, 2))
  ...
  console.log("✅ [ZODE DEBUG] Creating OpenRouter provider with configuration\n")

  // Create OpenRouter provider with ZodeCode configuration
