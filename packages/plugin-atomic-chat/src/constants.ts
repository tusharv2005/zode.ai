/** Provider id and `zode.json` key (see https://atomic.chat and models.dev). */
...
export const LOG_PREFIX = '[@zodecode/plugin-atomic-chat]' as const

export const ATOMIC_CHAT_PLUGIN = '@zodecode/plugin-atomic-chat' as const
