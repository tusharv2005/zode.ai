...
import { dirname, isAbsolute, join, relative, resolve as pathResolve, sep } from "path" // zodecode_change - harden containment checks
...
// zodecode_change start - Windows-resilient mkdir -p.
...
export namespace AppFileSystem {
  ...
  export const layer = Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const ensureDir = Effect.fn("FileSystem.ensureDir")(function* (path: string) {
        // zodecode_change start - use mkdirSafe to tolerate Windows EEXIST
  ...
  export function contains(parent: string, child: string) {
    // zodecode_change start - reject cross-drive and escaped relative paths
