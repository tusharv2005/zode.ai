...
import { Icon, type IconProps } from "./icon" // zodecode_change: added Icon
...
export interface BasicToolProps {
  ...
  forceOpen?: boolean
  defer?: boolean
  hasDetails?: boolean // zodecode_change
  locked?: boolean
  animated?: boolean
  allowPendingToggle?: boolean // zodecode_change
  onSubtitleClick?: () => void
  onOpenChange?: (open: boolean) => void // zodecode_change
...
export function BasicTool(props: BasicToolProps) {
  ...
  const hasDetails = () => props.hasDetails ?? !!props.children // zodecode_change
  ...
  const handleOpenChange = (value: boolean) => {
    if (pending() && !props.allowPendingToggle) return // zodecode_change
    if (props.hideDetails) return // zodecode_change
    if (props.locked && !value) return
    setState("open", value)
    props.onOpenChange?.(value) // zodecode_change
  }
