...
import type { SessionStatus } from "@zodecode/sdk/v2"
...
export function SessionTurn(
  ...
  const pending = createMemo(() => {
    if (typeof props.active === "boolean" && typeof props.queued === "boolean") return // zodecode_change
    const messages = allMessages() ?? emptyMessages
  ...
  // zodecode_change start — restore queued feature
  ...
  const showThinking = createMemo(() => {
    ...
    if (queued()) return false // zodecode_change
