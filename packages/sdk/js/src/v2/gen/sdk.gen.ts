...
import type {
  ...
  ZodeAudioTranscriptionsErrors,
  ZodeAudioTranscriptionsResponses,
  ZodeClawChatCredentialsResponses,
  ZodeClawStatusErrors,
  ZodeClawStatusResponses,
  ZodeCloudSessionGetErrors,
  ZodeCloudSessionGetResponses,
  ZodeCloudSessionImportErrors,
  ZodeCloudSessionImportResponses,
  ZodeCloudSessionsErrors,
  ZodeCloudSessionsResponses,
  ZodecodeHeapSnapshotErrors,
  ZodecodeHeapSnapshotResponses,
  ZodecodeRemoveAgentErrors,
  ZodecodeRemoveAgentResponses,
  ZodecodeRemoveSkillErrors,
  ZodecodeRemoveSkillResponses,
  ZodecodeSessionImportMessageErrors,
  ZodecodeSessionImportMessageResponses,
  ZodecodeSessionImportPartErrors,
  ZodecodeSessionImportPartResponses,
  ZodecodeSessionImportProjectErrors,
  ZodecodeSessionImportProjectResponses,
  ZodecodeSessionImportSessionErrors,
  ZodecodeSessionImportSessionResponses,
  ZodeEditErrors,
  ZodeEditResponses,
  ZodeFimErrors,
  ZodeFimResponses,
  ZodeModesResponses,
  ZodeNotificationsErrors,
  ZodeNotificationsResponses,
  ZodeOrganizationSetErrors,
  ZodeOrganizationSetResponses,
  ZodeProfileErrors,
  ZodeProfileResponses,
  LspStatusResponses,
  McpAddErrors,
  McpAddResponses,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new ZodeClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Zode system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Zode system.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Zode configuration settings and preferences.
   */
   ...
   *
   * Update global Zode configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Zode server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Zode system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Zode instances, releasing all resources.
   */
   ...
   * Upgrade zode
   *
   * Upgrade zode to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Zode configuration settings and preferences.
   */
   ...
   *
   * Update Zode configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get project rules
   *
   * List project instruction files used by Zode and return their current contents.
   */
   ...
   * Update model state
   *
   * Patch TUI-compatible model selections shared with Zode Console.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Zode state.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Zode sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
   */
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Zode instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Zode instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Zode system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Zode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Zode is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Zode.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Zode sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Zode session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Zode session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Audio extends HeyApiClient {
   ...
   *
   * Proxy an audio transcription request to the Zode Gateway
   */
...
export class Organization extends HeyApiClient {
  /**
   * Update Zode Gateway organization
   *
   * Switch to a different Zode Gateway organization
   */
  public set<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<ZodeOrganizationSetResponses, ZodeOrganizationSetErrors, ThrowOnError>(
      {
...
export class Claw extends HeyApiClient {
  /**
   * Get ZodeClaw instance status
   *
   * Fetch the user's ZodeClaw instance status via the ZodeClaw worker
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<ZodeClawStatusResponses, ZodeClawStatusErrors, ThrowOnError>({
  ...
  /**
   * Get ZodeClaw chat credentials
   *
   * Returns the bearer token and endpoint URLs the client uses to talk to the Zode Chat worker and the Event Service. The bearer is the user's existing long-lived Zode JWT — zode-chat and event-service both verify it directly with NEXTAUTH_SECRET, so no separate token mint is needed.
   */
  public chatCredentials<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ZodeClawChatCredentialsResponses, unknown, ThrowOnError>({
...
export class Session4 extends HeyApiClient {
   ...
   * Get cloud session
   *
   * Fetch full session data from the Zode cloud for preview
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
    ...
    return (options?.client ?? this.client).get<ZodeCloudSessionGetResponses, ZodeCloudSessionGetErrors, ThrowOnError>({
...
export class Zode extends HeyApiClient {
  /**
   * Get Zode Gateway profile
   *
   * Fetch user profile and organizations from Zode Gateway
   */
  public profile<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ZodeProfileResponses, ZodeProfileErrors, ThrowOnError>({
      url: "/zode/profile",
      ...options,
      ...params,
    })
  ...
  public modes<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ZodeModesResponses, unknown, ThrowOnError>({
      url: "/zode/modes",
      ...options,
      ...params,
    })
   ...
   * FIM completion
   *
   * Proxy a Fill-in-the-Middle completion request to the Zode Gateway
   */
  public fim<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).sse.post<ZodeFimResponses, ZodeFimErrors, ThrowOnError>({
      url: "/zode/fim",
      ...options,
      ...params,
      headers: {
  ...
  public edit<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ZodeEditResponses, ZodeEditErrors, ThrowOnError>({
      url: "/zode/edit",
      ...options,
      ...params,
      headers: {
  ...
  /**
   * Get Zode notifications
   *
   * Fetch notifications from Zode Gateway for CLI display
   */
  public notifications<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ZodeNotificationsResponses, ZodeNotificationsErrors, ThrowOnError>({
   ...
   * Get cloud sessions
   *
   * Fetch cloud CLI sessions from Zode API
   */
  public cloudSessions<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<ZodeCloudSessionsResponses, ZodeCloudSessionsErrors, ThrowOnError>({
...
export class Zodecode extends HeyApiClient {
  /**
   * Remove a skill
   *
  ...
  public removeSkill<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ZodecodeRemoveSkillResponses, ZodecodeRemoveSkillErrors, ThrowOnError>(
      {
  ...
  public removeAgent<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<ZodecodeRemoveAgentResponses, ZodecodeRemoveAgentErrors, ThrowOnError>(
      {
...
export class Telemetry extends HeyApiClient {
   ...
   *
   * Forward a telemetry event to PostHog via zode-telemetry.
   */
...
export class ZodeClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<ZodeClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    ZodeClient.__registry.set(this, args?.key)
  }
  ...
  private _zode?: Zode
  get zode(): Zode {
    return (this._zode ??= new Zode({ client: this.client }))
  }

  private _zodecode?: Zodecode
  get zodecode(): Zodecode {
    return (this._zodecode ??= new Zodecode({ client: this.client }))
  }
