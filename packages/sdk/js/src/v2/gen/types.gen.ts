...
export type Event =
  ...
  | EventZodecodeAgentManagerStart
  | EventIndexingStatus
  ...
  | EventZodeSessionsRemoteStatusChanged
  | EventWorkspaceReady
...
/**
 * Server configuration for the zode serve command
 */
...
export type ZodecodeSessionImportResult = {
  ok: boolean
  id: string
  skipped?: boolean
}
...
export type EventZodecodeAgentManagerStart = {
  id: string
  type: "zodecode.agent_manager.start"
  properties: {
    requestID: string
    sessionID: string
    mode: "worktree" | "local"
...
export type EventZodeSessionsRemoteStatusChanged = {
  id: string
  type: "zode-sessions.remote-status-changed"
  properties: {
    enabled: boolean
    connected: boolean
  }
...
export type ZodeProfileError = ZodeProfileErrors[keyof ZodeProfileErrors]

export type ZodeProfileResponses = {
  /**
   * Profile data
   */
  200: {
...
export type ZodeProfileResponse = ZodeProfileResponses[keyof ZodeProfileResponses]

export type ZodeModesData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type ZodeModesResponses = {
  /**
...
export type ZodeModesResponse = ZodeModesResponses[keyof ZodeModesResponses]

export type ZodeFimData = {
  body?: {
    prefix: string
    suffix: string
    provider?: string
...
export type ZodeFimError = ZodeFimErrors[keyof ZodeFimErrors]

export type ZodeFimResponses = {
  /**
...
export type ZodeFimResponse = ZodeFimResponses[keyof ZodeFimResponses]

export type ZodeEditData = {
  body?: {
    provider?: string
    model?: string
    maxTokens?: number
...
export type ZodeEditError = ZodeEditErrors[keyof ZodeEditErrors]

export type ZodeEditResponses = {
  /**
...
export type ZodeEditResponse = ZodeEditResponses[keyof ZodeEditResponses]

export type ZodeAudioTranscriptionsData = {
  body?: {
    model: string
    input_audio: {
      data: string
  ...
  url: "/zode/audio/transcriptions"
}

export type ZodeAudioTranscriptionsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodeAudioTranscriptionsError = ZodeAudioTranscriptionsErrors[keyof ZodeAudioTranscriptionsErrors]

export type ZodeAudioTranscriptionsResponses = {
  /**
...
export type ZodeAudioTranscriptionsResponse = ZodeAudioTranscriptionsResponses[keyof ZodeAudioTranscriptionsResponses]

export type ZodeNotificationsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/zode/notifications"
}

export type ZodeNotificationsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodeNotificationsError = ZodeNotificationsErrors[keyof ZodeNotificationsErrors]

export type ZodeNotificationsResponses = {
  /**
   * Notifications list
   */
  200: Array<{
...
export type ZodeNotificationsResponse = ZodeNotificationsResponses[keyof ZodeNotificationsResponses]

export type ZodeOrganizationSetData = {
  body?: {
  ...
  url: "/zode/organization"
}

export type ZodeOrganizationSetErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodeOrganizationSetError = ZodeOrganizationSetErrors[keyof ZodeOrganizationSetErrors]

export type ZodeOrganizationSetResponses = {
  /**
...
export type ZodeOrganizationSetResponse = ZodeOrganizationSetResponses[keyof ZodeOrganizationSetResponses]

export type ZodeClawStatusData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/zode/claw/status"
}

export type ZodeClawStatusErrors = {
  /**
   * ServiceUnavailable
   */
...
export type ZodeClawStatusError = ZodeClawStatusErrors[keyof ZodeClawStatusErrors]

export type ZodeClawStatusResponses = {
  /**
   * Instance status
   */
  200: {
...
export type ZodeClawStatusResponse = ZodeClawStatusResponses[keyof ZodeClawStatusResponses]

export type ZodeClawChatCredentialsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/zode/claw/chat-credentials"
}

export type ZodeClawChatCredentialsResponses = {
  /**
   * Zode Chat credentials or null
   */
  200: {
    token: string
    expiresAt: string
...
export type ZodeClawChatCredentialsResponse = ZodeClawChatCredentialsResponses[keyof ZodeClawChatCredentialsResponses]

export type ZodeCloudSessionsData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/zode/cloud-sessions"
}

export type ZodeCloudSessionsErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodeCloudSessionsError = ZodeCloudSessionsErrors[keyof ZodeCloudSessionsErrors]

export type ZodeCloudSessionsResponses = {
  /**
   * Cloud sessions list
   */
  200: {
...
export type ZodeCloudSessionsResponse = ZodeCloudSessionsResponses[keyof ZodeCloudSessionsResponses]

export type ZodeCloudSessionGetData = {
  body?: never
  path: {
    id: string
  }
  ...
  url: "/zode/cloud/session/{id}"
}

export type ZodeCloudSessionGetErrors = {
  /**
   * Not found
   */
  404: NotFoundError
...
export type ZodeCloudSessionGetError = ZodeCloudSessionGetErrors[keyof ZodeCloudSessionGetErrors]

export type ZodeCloudSessionGetResponses = {
  /**
   * Cloud session data
   */
  200: {
...
export type ZodeCloudSessionGetResponse = ZodeCloudSessionGetResponses[keyof ZodeCloudSessionGetResponses]

export type ZodeCloudSessionImportData = {
  body?: {
    sessionId: string
  }
  path?: never
  ...
  url: "/zode/cloud/session/import"
}

export type ZodeCloudSessionImportErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodeCloudSessionImportError = ZodeCloudSessionImportErrors[keyof ZodeCloudSessionImportErrors]

export type ZodeCloudSessionImportResponses = {
  /**
...
export type ZodeCloudSessionImportResponse = ZodeCloudSessionImportResponses[keyof ZodeCloudSessionImportResponses]

export type ZodecodeHeapSnapshotData = {
  body?: never
  path?: never
  query?: {
    directory?: string
  ...
  url: "/zodecode/heap/snapshot"
}

export type ZodecodeHeapSnapshotErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeHeapSnapshotError = ZodecodeHeapSnapshotErrors[keyof ZodecodeHeapSnapshotErrors]

export type ZodecodeHeapSnapshotResponses = {
  /**
...
export type ZodecodeHeapSnapshotResponse = ZodecodeHeapSnapshotResponses[keyof ZodecodeHeapSnapshotResponses]

export type ZodecodeRemoveSkillData = {
  body?: {
    location: string
  }
  path?: never
  ...
  url: "/zodecode/skill/remove"
}

export type ZodecodeRemoveSkillErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeRemoveSkillError = ZodecodeRemoveSkillErrors[keyof ZodecodeRemoveSkillErrors]

export type ZodecodeRemoveSkillResponses = {
  /**
   * Skill removed
   */
  200: boolean
...
export type ZodecodeRemoveSkillResponse = ZodecodeRemoveSkillResponses[keyof ZodecodeRemoveSkillResponses]

export type ZodecodeRemoveAgentData = {
  body?: {
    name: string
  }
  path?: never
  ...
  url: "/zodecode/agent/remove"
}

export type ZodecodeRemoveAgentErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeRemoveAgentError = ZodecodeRemoveAgentErrors[keyof ZodecodeRemoveAgentErrors]

export type ZodecodeRemoveAgentResponses = {
  /**
   * Agent removed
   */
  200: boolean
...
export type ZodecodeRemoveAgentResponse = ZodecodeRemoveAgentResponses[keyof ZodecodeRemoveAgentResponses]
...
export type ZodecodeSessionImportProjectData = {
  body?: {
    id: string
    worktree: string
    vcs?: string
  ...
  url: "/zodecode/session-import/project"
}

export type ZodecodeSessionImportProjectErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeSessionImportProjectError =
  ZodecodeSessionImportProjectErrors[keyof ZodecodeSessionImportProjectErrors]

export type ZodecodeSessionImportProjectResponses = {
  /**
   * Project import result
   */
  200: ZodecodeSessionImportResult
}

export type ZodecodeSessionImportProjectResponse =
  ZodecodeSessionImportProjectResponses[keyof ZodecodeSessionImportProjectResponses]

export type ZodecodeSessionImportSessionData = {
  body?: {
    id: string
    projectID: string
    force?: boolean
  ...
  url: "/zodecode/session-import/session"
}

export type ZodecodeSessionImportSessionErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeSessionImportSessionError =
  ZodecodeSessionImportSessionErrors[keyof ZodecodeSessionImportSessionErrors]

export type ZodecodeSessionImportSessionResponses = {
  /**
...
export type ZodecodeSessionImportSessionResponse =
  ZodecodeSessionImportSessionResponses[keyof ZodecodeSessionImportSessionResponses]

export type ZodecodeSessionImportMessageData = {
  body?: {
    id: string
    sessionID: string
    timeCreated: number
  ...
  url: "/zodecode/session-import/message"
}

export type ZodecodeSessionImportMessageErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeSessionImportMessageError =
  ZodecodeSessionImportMessageErrors[keyof ZodecodeSessionImportMessageErrors]

export type ZodecodeSessionImportMessageResponses = {
  /**
...
export type ZodecodeSessionImportMessageResponse =
  ZodecodeSessionImportMessageResponses[keyof ZodecodeSessionImportMessageResponses]

export type ZodecodeSessionImportPartData = {
  body?: {
    id: string
    messageID: string
    sessionID: string
  ...
  url: "/zodecode/session-import/part"
}

export type ZodecodeSessionImportPartErrors = {
  /**
   * Bad request
   */
  400: BadRequestError
...
export type ZodecodeSessionImportPartError = ZodecodeSessionImportPartErrors[keyof ZodecodeSessionImportPartErrors]

export type ZodecodeSessionImportPartResponses = {
  /**
   * Part import result
   */
  200: ZodecodeSessionImportResult
...
export type ZodecodeSessionImportPartResponse =
  ZodecodeSessionImportPartResponses[keyof ZodecodeSessionImportPartResponses]
