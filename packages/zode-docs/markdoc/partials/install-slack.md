Bring Zode Code directly into your team's Slack workspace.

### Install the Slack App

1. Click the button below to install Zode for Slack
...
```
@Zode Can you update the documentation for the new API endpoint in the backend repository?
```
