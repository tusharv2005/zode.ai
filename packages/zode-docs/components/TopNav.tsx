...
const mainNavItems: NavItem[] = [
  ...
  { label: "Zode Gateway", href: "/gateway" },
  { label: "ZodeClaw", href: "/zodeclaw" },
  { label: "Contributing", href: "/contributing" },
]

const contributingItems: DropdownItem[] = [
  { label: "Contributing Guide", href: "/contributing", description: "How to contribute to Zode Code" },
  {
    label: "Code of Conduct",
    href: "https://github.com/Zode-Org/zodecode?tab=coc-ov-file",
    ...
    <header className="top-header">
      ...
      <div className="top-bar">
        ...
        <Link href="/" className="logo-link flex gap-2 items-center">
          ...
          <div>
            <span className="logo-text font-brand">Zode Code</span>
      ...
      <div className="announcement-banner">
        <p>
          The all-new Zode Code extension is here, rebuilt on the{" "}
          <Link href="/code-with-ai/platforms/vscode/whats-new">Zode CLI</Link> for speed, flexibility, and continued
          access to 500+ models via the Zode Gateway →
        </p>
      </div>
