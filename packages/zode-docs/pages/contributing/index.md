---
title: "Contributing"
description: "Contribute to Zode Code"
---

# Contributing Overview

{% callout type="info" %}
**New versions of the VS Code extension and CLI are being developed in [Zode-Org/zodecode](https://github.com/Zode-Org/zodecode)** (extension at `packages/zode-vscode`, CLI at `packages/opencode`). If you're looking to contribute to the extension or CLI, please head over to that repository.
{% /callout %}

Zode Code is an open-source project that welcomes contributions from developers of all skill levels. This guide will help you get started with contributing to Zode Code, whether you're fixing bugs, adding features, improving documentation, or sharing custom modes.

## Ways to Contribute

There are many ways to contribute to Zode Code:

1. **Code Contributions**: Implement new features or fix bugs
2. **Documentation**: Improve existing docs or create new guides
3. **Marketplace Contributions**: Create and share custom modes, skills, and MCP servers via the [Zode Marketplace](https://github.com/Zode-Org/zode-marketplace)
...
Before diving into the code, we recommend reviewing the [Architecture Overview](/docs/contributing/architecture) to understand how the different components of Zode Code fit together.
...
AI and coding agents are welcome in Zode contributions. Contributors still own the work they submit: you must personally understand the change, test it appropriately, be able to explain the diff, and understand how it interacts with the affected package and the rest of the repo.
...
- Run `bun run script/extract-source-links.ts` after adding or changing guarded URLs in `packages/zode-vscode/`, `packages/zode-vscode/webview-ui/`, or `packages/opencode/src/`.
...
- Use the root [TESTING.md](https://github.com/Zode-Org/zodecode/blob/main/TESTING.md) guide for backend/API validation with `bun dev serve` and `curl`-based requests.
...
2. Go to the [Zode Code repository](https://github.com/Zode-Org/zodecode)
...
## Contributing to the Zode Marketplace

The [Zode Marketplace](https://github.com/Zode-Org/zode-marketplace) is a community-driven repository of agent tooling that extends Zode Code's capabilities. You can contribute:
...
3. Submit a pull request to the [Zode Marketplace repository](https://github.com/Zode-Org/zode-marketplace)
...
When participating in the Zode Code community:

- Be respectful and inclusive
- Provide constructive feedback
- Help newcomers get started
- Follow the [Code of Conduct](https://github.com/Zode-Org/zodecode/blob/main/CODE_OF_CONDUCT.md)
...
All contributors are valued members of the Zode Code community. Contributors are recognized in:

- Release notes
- The project's README
- The contributors list on GitHub

Thank you for contributing to Zode Code and helping make AI-powered coding assistance better for everyone!
