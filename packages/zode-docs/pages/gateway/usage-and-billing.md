---
title: "Usage & Billing"
description: "Understand how the Zode AI Gateway tracks costs, manages balances, and enforces organization-level spending controls."
---

# Usage & Billing

The Zode AI Gateway tracks usage and costs for every request with microdollar precision (1 USD = 1,000,000 microdollars). This enables accurate billing even for very low-cost requests.
...
- **BYOK requests**: When using your own API key, the cost is set to $0 on Zode's side. You pay the provider directly based on your agreement with them
