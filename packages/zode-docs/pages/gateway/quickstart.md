...
Create a `.env` file and add your Zode API key:

```bash
ZODE_API_KEY=your_api_key_here
```

For step-by-step instructions on getting an API key, please see the [Zode Gateway API Key instructions](/docs/getting-started/setup-authentication#zode-gateway-api-key).
...
The Zode AI Gateway is fully OpenAI-compatible, so you can use the OpenAI SDK by pointing it to the Zode base URL.
