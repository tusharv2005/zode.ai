...
The Zode Code **memory bank** feature has been deprecated in favor of AGENTS.md.
...
1. Examine the contents in `.zodecode/rules/memory-bank/`
2. Move that content into your project's `AGENTS.md` file (or ask Zode to do it for you)
   {% /callout %}

## What is AGENTS.md?

AGENTS.md is an open standard for configuring AI agent behavior in software projects. It's a simple Markdown file placed at the root of your project that contains instructions for AI coding assistants. The standard is supported by multiple AI coding tools, including Zode Code, Cursor, and Windsurf.
...
Both `AGENTS.md` and `AGENT.md` are **write-protected files** in Zode Code. This means:
...
## How AGENTS.md Works in Zode Code

### Loading Behavior

When you start a task in Zode Code:

1. Zode Code checks for `AGENTS.md` or `AGENT.md` at the project root
...
| **[Instructions](/docs/customize/custom-rules)** | Project | `instructions` key in project `zode.jsonc` | 2 |
| **AGENTS.md** | Project | `AGENTS.md` at project root | 3 |
| **[Instructions](/docs/customize/custom-rules)** | Global | `instructions` key in global `zode.jsonc` | 4 |
| **[Skills](/docs/customize/skills)** | Both | `.zode/skills/`, config `skills` key | Loaded on demand |
...
AGENTS.md works alongside Zode Code's other configuration systems:

| Feature | Scope | Location | Purpose | Priority |
|---|---|---|---|---|
| **[Mode-specific Custom Rules](/docs/customize/custom-rules)** | Project | `.zodecode/rules-{mode}/` | Mode-specific rules and constraints | 1 (Highest) |
| **[Custom Rules](/docs/customize/custom-rules)** | Project | `.zodecode/rules/` | Zode Code-specific rules and constraints | 2 |
| **[AGENTS.md](/docs/customize/agents-md)** | Project | `AGENTS.md` | Universal standard for any AI coding tool | 3 |
| **[Global Custom Rules](/docs/customize/custom-rules)** | Global | `~/.zodecode/rules/` | Global Zode Code rules | 4 |
...
```bash
export ZODE_DISABLE_EXTERNAL_SKILLS=true
```
...
- **[Custom Rules](/docs/customize/custom-rules)** - Zode Code-specific rules with more control
