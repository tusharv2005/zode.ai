---
title: "App Builder"
description: "Build complete applications with Zode Code"
---

# App Builder

Zode's **App Builder** lets you create end-to-end applications through natural language conversation. Describe what you want to build, watch it come to life in a real-time preview, and deploy directly from your Zode dashboard. No local environment setup required.
...
- **Active Zode Code account**  
  Sign up or log in at [app.__PRESERVE_ZODE_AI__](https://app.__PRESERVE_ZODE_AI__)

---

## Cost

- You pay only for the AI model usage via Zode Code credits
...
1. Navigate to **[App Builder](https://app.__PRESERVE_ZODE_AI__/app-builder)** from your Zode dashboard.
