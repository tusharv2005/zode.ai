---
title: "Code with AI"
description: "Learn how to code with AI using Zode Code across different platforms and interfaces"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Zode Code is your AI pair programmer that works in your IDE, terminal, or browser. Generate code, refactor, debug, and ship faster with AI that understands your codebase and context.
{% /callout %}

## Getting Started

New to Zode Code? Start here to understand the core concepts:

- [**Install Zode Code**](/docs/getting-started/installing) — Get started in VS Code, JetBrains, CLI, or mobile
...
Use Zode Code wherever you work:
...
- [**Cloud Agent**](/docs/code-with-ai/platforms/cloud-agent) — Run Zode in the cloud
- [**Mobile Apps**](/docs/code-with-ai/platforms/mobile) — iOS and Android support
- [**Slack**](/docs/code-with-ai/platforms/slack) — Chat with Zode in your workspace
- [**App Builder**](/docs/code-with-ai/app-builder) — Create full-stack applications with AI

## Working with Agents

Zode uses specialized agents to help with different tasks:
...
- Explore [**Customize**](/docs/customize) to tailor Zode to your workflow
