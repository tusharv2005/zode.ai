...
Popular choices:
- **Zode Auto Frontier** — highest quality models, best results (recommended)
- **Zode Auto Balanced** — good balance of quality and cost (minimum for Gas Town)
...
Adding a GitHub PAT ensures that all commits, branches, and PRs created by your agents appear as **you** in git history. Without it, activity shows up under the Zode GitHub App bot account.
{% /callout %}
...
- PRs show as created by the Zode bot
- Some `gh` CLI operations may not work

### GitHub App Installation

The [Zode GitHub App](https://github.com/apps/zode-code) provides base-level repository access. It's installed per-organization or per-repository and gives agents read/write access to code, PRs, and issues.
