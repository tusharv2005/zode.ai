...
**Fix:**
1. Check that the [Zode GitHub App](https://github.com/apps/zode-code) is installed on your repository
...
| Cause | Fix |
|---|---|
| GitHub App uninstalled | Reinstall at [github.com/apps/zode-code](https://github.com/apps/zode-code) |
