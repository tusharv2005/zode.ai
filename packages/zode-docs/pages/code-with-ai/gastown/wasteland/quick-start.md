...
3. **Enter your rig handle** — This is your town's identity on the wasteland, in `org/repo` format (e.g., `zode/main`). It's set once when you join — choose carefully, as it's sticky by design. Behind the scenes this is equivalent to `wl join --handle <your-handle>`.
4. Click **Connect**.
