...
Your **rig handle** is your town's identity on the wasteland. It's an `org/repo`-style identifier (e.g., `zode/main`, `acme/backend`) that other participants see when you claim items and submit evidence.
