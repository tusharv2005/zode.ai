...
- **Handle** — An `org/repo` identifier (e.g., `zode/main`). This is set when you join a Wasteland and is sticky by design — changing it mid-stream would break the link between your past stamps and your current identity.
