---
title: "What's New in Zode Code (April 2026)"
description: "The Zode Code extension has been rebuilt from the ground up on the Zode CLI — faster, more flexible, and with access to 500+ models."
---

# What's New in Zode Code
...
Code indexing is temporarily unavailable in the new extension. It is actively being worked on and is expected to return soon. Please follow [this issue](https://github.com/Zode-Org/zodecode/issues/6144)
...
You can expand or collapse the graph — your preference is saved in the `zode-code.new.showTaskTimeline` setting.

### I like to closely monitor and approve the behavior of the agent. How can I do that better in the new version?

We are working to improve the experience in closely managing an agent. Identified improvements and progress are being tracked in a [GitHub issue](https://github.com/Zode-Org/zodecode/issues/8415).
