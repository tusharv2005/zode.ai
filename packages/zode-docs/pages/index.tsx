...
const terminalContent = {
  installation: (
    <>
      <span className="terminal-comment"># Install Zode Code VS Code Extension</span>
      {"\n"}
      <span className="terminal-prompt">$</span> code --install-extension zodecode.zode-code
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or install via CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> npm install -g @zodecode/cli
    </>
  ),
  gateway: (
    <>
      <span className="terminal-comment"># Call Zode Gateway with a quick curl script</span>
      {"\n"}
  ...
  firstTask: (
    <>
      <span className="terminal-comment"># Start a new task with Zode Code</span>
      {"\n"}
      <span className="terminal-prompt">$</span> zode "Create a React component for a user profile"
      {"\n"}
      {"\n"}
      <span className="terminal-comment">
        # Or for interactive sessions, just run the Zode CLI in your project folder
      </span>
      {"\n"}
      <span className="terminal-prompt">$</span> zode
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Run in architect mode for planning</span>
      {"\n"}
      <span className="terminal-prompt">$</span> zode --mode architect "Design a REST API"
    </>
  ),
  customRules: (
    <>
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> touch .zodecode/rules.md
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># Or use the CLI to add rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> zode rules add "Always use TypeScript"
      {"\n"}
      <span className="terminal-prompt">$</span> zode rules add "Follow React best practices"
      {"\n"}
      {"\n"}
      <span className="terminal-comment"># List all active rules</span>
      {"\n"}
      <span className="terminal-prompt">$</span> zode rules list
    </>
  ),
  zodeclaw: (
    <>
      <span className="terminal-comment"># Chat with your ZodeClaw agent from the CLI</span>
      {"\n"}
      <span className="terminal-prompt">$</span> zode /claw
      {"\n"}
      {"\n"}
      ...
      {"\n"}
      <span className="terminal-prompt">$</span> curl -X POST https://your-instance.zodeclaw.ai/webhook \{"\n"}
      -H "Content-Type: application/json" \{"\n"}
...
const categories = [
  {
    title: "Get Started",
    description: "Install Zode Code and get up and running in minutes",
  ...
  {
    title: "Code with AI",
    description: "Learn how to use Zode Code to write, edit, and understand code",
    href: "/code-with-ai",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    links: [
      { title: "Overview", href: "/zodeclaw/overview" },
      { title: "Chat Platforms", href: "/zodeclaw/chat-platforms" },
      { title: "Development Tools", href: "/zodeclaw/development-tools" },
    ],
  },
  {
    title: "Collaborate",
    ...
    links: [
      ...
      { title: "Zode for Teams", href: "/collaborate" },
  ...
  {
    title: "Contributing",
    description: "Help improve Zode Code and learn about its architecture",
    href: "/contributing",
    icon: (
      <svg className="category-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        <path
...
export default function HomePage() {
  const [activeTab, setActiveTab] = useState<"installation" | "firstTask" | "customRules" | "gateway" | "zodeclaw">(
    "installation",
  )
  ...
  return (
    <div className="homepage">
      <Head>
        <title>Zode Code Docs: Setup, Models, MCP, Custom Modes & CLI</title>
      </Head>
      ...
      <section className="hero">
        <div className="hero-content">
          <h1 className="hero-title">Zode Documentation</h1>
          <p className="hero-subtitle">
            Explore guides and examples for the Zode platform — from coding agents and AI-powered development to hosted
            agentic infrastructure with ZodeClaw.
          </p>
          <div className="hero-buttons">
            <Link href="/getting-started" className="btn btn-primary">
              Get started with Zode Code →
            </Link>
            <Link href="/zodeclaw/overview" className="btn btn-secondary">
              Explore ZodeClaw
            </Link>
          </div>
        </div>
        ...
        <div className="quick-panel">
          <div className="quick-section">
            <h3 className="quick-title">ZODE CODE</h3>
          ...
          <div className="quick-section">
            <h3 className="quick-title">ZODECLAW</h3>
            <div className="quick-links">
              <Link href="/zodeclaw/overview" className="quick-link">
                Overview
              </Link>
              <Link href="/zodeclaw/chat-platforms" className="quick-link">
                Chat Platforms
              </Link>
              <Link href="/zodeclaw/development-tools" className="quick-link">
                Development Tools
              </Link>
            </div>
          </div>
      ...
      <section className="terminal-section">
        <div className="terminal-intro">
          ...
          <p className="terminal-description">Get started quickly with Zode Code, ZodeClaw, and Zode Gateway</p>
        </div>
        <div className="terminal-container">
          <div className="terminal-tabs">
            ...
            <button
              className={`terminal-tab ${activeTab === "zodeclaw" ? "active" : ""}`}
              onClick={() => setActiveTab("zodeclaw")}
            >
              ZodeClaw
            </button>
            <button
        ...
        <div className="footer-grid">
          ...
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Zode-Org/zodecode/releases" className="footer-link">
                Changelog
              </Link>
            </div>
          </div>
          <div className="footer-item">
            ...
            <div>
              ...
              <Link href="https://github.com/Zode-Org/zodecode/issues" className="footer-link">
                Report an issue
              </Link>
            </div>
          </div>
