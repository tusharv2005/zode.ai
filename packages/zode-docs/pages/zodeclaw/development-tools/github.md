...
description: "Connect a GitHub account to your ZodeClaw agent for repository access"
---

# GitHub Integration

Connect a GitHub account to your ZodeClaw agent so it can clone repositories, push commits, open pull requests, and leave code reviews — all autonomously.
...
ZodeClaw uses a [fine grained Personal Access Token](https://github.com/settings/tokens?type=beta) to authenticate as your bot. When creating the token, use these settings:

| Setting | Recommended Value |
|---|---|
| **Token name** | `zodeclaw-bot` (or any descriptive name) |
...
### Step 3: Enter credentials in ZodeClaw
...
ZodeClaw accepts both GitHub token formats:
...
When your instance starts, ZodeClaw automatically:
...
- Tokens are encrypted at rest using ZodeClaw's secret management system
