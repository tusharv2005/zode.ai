...
description: "How ZodeClaw instances are structured"
---

# Architecture Notes

For advanced users — how ZodeClaw instances are structured:
...
- **Network isolation** — OpenClaw binds to loopback only; external traffic is proxied through a Zode controller.
