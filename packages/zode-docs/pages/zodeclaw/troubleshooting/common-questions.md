...
description: "Answers to common ZodeClaw troubleshooting questions"
---
...
2. Click **OpenClaw Doctor** on your [dashboard](/docs/zodeclaw/dashboard)
...
1. Check that the channel token is configured in [Settings](/docs/zodeclaw/dashboard#channels)
