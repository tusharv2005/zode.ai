...
description: "Control which commands your ZodeClaw agent can run on the host machine"
---
...
{% image src="/docs/img/zodeclaw/allow-everything-settings.png" alt="Allow Everything setting in ZodeClaw Settings Dashboard" width="800" caption="The Allow Everything toggle in ZodeClaw Settings" /%}
