---
title: "Slack"
description: "Using ZodeClaw with Slack"
---

# Slack

This page covers everything you need to use ZodeClaw with Slack: connecting your bot, controlling who can DM it, and adding it to channels.

## Connecting ZodeClaw to Slack

{% youtube url="https://youtu.be/Q5bt-qH-_pY" title="Slack Setup Guide" caption="How to connect your ZodeClaw agent to Slack" /%}

Create a Slack app from the OpenClaw manifest and link it to your ZodeClaw dashboard.
...
4. Customize the manifest before creating:
   ...
   - Update the slash command if desired (e.g., `/zodeclaw`)
5. Click **Create**
...
3. Click **Save**
4. Scroll to the top of the ZodeClaw UI and click **Redeploy**. Wait for the instance to come back up

### Step 4: Pair Slack with ZodeClaw
...
By default, ZodeClaw can respond to any DMs and will not respond in Slack channels, even if added.

## Making ZodeClaw DM-Only (from you)

By default, ZodeClaw will respond to DMs from any user in Slack.
...
## Adding ZodeClaw to a Slack Channel

By default, ZodeClaw will not respond in Slack channels, even if added. To have ZodeClaw participate in a Slack channel:
