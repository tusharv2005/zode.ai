---
title: "About Plans"
description: "Overview of Zode Code plans and pricing"
---

# About Plans

Zode Code accelerates development with AI-driven code generation and task automation. You can use Zode Code as an open source extension in VS Code or JetBrains IDEs.
...
Zode Code's paid plans, Teams and Enterprise, are the solution for these organizations.

{% callout type="note" %}

Purchases of Zode Code's paid plans are separate from model provider credits.

No credits are included with a Teams or Enterprise plan purchase.

{% /callout %}

## What You Get from Zode Teams
...
## What You Get from Zode Enterprise
