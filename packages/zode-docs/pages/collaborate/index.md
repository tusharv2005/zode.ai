---
title: "Collaborate"
description: "Work together with Zode Code team features"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Zode Code makes it easy to work together with your team. Share sessions, manage team settings, and track AI adoption across your organization.
{% /callout %}

## Sessions & Sharing

Sessions are your platform-agnostic interaction with Zode. They remember your repository, task, and conversation so you can pause and resume work without losing context.

- [**Sessions & Sharing**](/docs/collaborate/sessions-sharing) — Share and collaborate on Zode Code sessions
...
Zode Code's paid plans provide powerful team management features:
...
- **Enterprise ([Contact Sales](https://__PRESERVE_ZODE_AI__/contact-sales))** — Model controls, audit logs, SSO, dedicated support
