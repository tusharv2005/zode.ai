...
**Action:** Install the Zode CLI to enable AI-assisted terminal workflows:
...
**Action:** Use [Zode Deploy](/docs/deploy-secure/deploy) to spin up live URLs for branches, allowing your team to verify changes before merging.
...
Most teams start with Code mode and stop there. But Zode's other modes unlock additional value.
...
4. Consider Zode Deploy to validate AI output
