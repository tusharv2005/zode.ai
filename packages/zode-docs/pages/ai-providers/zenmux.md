---
title: "Using ZenMux with Zode Code | Unified AI Gateway"
description: "Access OpenAI, Anthropic, Google, and other AI models through ZenMux in Zode Code with automatic routing and cost optimization."
sidebar_label: ZenMux
---

# Using ZenMux With Zode Code
...
3. **Configure in Zode Code:** Add your API key to Zode Code settings.
...
- Check the [Zode Code GitHub repository](https://github.com/Zode-Org/zodecode) for integration-specific issues
