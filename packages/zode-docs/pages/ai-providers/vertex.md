---
title: "Using GCP Vertex AI with Zode Code"
description: "Connect Google Cloud Vertex AI to Zode Code to use Claude, Gemini, and other models through your GCP account."
sidebar_label: GCP Vertex AI
---

# Using GCP Vertex AI With Zode Code

Zode Code supports accessing models through Google Cloud Platform's Vertex AI, a managed machine learning platform that provides access to various foundation models, including Anthropic's Claude family.
...
- **Application Default Credentials (ADC):** Zode Code uses Application Default Credentials to authenticate with Vertex AI. The easiest way to set this up is to:
...
- **Prompt caching:** Claude models served through Vertex AI support Zode prompt caching. Zode applies Anthropic cache controls and tracks cache write/read tokens when Vertex reports them. Native Vertex Gemini models use Google's implicit server-side caching; no extra Zode configuration is required, and Gemini may not report cache write tokens.
