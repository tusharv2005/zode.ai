---
title: "Using Vercel AI Gateway with Zode Code"
description: Configure the Vercel AI Gateway in Zode Code to robustly access 100+ language models from various providers through a centralized interface.
keywords:
  - zode code
  - vercel ai gateway
  - ai provider
...
# Using Vercel AI Gateway With Zode Code
...
The Vercel AI Gateway supports a large and growing number of models. Zode Code automatically fetches the list of available models from the `https://ai-gateway.vercel.sh/v1/models` endpoint. Only language models are shown.
