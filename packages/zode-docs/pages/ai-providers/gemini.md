---
title: "Using Google Gemini with Zode Code"
description: "Connect Google Gemini models to Zode Code. Guide to getting an API key from Google AI Studio and configuring Gemini in VS Code and the CLI."
sidebar_label: Google Gemini
---

# Using Google Gemini With Zode Code

Zode Code supports Google's Gemini family of models through the Google AI Gemini API.
