---
title: "Using Fireworks AI with Zode Code | Fast Inference"
description: "Run open-source and proprietary models on Fireworks AI's high-performance platform in Zode Code. Setup guide for VS Code and the CLI."
---

# Using Fireworks AI With Zode Code
...
3. **Create a Key:** Click "Create API key" and give your key a descriptive name (e.g., "Zode Code").
