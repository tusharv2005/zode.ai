---
title: "Using Inception Labs with Zode Code"
description: "Connect Inception Labs' Mercury diffusion LLMs to Zode Code for ultra-fast code generation. Setup guide for VS Code and the CLI."
sidebar_label: Inception
---

# Using Inception With Zode Code
...
Zode Code supports Inception's available models. Model selection and capabilities may vary based on your account tier.
...
- **Docs Feedback:** Report documentation issues at [Zode-Org/zodecode issues](https://github.com/Zode-Org/zodecode/issues/new?title=Documentation%20Issue:%20/docs/ai-providers/inception).
