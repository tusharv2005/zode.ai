---
title: "Using Anthropic Claude with Zode Code"
description: "Configure Anthropic's Claude models in Zode Code. Guide to getting an API key, setting up Claude Sonnet and Opus in VS Code and the CLI."
sidebar_label: Anthropic
---

# Using Anthropic With Zode Code
...
3.  **Create a Key:** Click "Create Key". Give your key a descriptive name (e.g., "Zode Code").
