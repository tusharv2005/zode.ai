---
title: "Using Mistral AI with Zode Code"
description: "Configure Mistral AI models, including Codestral, in Zode Code. Guide to getting an API key and setup for VS Code and the CLI."
sidebar_label: Mistral AI
---

# Using Mistral AI With Zode Code

Zode Code supports accessing models through the Mistral AI API, including both standard Mistral models and the code-specialized Codestral model.
...
Mistral's adjustable reasoning support is exposed only for reasoning-capable Mistral Small 4 models: `mistral-small-2603` and `mistral-small-latest`. When one of these models is selected, Zode offers a `high` variant that sends `reasoningEffort: "high"` to the Mistral provider.
