---
title: "Using Glama with Zode Code"
description: "Connect Glama's unified AI gateway to Zode Code to access Claude, GPT, and other leading models through a single API key."
sidebar_label: Glama
---

# Using Glama With Zode Code
...
Zode Code will automatically try to fetch a list of available models from the Glama API. Some models that are commonly available through Glama include:

- **Anthropic Claude models:** (e.g., `anthropic/claude-3-5-sonnet`) These are generally recommended for best performance with Zode Code.
...
Glama is not yet available as a CLI provider. Check the [Zode Code releases](https://github.com/Zode-Org/zodecode/releases) for updates on provider support.
{% /callout %}
