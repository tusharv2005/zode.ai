---
title: "Using Synthetic with Zode Code"
description: "Access open-source AI models through Synthetic in Zode Code. Setup guide for getting an API key and configuring models."
sidebar_label: Synthetic
---

# Using Synthetic With Zode Code
...
Zode Code supports all "always on" Synthetic AI models. The available models include various open-source options optimized for different use cases.
