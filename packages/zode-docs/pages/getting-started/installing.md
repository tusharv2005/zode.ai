---
title: "Installation"
description: "How to install Zode Code on your system"
---

# Installation

Get started with Zode Code by installing it on your preferred platform. Choose your development environment below:
...
The current Zode Code extension is built on the [Zode CLI](https://github.com/Zode-Org/zodecode) and is distributed as the **pre-release version** on the VS Code Marketplace.

1. Open VS Code
2. Go to Extensions (`Ctrl+Shift+X` / `Cmd+Shift+X`)
3. Search for "Zode Code"
...
For VS Code-compatible editors like VSCodium, Gitpod, Eclipse Theia, and Windsurf, you can browse and install directly from the [Zode Code page on Open VSX Registry](https://open-vsx.org/extension/zodecode/Zode-Code).
...
4. Search for "Zode Code"
5. Select "Zode Code" and click **Install**
...
1. **Download the VSIX file:**
   - Find official releases on the [Zode Code GitHub Releases page](https://github.com/Zode-Org/zodecode/releases)
   - Download the `.vsix` file from the [latest release](https://github.com/Zode-Org/zodecode/releases/latest)
...
1. Open the [Zode Code GitHub Releases page](https://github.com/Zode-Org/zodecode/releases)
...
{% image src="/docs/img/installing-vsix.png" alt="Installing Zode Code using VS Code's Install from VSIX dialog" width="600px" caption="Installing Zode Code using VS Code's \"Install from VSIX\" dialog" /%}
...
- Restart VS Code
- Verify Zode Code is listed and enabled in Extensions
- Try disabling and re-enabling the extension in Extensions
- Check Output panel for errors (View → Output, select "Zode Code")
...
The legacy extension is the previous version of Zode Code for VS Code. It is still available but is no longer actively developed. We recommend installing the current extension (see the **VS Code** tab).
...
- [Your First Task](/docs/code-with-ai/agents/chat-interface) - Learn the basics of working with Zode Code
