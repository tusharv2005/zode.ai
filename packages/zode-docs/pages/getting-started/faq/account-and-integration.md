...
description: "Questions about accounts and integrations in Zode Code"
tocDepth: 2
---

# Account and Integration

This section contains questions about accounts and integrations in Zode Code.
...
This process involves removing the **Zode Connect** application from your GitHub account settings.
...
2. Find **Zode Connect** in the list of installed applications
3. Click **Configure** next to Zode Connect
4. From the configuration page, you can either:
   - **Uninstall** the integration completely, or
   - **Edit** which repositories are connected

{% callout type="tip" %}
If you'd like to reconnect GitHub later, simply open your Zode Code profile, go to **Integrations**, and connect GitHub again.
{% /callout %}
