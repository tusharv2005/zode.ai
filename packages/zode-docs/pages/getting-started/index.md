---
title: "Introduction to Zode Code"
description: "Get started with Zode Code - the leading open source agentic engineering platform"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Zode Code is an open-source AI coding assistant that works wherever you do—in your IDE, terminal, browser, or on the go. Generate code, automate reviews, debug issues, and ship faster with AI that understands your codebase.
{% /callout %}
...
- [**CLI**](/docs/code-with-ai/platforms/cli) — Run Zode from your terminal for scripting and automation
- **Web & Mobile** — Access Zode from your browser (coming soon) or [iOS/Android apps](/docs/code-with-ai/platforms/mobile)
- [**Slack**](/docs/code-with-ai/platforms/slack) — Chat with Zode directly in your workspace
...
- [**Deploy & Secure**](/docs/deploy-secure) — Build and deploy apps directly from Zode. Run security scans and manage issues with AI assistance.

## Quick Start

1. [Install Zode Code](/docs/getting-started/installing) in your preferred environment
2. [Connect an AI provider](/docs/ai-providers) or use Zode's built-in provider & credits
...
Zode Code is open source. You can inspect the code, contribute features, or fork it to meet your needs.

- [GitHub Repository](https://github.com/Zode-Org/zodecode)
