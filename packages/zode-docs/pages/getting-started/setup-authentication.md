...
description: "Configure Zode Code and connect to your AI providers"
---

# Setup & Authentication

When you install Zode Code, you'll be prompted to sign in or create a free account. This automatically configures everything you need to get started.

## Quick Start with Zode Account

{% tabs %}
{% tab label="VSCode" %}

The extension prompts you to sign in when you first open Zode Code in VS Code. Click **Sign In** and complete the browser-based flow. Sign-in applies across extension surfaces, including the sidebar and Agent Manager.
...
1. Click **"Try Zode Code for Free"** in the extension
2. Sign in with your Google account
3. Allow VS Code to open the authorization URL

{% image src="/docs/img/signupflow.gif" alt="Sign up and registration flow with Zode Code" /%}
...
If you prefer to use your own API key or existing subscription, Zode Code supports **over 30 providers**. Here are some popular options to get started:
...
These are just a few examples! Zode Code supports many more providers including Google Gemini, DeepSeek, Mistral, Ollama (for local models), AWS Bedrock, Google Vertex, and more. See the complete list at [AI Providers](/docs/ai-providers/).
{% /callout %}

### ChatGPT Plus/Pro Subscription

Already have a ChatGPT subscription? You can use it with Zode Code through the [OpenAI ChatGPT provider](/docs/ai-providers/openai-chatgpt-plus-pro)—no API key needed.
...
These settings apply across the extension, including the sidebar and Agent Manager. Agent Manager does not need separate provider or Zode CLI authentication setup.
...
Or use `zode auth login` for providers that support OAuth, such as GitHub Copilot or ChatGPT Plus/Pro.
...
1. Click the {% zode-code-icon /%} icon in the VS Code sidebar
