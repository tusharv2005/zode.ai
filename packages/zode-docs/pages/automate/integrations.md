---
title: "Integrations"
description: "Overview of Zode Code integrations"
---

# Zode Code Integrations

Zode Integrations lets you connect your GitHub or GitLab account (soon Bitbucket) to enable advanced features inside Zode Code. Once connected, Zode can access your repositories securely, enabling features like **Code Reviews**, **Cloud Agents**, and **Zode Deploy**.
...
- **Connect GitHub or GitLab to Zode Code** in a few clicks
- **Enable advanced features** like Cloud Agents, Code Reviews, and Zode Deploy
- **Authorize repository access** so Zode can analyze and work with your code
...
- For GitHub: You need permission to install GitHub Apps for the repositories you want Zode to access.
...
2. You'll be redirected to GitHub to authorize the **ZodeConnect** App.
3. Select the GitHub account or organization you want to connect.

### 3. Choose Repository Access

GitHub will ask which repositories you want Zode to access:
...
- You'll return to the Zode Integrations page.
- GitHub will show a **Connected** status.
- Your Zode workspace can now access GitHub repositories securely.
...
4. You'll be redirected back to Zode with the connection active
...
4. In Zode, go to the GitLab integration page
...
> PAT tokens cannot be refreshed automatically. When your token expires, create a new one in GitLab and reconnect in Zode.
...
Once your Git provider is connected, the following features are enabled in Zode:

### Cloud Agents

- Run Zode Code in the cloud from any device
...
- Deploy Next.js 14 & 15 apps directly from Zode
...
- Update which repositories Zode has access to
...
> Disconnecting from Zode does not revoke OAuth tokens on GitLab's side. You can manually revoke them from **GitLab → User Settings → Applications → Authorized Applications**.
...
Ensure the ZodeConnect App is installed for the correct GitHub org and that repo access includes the repositories you need.
...
- **PAT**: Create a new token in GitLab and reconnect in Zode.
