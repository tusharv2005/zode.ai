---
title: "Automate"
description: "Automate your development workflows with Zode Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Automate repetitive tasks, set up AI-powered code reviews, and extend Zode Code's capabilities with integrations and MCP servers.
{% /callout %}
...
Connect Zode Code to external tools and services:
...
- [**Using MCP in Zode Code**](/docs/automate/mcp/using-in-zode-code) — Configuration guide
...
Connect Zode Code with your development tools:
...
Customize and extend Zode Code's capabilities:
...
2. Configure [MCP servers](/docs/automate/mcp/using-in-zode-code) for external integrations
