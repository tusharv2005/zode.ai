...
Zode's **Code Reviews** feature automatically analyzes your pull or merge requests using an AI model of your choice. It can review code the moment a PR/MR is opened or updated, surface issues, and provide structured feedback across performance, security, style, and test coverage.
...
- **Compute and review time are free during limited beta**
  - Feedback is welcome in the Code Reviews beta Discord channel:
    - [Zode Discord](https://discord.gg/hZnd57qN)
- **Zode Code credits are still used** when the agent performs model reasoning during a review.
