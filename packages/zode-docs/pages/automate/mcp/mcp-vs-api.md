...
## Why Zode Code Uses MCP

Zode Code leverages MCP to provide:
...
MCP creates a universal connector between Zode Code and external services, with REST APIs often powering those services behind the scenes.
