---
title: Semantic Search Tool | Zode Code Docs
...
- When Zode Code needs to find code related to specific functionality across your project
...
- When implementing a new feature, Zode Code searches for "authentication middleware" to understand existing patterns before writing new code.
- When debugging an issue, Zode Code searches for "error handling in API calls" to find related error patterns across the codebase.
- When refactoring code, Zode Code searches for "database transaction patterns" to ensure consistency across all database operations.
- When onboarding to a new codebase, Zode Code searches for "configuration loading" to understand how the application bootstraps.
