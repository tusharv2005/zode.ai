---
title: "Deploy & Secure"
description: "Deploy applications and manage security with Zode Code"
---

# {% $markdoc.frontmatter.title %}

{% callout type="generic" %}
Deploy your applications directly from Zode Code and manage security with AI-powered reviews and scans.
{% /callout %}
