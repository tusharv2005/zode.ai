---
title: "Deploy"
description: "Deploy your applications with Zode Code"
---

# Deploy

Zode Deploy lets you ship **Next.js** and **static sites** directly from Zode Code, with:

- **One-click deployment** from the Zode Code dashboard
...
2. Click **Configure** and follow the prompts to connect GitHub to Zode Code
...
Zode Deploy does **not** include built-in database hosting, but you can connect to any external database service.

---

## Environment Variables

Zode Deploy supports Environment Variables and Secrets. Add the variable **key** and **value** during the **Create New Deployment** step, and toggle to mark as secrets.
