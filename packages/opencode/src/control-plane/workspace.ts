...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.ZODE_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ZODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ZODE_WORKSPACE_ID: config.id,
        ZODE_EXPERIMENTAL_WORKSPACES: "true",
