...
import ZODE_CONFIG from "./zode-config.md"
...
export const BUILTIN_SKILLS: BuiltinSkill[] = [
  {
    name: "zode-config",
    description:
      "Guide for Zode configuration: config paths, zode.json fields, commands, agents, skills, permissions, MCPs, providers, TUI settings, plus Agent Manager worktree setup/run scripts, workflows, and state. Use for Zode config questions, locating loaded config, changing settings, or Agent Manager questions about run/setup scripts, worktree setup/workflows, apply/merge/PR/conflicts, missing sessions/worktrees, and agent-manager.json recovery.",
    content: ZODE_CONFIG,
  },
]
