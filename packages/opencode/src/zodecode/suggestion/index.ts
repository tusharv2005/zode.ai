...
import { ZodeSessionPromptQueue } from "../session/prompt-queue"
...
export namespace Suggestion {
  ...
  // zodecode_change - Instance.state() removed in v1.4.4; use module-level state
  ...
  export async function show(input: {
    ...
    if (ZodeSessionPromptQueue.hasFollowup(SessionID.make(input.sessionID))) {
