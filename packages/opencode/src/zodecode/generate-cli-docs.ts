...
const TABLE_PATH = root + "packages/zode-docs/markdoc/partials/cli-commands-table.md"
const REFERENCE_PATH = root + "packages/zode-docs/pages/code-with-ai/platforms/cli-reference.md"
