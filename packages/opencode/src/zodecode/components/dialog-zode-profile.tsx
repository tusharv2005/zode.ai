...
import type { ZodecodeProfile, ZodecodeBalance } from "@zodecode/zode-gateway"

interface DialogZodeProfileProps {
  profile: ZodecodeProfile
  balance: ZodecodeBalance | null
  currentOrgId?: string | null
}

export function DialogZodeProfile(props: DialogZodeProfileProps) {
