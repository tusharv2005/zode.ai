/**
 * Zode Notifications Dialog
 *
 * Displays all notifications from Zode API in a scrollable dialog.
...
interface DialogZodeNotificationsProps {
  notifications: ZodecodeNotification[]
}

export function DialogZodeNotifications(props: DialogZodeNotificationsProps) {
