/**
 * Zode Gateway Organization Selection Dialog
 *
...
import { getOrganizationOptions, getDefaultOrganizationSelection } from "@zodecode/zode-gateway/tui"
...
interface DialogZodeOrganizationProps {
...
export function DialogZodeOrganization(props: DialogZodeOrganizationProps) {
