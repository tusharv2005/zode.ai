/**
 * Custom OAuth handler for Zode Gateway
 *
...
import { DialogZodeOrganization } from "./dialog-zode-organization.js"
...
export function ZodeAutoMethod(props: ZodeAutoMethodProps) {
  ...
  onMount(async () => {
    try {
      ...
      const profileResponse = await sdk.client.zode.profile()
      ...
      console.warn("Failed to fetch Zode profile, using personal account:", error)
      setStatus("error")
