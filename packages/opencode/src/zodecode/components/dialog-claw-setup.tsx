...
/**
 * ZodeClaw Setup Dialog
 *
 * Shown when the user has no ZodeClaw instance provisioned.
    ...
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box paddingBottom={1} gap={1}>
        ...
        <text fg={theme.textMuted} wrapMode="word">
          ZodeClaw gives you a personal AI that reads email, manages your calendar, monitors your projects, and lives in
        ...
        <box flexDirection="row" marginTop={1}>
          <Link href="https://__PRESERVE_ZODE_AI__/zodeclaw" fg={theme.text}>
            Learn more
          </Link>
        </box>
      </box>
