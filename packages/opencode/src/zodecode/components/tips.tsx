...
const TIPS = [
  ...
  "Zode can {highlight}configure itself{/highlight} if you ask it",
  "Ask Zode to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Zode to {highlight}create a review agent for this project{/highlight}",
  "Ask Zode to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Zode to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Zode to {highlight}make my review agent read-only{/highlight}",
  "Ask Zode to {highlight}require approval before git push{/highlight}",
  "Ask Zode to {highlight}turn off auto-formatting{/highlight}",
  "Ask Zode to {highlight}block access to .env files{/highlight}",
  "Ask Zode to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Zode to {highlight}match my terminal theme{/highlight}",
  "Ask Zode to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Zode to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Zode to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Zode to {highlight}save this workflow as a /command{/highlight}",
  "Zode auto-handles OAuth for remote MCP servers requiring auth",
  "Zode auto-formats files using prettier, gofmt, ruff, and more",
  "Zode uses LSP servers for intelligent code analysis",
  "Use {highlight}zode run{/highlight} for non-interactive scripting",
  "Use {highlight}zode --continue{/highlight} to resume the last session",
  "Use {highlight}zode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zode serve{/highlight} for headless API access to Zode",
  "Use {highlight}zode run --attach{/highlight} to connect to a running server",
  "Run {highlight}zode upgrade{/highlight} to update to the latest version",
  "Run {highlight}zode auth list{/highlight} to see all configured providers",
