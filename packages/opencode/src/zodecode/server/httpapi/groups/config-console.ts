...
export const TuiKeybindListResponse = Schema.Struct({ keybinds: Schema.Array(ZodecodeKeybinds.Info) }).annotate({
...
export const ConfigConsoleApi = HttpApi.make("config-console")
  .add(
    HttpApiGroup.make("config-console")
      .add(
        ...
        HttpApiEndpoint.get("rules", ConfigConsolePaths.rules, {
          ...
          OpenApi.annotations({
            ...
            description: "List project instruction files used by Zode and return their current contents.",
          }),
        ),
        ...
        HttpApiEndpoint.patch("modelStateUpdate", ConfigConsolePaths.modelState, {
          ...
          OpenApi.annotations({
            ...
            description: "Patch TUI-compatible model selections shared with Zode Console.",
          }),
        ),
      ...
      .annotateMerge(OpenApi.annotations({ title: "config-console", description: "Zode Console config routes." }))
