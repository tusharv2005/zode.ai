...
import { IndexingStatusInfo } from "@/zodecode/indexing-event"
...
export { IndexingStatusInfo, IndexingStatusState } from "@/zodecode/indexing-event"
  ...
  .add(
    HttpApiGroup.make("indexing")
      ...
      .annotateMerge(
        OpenApi.annotations({
          title: "indexing",
          description: "Zode indexing routes.",
        }),
      )
