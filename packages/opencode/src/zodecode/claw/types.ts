...
/**
 * ZodeClaw TUI types — Zode Chat protocol.
 *
 * Mirrors `@zodecode/zode-chat` from the cloud monorepo. We carry our own
...
export type ClawStatus = {
  ...
  secretCount?: number
  userId?: string
  // User-chosen name for the ZodeClaw bot, set during onboarding via the
  ...
  // literal string "ZodeClaw" when null.
  botName?: string | null
}
