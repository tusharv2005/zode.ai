/**
 * ZodeClaw chat slash-command autocomplete.
 *
 ...
 * with zodeclaw's own `/new` for conversations.
 *
...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "ZodeClaw", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "ZodeClaw", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "ZodeClaw", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "ZodeClaw", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "ZodeClaw", cmd: hide },
      { key: "return", desc: "Select command", group: "ZodeClaw", cmd: select },
      { key: "tab", desc: "Select command", group: "ZodeClaw", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
