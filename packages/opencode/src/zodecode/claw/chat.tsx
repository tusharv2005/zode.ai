 ...
 * and a textarea for chatting with the ZodeClaw bot via Zode Chat.
...
export function ClawChat(props: {
  ...
  // `bot:zodeclaw:{sandboxId}` — the bot is the only non-self member in 1:1
  // chats, so we resolve bot ids to the user-configured `botName` (which
  // falls back to "ZodeClaw" upstream) and render any human collaborators
