/**
 * Conversation selector for the ZodeClaw chat.
 *
  ...
  return (
    <DialogSelect
      ...
      actions={[
        ...
        {
          command: "zodeclaw.conversation.new",
          title: "new",
          side: "right",
          onTrigger: async () => {
      ...
      bindings={[{ key: "ctrl+n", cmd: "zodeclaw.conversation.new" }]}
    />
  )
}
