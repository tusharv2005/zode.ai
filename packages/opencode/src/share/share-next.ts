...
const disabled = process.env["ZODE_DISABLE_SHARE"] === "true" || process.env["ZODE_DISABLE_SHARE"] === "1"
...
// zodecode_change start - preserve the share transport contract when stored legacy summary diffs omit file details
