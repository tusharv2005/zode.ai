...
import { localReviewCommand, localReviewUncommittedCommand } from "@/zodecode/review/command" // zodecode_change
...
// zodecode_change start - skills can share names with slash commands
  ...
  Effect.gen(function* () {
    ...
    const init = Effect.fn("Command.state")(function* (ctx: InstanceContext) {
      ...
      for (const item of yield* skill.all()) {
        ...
        commands[item.name] = fromSkill(item) // zodecode_change
      }
    ...
    const get = Effect.fn("Command.get")(function* (name: string) {
      ...
      // zodecode_change end
      return undefined // zodecode_change
    })
