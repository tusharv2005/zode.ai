import { chmod, mkdir, readFile, rename, stat as statFile, writeFile } from "fs/promises" // zodecode_change
import { createWriteStream, existsSync, statSync } from "fs"
import { realpathSync } from "fs"
// zodecode_change start - harden containment checks
...
export async function write(p: string, content: string | Buffer | Uint8Array, mode?: number): Promise<void> {
  // zodecode_change start - atomic write via temp-file + rename to avoid partial reads on concurrent saves
