...
import "@/server/event"
import "@/zodecode/indexing-event" // zodecode_change - register indexing.status before HttpApi event schemas
    ...
    .add(
      ...
      HttpApiEndpoint.post("upgrade", GlobalPaths.upgrade, {
        ...
        OpenApi.annotations({
          ...
          summary: "Upgrade zode", // zodecode_change
          description: "Upgrade zode to the specified version or latest if not specified.", // zodecode_change
        }),
      ),
    )
