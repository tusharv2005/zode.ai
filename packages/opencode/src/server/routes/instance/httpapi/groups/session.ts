...
export const SessionPaths = {
  ...
  viewed: `${root}/viewed`, // zodecode_change
} as const
    ...
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.post("fork", SessionPaths.fork, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          payload: [HttpApiSchema.NoContent, ForkPayload], // zodecode_change - carry upstream bodyless full-session fork support
          success: described(Session.Info, "200"),
          error: [HttpApiError.BadRequest, ApiNotFoundError], // zodecode_change - carry upstream malformed payload response
        }).annotateMerge(
          OpenApi.annotations({
