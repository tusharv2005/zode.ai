...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.ZODE_WORKSPACE_ID ? WorkspaceID.make(Flag.ZODE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-zode-directory"] || process.cwd()
}
