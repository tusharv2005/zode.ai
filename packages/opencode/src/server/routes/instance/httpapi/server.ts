...
import { Git } from "@/git" // zodecode_change
...
import { ModelCache } from "@/provider/model-cache" // zodecode_change
...
import { provide as provideZodeHttpApiHandlers } from "@/zodecode/server/httpapi/server" // zodecode_change
...
const instanceApiRoutes = HttpApiBuilder.layer(InstanceHttpApi).pipe(
  ...
  provideZodeHttpApiHandlers, // zodecode_change
)
...
export function createRoutes(corsOptions?: CorsOptions) {
  return Layer.mergeAll(rootApiRoutes, eventApiRoutes, instanceRoutes, docRoute, uiRoute).pipe(
    Layer.provide([
      ...
      Format.defaultLayer,
      Git.defaultLayer, // zodecode_change
      LSP.defaultLayer,
      Installation.defaultLayer,
      MCP.defaultLayer,
      ModelCache.defaultLayer, // zodecode_change
