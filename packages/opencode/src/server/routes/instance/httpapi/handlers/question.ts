...
import { HttpApiBuilder, HttpApiError } from "effect/unstable/httpapi" // zodecode_change - map Question missing requests to declared 404 errors
...
export const questionHandlers = HttpApiBuilder.group(InstanceHttpApi, "question", (handlers) =>
  Effect.gen(function* () {
    ...
    const reply = Effect.fn("QuestionHttpApi.reply")(function* (ctx: {
      ...
      // zodecode_change start - map missing Question requests to the declared transport error
      yield* svc
        .reply({
