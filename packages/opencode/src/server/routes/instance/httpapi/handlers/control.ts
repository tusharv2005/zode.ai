...
import { invalidateAfterProviderAuthChange } from "@/zodecode/server/provider-auth-lifecycle" // zodecode_change
...
export const controlHandlers = HttpApiBuilder.group(RootHttpApi, "control", (handlers) =>
  Effect.gen(function* () {
    ...
    const authSet = Effect.fn("ControlHttpApi.authSet")(function* (ctx: {
      ...
      yield* invalidateAfterProviderAuthChange(ctx.params.providerID) // zodecode_change
      return true
    })
