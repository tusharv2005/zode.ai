...
import { ConsoleAssets } from "@/zodecode/console/assets" // zodecode_change

const embeddedUIPromise = Flag.ZODE_DISABLE_EMBEDDED_WEB_UI
...
export function embeddedUI() {
  if (Flag.ZODE_DISABLE_EMBEDDED_WEB_UI) return Promise.resolve(null)
...
export function serveUIEffect(
  ...
  return Effect.gen(function* () {
    ...
    // zodecode_change start - serve Zode Console under /console
    ...
    // zodecode_change - no proxy fallback to app.opencode.ai; embedded UI only
    return notFound()
  })
}
