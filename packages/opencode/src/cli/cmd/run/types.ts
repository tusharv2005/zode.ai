...
import type { ZodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@zodecode/sdk/v2"
...
type PromptModel = Parameters<ZodeClient["session"]["prompt"]>[0]["model"]
type PromptInput = Parameters<ZodeClient["session"]["prompt"]>[0]

export type RunPromptPart = NonNullable<PromptInput["parts"]>[number]

export type RunCommand = NonNullable<Awaited<ReturnType<ZodeClient["command"]["list"]>>["data"]>[number]

export type RunProvider = NonNullable<Awaited<ReturnType<ZodeClient["provider"]["list"]>>["data"]>["all"][number]
...
export type RunAgent = NonNullable<Awaited<ReturnType<ZodeClient["app"]["agents"]>>["data"]>[number]

type RunResourceMap = NonNullable<Awaited<ReturnType<ZodeClient["experimental"]["resource"]["list"]>>["data"]>
...
export type PermissionReply = Parameters<ZodeClient["permission"]["reply"]>[0]

export type QuestionReply = Parameters<ZodeClient["question"]["reply"]>[0]

export type QuestionReject = Parameters<ZodeClient["question"]["reject"]>[0]
