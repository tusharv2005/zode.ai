import type { Session as SDKSession, Message, Part } from "@zodecode/sdk/v2"
...
const log = Log.create({ service: "import" }) // zodecode_change
...
async function ingestBootstrap(sessionId: string) {
  ...
  return ZodeSessions.bootstrap(sessionId)
}
