import type { TuiDialogSelectOption, TuiPluginApi, TuiRouteDefinition, TuiSlotProps } from "@zodecode/plugin/tui"
...
function routeCurrent(route: ReturnType<typeof useRoute>): TuiPluginApi["route"]["current"] {
  ...
  if (route.data.type === "zodeclaw") return { name: "zodeclaw" }
  // zodecode_change end
