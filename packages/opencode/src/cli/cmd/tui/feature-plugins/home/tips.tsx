import type { TuiPlugin, TuiPluginApi } from "@zodecode/plugin/tui"
  ...
  api.slots.register({
    ...
    slots: {
      home_bottom() {
        ...
        const show = createMemo(() => !hidden()) // zodecode_change - always show tips regardless of first-time status
