// zodecode_change start - use Zode-specific tips component
export { Tips } from "@/zodecode/components/tips"
// zodecode_change end
...
// zodecode_change - renamed Tips -> _Tips so the upstream implementation stays
// as shadowed dead code while we re-export the real Tips from @/zodecode/components/tips
...
const TIPS = [
  ...
  "Use {highlight}zode run{/highlight} for non-interactive scripting", // zodecode_change
  "Use {highlight}zode --continue{/highlight} to resume the last session", // zodecode_change
  "Use {highlight}zode run -f file.ts{/highlight} to attach files via CLI", // zodecode_change
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}zode serve{/highlight} for headless API access to Zode", // zodecode_change
  "Use {highlight}zode run --attach{/highlight} to connect to a running server", // zodecode_change
  "Run {highlight}zode upgrade{/highlight} to update to the latest version", // zodecode_change
  "Run {highlight}zode auth list{/highlight} to see all configured providers", // zodecode_change
  "Run {highlight}zode agent create{/highlight} for guided agent creation", // zodecode_change
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}zode github install{/highlight} to set up the GitHub workflow", // zodecode_change
  ...
  "Run {highlight}docker run -it --rm ghcr.io/zode-org/zodecode{/highlight} for containerized use",
