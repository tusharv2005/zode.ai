...
import type { PermissionRequest } from "@zodecode/sdk/v2"
...
function EditBody(props: { request: PermissionRequest }) {
  ...
  const hunks = createMemo(() => splitDiffHunks(diff())) // zodecode_change
        ...
        {(() => {
          const info = () => {
            ...
            if (permission === "webfetch") {
              const url = normalizeUrls(typeof data.url === "string" ? data.url : "") // zodecode_change
              return {
                icon: "%",
                title: `WebFetch ${url}`,
                body: (
          ...
          const header = () => (
            <box flexDirection="column" gap={0}>
              ...
              {/* // zodecode_change start - explain config file edits always require approval */}
          ...
          // zodecode_change start — hide "Always allow" for config file edits
  ...
  return (
    ...
    >
      <box gap={1} paddingLeft={1} paddingRight={3} paddingTop={1} paddingBottom={1}>
        ...
        <box paddingLeft={1}>
          {/* zodecode_change */}
          <text fg={theme.textMuted}>Tell Zode what to do differently</text>
        </box>
      </box>
      <box
