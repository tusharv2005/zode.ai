...
// zodecode_change start - expose Effect stats aggregation for Zode regression coverage
      ...
      Effect.gen(function* () {
        ...
        for (const message of messages) {
          if (message.info.role === "assistant") {
            // zodecode_change start - count propagated subagent cost once but keep child model stats (#6321)
            ...
            sessionModelUsage[modelKey].cost += cost // zodecode_change
