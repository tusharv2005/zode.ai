...
export const Action = Schema.NullOr(Schema.Literals(["ask", "allow", "deny"])) // zodecode_change - nullable allows null as a delete sentinel
...
const InputObject = Schema.StructWithRest(
  Schema.Struct({
    ...
    agent_manager: Schema.optional(Rule), // zodecode_change
  }),
...
const normalizeInput = (input: Schema.Schema.Type<typeof InputSchema>): Schema.Schema.Type<typeof InputObject> =>
  input === null || typeof input === "string" ? { "*": input } : input // zodecode_change
