...
import { PROMPTS, AI_SDK_PROVIDERS } from "@zodecode/zode-gateway" // zodecode_change
...
export const Model = Schema.Struct({
  ...
  prompt: Schema.optional(Schema.Literals(PROMPTS)), // zodecode_change
  isFree: Schema.optional(Schema.Boolean), // zodecode_change
  ai_sdk_provider: Schema.optional(Schema.Literals(AI_SDK_PROVIDERS)), // zodecode_change
  ...
  variants: Schema.optional(
    Schema.Record(
      Schema.String,
      Schema.NullOr(
        // zodecode_change - allow null values so removed variants can be deleted via stripNulls on save
...
export const Info = Schema.Struct({
  ...
  models: Schema.optional(Schema.Record(Schema.String, Schema.NullOr(Model))), // zodecode_change - allow null values so removed models can be deleted via stripNulls on save
})
