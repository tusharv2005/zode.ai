import { afterEach, expect } from "bun:test" // zodecode_change - blocking behavior now uses the scoped service test helper
...
import { disposeAllInstances, provideInstance, reloadTestInstance, tmpdirScoped } from "../fixture/fixture" // zodecode_change - blocking coverage no longer uses the Promise facade fixture
...
// zodecode_change start - review follow-up uses non-blocking question prompts
it.instance(
...
// zodecode_change start - preserve upstream unknown-request failure behavior during facade migration
it.instance(
