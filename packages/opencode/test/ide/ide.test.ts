...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ZODE_CALLER", () => {
    process.env["ZODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ZODE_CALLER", () => {
    process.env["ZODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ZODE_CALLER", () => {
    process.env["ZODE_CALLER"] = "unknown"
