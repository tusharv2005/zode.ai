...
const disableDefault = process.env.ZODE_DISABLE_DEFAULT_PLUGINS
process.env.ZODE_DISABLE_DEFAULT_PLUGINS = "1"
...
const experimental = Flag.ZODE_EXPERIMENTAL_WORKSPACES
...
afterAll(() => {
  if (disableDefault === undefined) {
    delete process.env.ZODE_DISABLE_DEFAULT_PLUGINS
  } else {
    process.env.ZODE_DISABLE_DEFAULT_PLUGINS = disableDefault
  }

  Flag.ZODE_EXPERIMENTAL_WORKSPACES = experimental
})
