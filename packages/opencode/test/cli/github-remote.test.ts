...
// zodecode_change start: rebrand fixtures off upstream repo path
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Zode-Org/zodecode.git")).toEqual({
    owner: "Zode-Org",
    repo: "zodecode",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Zode-Org/zodecode")).toEqual({ owner: "Zode-Org", repo: "zodecode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:Zode-Org/zodecode.git")).toEqual({ owner: "Zode-Org", repo: "zodecode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:Zode-Org/zodecode")).toEqual({ owner: "Zode-Org", repo: "zodecode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Zode-Org/zodecode.git")).toEqual({
    owner: "Zode-Org",
    repo: "zodecode",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Zode-Org/zodecode")).toEqual({ owner: "Zode-Org", repo: "zodecode" })
})
// zodecode_change end
