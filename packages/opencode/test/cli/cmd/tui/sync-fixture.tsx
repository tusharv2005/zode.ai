...
import { ToastProvider } from "../../../../src/cli/cmd/tui/ui/toast" // zodecode_change
...
export function createFetch(override?: FetchHandler) {
  ...
  const fetch = (async (input: RequestInfo | URL) => {
    ...
    switch (url.pathname) {
      ...
      case "/formatter":
      case "/lsp":
      case "/network": // zodecode_change
      case "/background-process": // zodecode_change
        return json([])
      case "/config":
      case "/experimental/resource":
      case "/global/config": // zodecode_change
      case "/mcp":
      case "/provider/auth":
      case "/session/status":
        return json({})
