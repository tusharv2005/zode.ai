...
import { isEligible, setKillSwitch, resetEligibility, type OrgState } from "@/zodecode/session-export/eligibility"
...
describe("isEligible", () => {
  ...
  test("free Zode Gateway personal context is eligible", () => {
    expect(isEligible(base)).toBe(true)
  })

  test("paid Zode Gateway is ineligible", () => {
  ...
  test("non-Zode provider with isFree=true is ineligible", () => {
