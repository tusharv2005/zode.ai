...
import { defaultEndpoint, resolveEndpoint } from "@/zodecode/session-export/worker/endpoint"
...
describe("session export endpoint", () => {
  ...
  test("allows approved production endpoint", () => {
    const endpoint = "https://supermassive-black-hole.zodeapps.io/v1/session-export/batch"
