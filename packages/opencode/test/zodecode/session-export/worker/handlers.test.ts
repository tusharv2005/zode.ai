...
import { Chunker } from "@/zodecode/session-export/worker/chunks"
import { Scrubber } from "@/zodecode/session-export/worker/scrub"
import { handleEvent } from "@/zodecode/session-export/worker/handlers"
import type {
  CompactionCaptured,
  LlmRequestCompleted,
  LlmRequestStarted,
...
} from "@/zodecode/session-export/events"
...
function started(id: string, input: Partial<LlmRequestStarted["input"]>): LlmRequestStarted {
  return {
    ...
    agent: "claude",
    modeId: "build",
    model: { providerId: "zode", modelId: "free-1", isFree: true },
