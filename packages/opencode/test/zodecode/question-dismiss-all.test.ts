...
import { ZodeSessionPromptQueue } from "../../src/zodecode/session/prompt-queue"
  ...
  it.instance(
    ...
    () =>
      Effect.gen(function* () {
        ...
        const first = yield* ZodeSessionPromptQueue.enqueue(
          sessionID,
        ...
        const second = yield* ZodeSessionPromptQueue.enqueue(
          sessionID,
