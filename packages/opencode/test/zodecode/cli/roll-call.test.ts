...
import { formatTable, formatMarkdown, handle, isTextModel } from "../../../src/zodecode/cli/cmd/roll-call"
...
describe("formatTable", () => {
  test("formats simple table correctly", () => {
    const rows = [
      ["zode/test-model", "YES", "Hello!", "1000ms"],
      ["zode/another-model", "NO", "(Error)", "500ms"],
    ]
