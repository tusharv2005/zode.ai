...
import { environmentDetails } from "../../src/zodecode/editor-context"
...
import PROMPT_GPT55 from "../../src/session/prompt/zodecode-gpt-5.5.txt"
...
describe("environmentDetails", () => {
  test("includes cwd and worktree in dynamic context", () => {
    const result = environmentDetails({
      directory: "/repo/.zode/worktrees/feature",
      worktree: "/repo/.zode/worktrees/feature",
      activeFile: "src/app.ts",
    })

    expect(result).toContain("Working directory: /repo/.zode/worktrees/feature")
    expect(result).toContain("Workspace root folder: /repo/.zode/worktrees/feature")
