...
```
REGISTRY=ghcr.io/zode-org TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/zode-org TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/zode-org/build/bun-node:24.04
```
