 ...
 * 1. Explicit `-Pzode.bun.path=...` Gradle property (forwarded via [bunPath])
...
abstract class PrepareLocalCliTask : DefaultTask() {
    ...
    private fun findBun(): File {
        ...
        return candidates.firstOrNull(::usable)
            ?: throw GradleException("Could not find Bun. Install Bun or pass -Pzode.bun.path=/absolute/path/to/bun.")
    }
