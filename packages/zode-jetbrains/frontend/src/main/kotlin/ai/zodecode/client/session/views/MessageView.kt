 ...
 * driven by [ai.zodecode.client.session.ui.SessionLayout] so that each
 ...
 * messages is owned by [ai.zodecode.client.session.ui.SessionLayout].
 */
class MessageView(
    val msg: Message,
...
) : ai.zodecode.client.session.ui.SessionLayoutPanel(
