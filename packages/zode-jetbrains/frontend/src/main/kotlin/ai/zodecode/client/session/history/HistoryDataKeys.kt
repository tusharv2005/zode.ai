...
object HistoryDataKeys {
    val SELECTION: DataKey<HistorySelection> = DataKey.create("ai.zodecode.client.session.history.HistorySelection")
    val CONTROLLER: DataKey<HistoryController> = DataKey.create("ai.zodecode.client.session.history.HistoryController")
}
