...
import ai.zodecode.client.session.history.HistoryActivitySnapshot
import ai.zodecode.client.session.history.HistoryTime
import ai.zodecode.client.session.history.LocalHistoryItem
import ai.zodecode.client.session.history.itemAt
import ai.zodecode.client.session.history.title
...
internal class RecentsList(
    ...
    private val title = JBLabel(ZodeBundle.message("session.empty.recent")).apply {
