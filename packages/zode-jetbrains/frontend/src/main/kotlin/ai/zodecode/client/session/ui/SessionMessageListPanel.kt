...
import ai.zodecode.client.session.views.MessageView
...
import ai.zodecode.client.session.views.TurnView
...
class SessionMessageListPanel(
    ...
    private fun onTurnAdded(turn: ai.zodecode.client.session.model.Turn) {
    ...
    private fun onTurnUpdated(turn: ai.zodecode.client.session.model.Turn) {
