...
import ai.zodecode.client.ui.md.MdView
import ai.zodecode.client.ui.md.MdViewFactory
...
private fun reasoningParts(selection: SessionSelection? = null): ReasoningParts {
    val title = JBLabel(ZodeBundle.message("session.part.reasoning")).apply { foreground = UiStyle.Colors.weak() }
