package ai.zodecode.client.autocomplete
...
@State(
    name = "ZodeAutocompleteSettings",
    storages = [Storage("zodeAutocompleteSettings.xml")],
)
class ZodeAutocompleteSettingsService : PersistentStateComponent<ZodeAutocompleteSettingsService.State> {
    ...
    companion object {
        fun getInstance(): ZodeAutocompleteSettingsService = service()
    }
}
