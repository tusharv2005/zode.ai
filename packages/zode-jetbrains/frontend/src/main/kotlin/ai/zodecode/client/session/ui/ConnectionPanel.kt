...
import ai.zodecode.client.session.controller.SessionControllerListener
...
class ConnectionPanel(
    ...
    private val retry = ActionLink(ZodeBundle.message("session.connection.retry")) {
    ...
    private fun showConnecting() {
        ...
        label.text = ZodeBundle.message("session.connection.connecting")
        detail = null
        expanded = false
