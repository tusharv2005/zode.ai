 ...
 *
 * Both [ai.zodecode.client.session.views.question.QuestionView] and
 * [ai.zodecode.client.session.views.LoginRequiredView] use this as their
...
class BaseQuestionView(
     ...
     * [ai.zodecode.client.session.views.question.QuestionView]). Calling with
