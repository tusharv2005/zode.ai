package ai.zodecode.client.session.scroll
...
internal class SessionScroll(
    ...
    init {
        jump = JBLabel(ScrollButtonIcon.create()).apply {
            ...
            toolTipText = ZodeBundle.message("session.scroll.bottom")
            isVisible = false
    ...
    private fun syncIcon() {
        ...
        jump.toolTipText = ZodeBundle.message(if (question) "session.scroll.question" else "session.scroll.bottom")
    }
