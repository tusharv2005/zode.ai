...
class PromptPanelTest : BasePlatformTestCase() {
    ...
    fun `test prompt button switches between send and stop state`() {
        ...
        assertEquals(KeymapUtil.createTooltipText("Send", "Zode.SendPrompt"), panel.buttonForTest().toolTipText)
    ...
    fun `test auto approve button toggles and updates tooltip`() {
        ...
        assertEquals(ZodeBundle.message("prompt.action.autoApprove.enable"), button.accessibleContext.accessibleName)
        assertEquals(ZodeBundle.message("prompt.action.autoApprove.disabled.tooltip"), button.toolTipText)
        ...
        assertEquals(ZodeBundle.message("prompt.action.autoApprove.disable"), button.accessibleContext.accessibleName)
        assertEquals(ZodeBundle.message("prompt.action.autoApprove.enabled.tooltip"), button.toolTipText)
    ...
    private fun autoApproveButton(panel: PromptPanel): JButton {
        val enable = ZodeBundle.message("prompt.action.autoApprove.enable")
        val disable = ZodeBundle.message("prompt.action.autoApprove.disable")
