...
class HistoryControllerTest : BasePlatformTestCase() {
    ...
    fun `test history panel sync updates running badges`() {
        ...
        assertEquals(ZodeBundle.message("session.part.tool.running"), panel.badgeText(0))
    }
    ...
    fun `test history panel overlay shows specific badge`() {
        ...
        assertEquals(ZodeBundle.message("history.badge.permission"), panel.badgeText(0))
    }
    ...
    fun `test history panel sync repaints activity kind change`() {
        ...
        assertEquals(ZodeBundle.message("history.badge.question"), panel.badgeText(0))
    }
    ...
    fun `test panel shows back button with tabs`() {
        ...
        assertEquals(ZodeBundle.message("history.back"), panel.backText())
    ...
    fun `test cloud history uses relative time and sections`() {
        ...
        assertEquals(ZodeBundle.message("history.time.hours", 5), HistoryTime.relative(today, now.toEpochMilli()))
        ...
        assertEquals(ZodeBundle.message("history.time.hours", 10), HistoryTime.relative(offset, now.toEpochMilli()))
    }
