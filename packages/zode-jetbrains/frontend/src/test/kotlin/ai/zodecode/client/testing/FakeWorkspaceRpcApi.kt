...
/**
 * Fake [ZodeWorkspaceRpcApi] for testing.
 *
 ...
 */
class FakeWorkspaceRpcApi : ZodeWorkspaceRpcApi {

    var directory = "/test"
    val state = MutableStateFlow(ZodeWorkspaceStateDto(ZodeWorkspaceStatusDto.PENDING))
    var reloads = 0
        private set
    ...
    var openResult = true
    var localConfigPath = "/test/.zode/zode.jsonc"
    var globalConfigPath = "/config/zode.jsonc"
