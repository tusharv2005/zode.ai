...
/**
 * Base class for [ai.zodecode.client.session.controller.SessionController] tests.
 *
...
abstract class SessionControllerTestBase : BasePlatformTestCase() {
    ...
    protected data class Snapshot(
        ...
        val diff: List<ai.zodecode.rpc.dto.DiffFileDto>,
        val todos: List<ai.zodecode.rpc.dto.TodoDto>,
        val compacted: Int,
    ) {
    ...
    protected lateinit var sessions: ZodeSessionService
    protected lateinit var app: ZodeAppService
    protected lateinit var workspaces: ZodeWorkspaceService
    ...
    override fun setUp() {
        ...
        app = ZodeAppService(scope, appRpc)
        workspaces = ZodeWorkspaceService(scope, projectRpc)
    ...
    protected fun assertQuestionReply(expected: String, replies: List<Triple<String, String, ai.zodecode.rpc.dto.QuestionReplyDto>>) {
    ...
    protected fun workspaceReady(
        ...
        connected: List<String> = listOf("zode"),
        defaults: Map<String, String> = emptyMap(),
    ) = ZodeWorkspaceStateDto(
