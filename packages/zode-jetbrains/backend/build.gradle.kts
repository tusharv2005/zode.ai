...
openApiGenerate {
    ...
    packageName.set("ai.zodecode.jetbrains.api")
    apiPackage.set("ai.zodecode.jetbrains.api.client")
    modelPackage.set("ai.zodecode.jetbrains.api.model")
...
val prepareLocalCli by tasks.registering(PrepareLocalCliTask::class) {
    ...
    dir.set(cliDir)
    bunPath.convention(
        providers.gradleProperty("zode.bun.path")
