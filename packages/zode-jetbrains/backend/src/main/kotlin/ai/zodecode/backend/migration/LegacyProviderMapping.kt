...
/**
 * Port of packages/zode-vscode/src/legacy-migration/provider-mapping.ts
 *
...
val PROVIDER_MAP: Map<String, ProviderMapping> = mapOf(
    ...
    "zodecode" to ProviderMapping(id = "zode", key = "zodecodeToken", name = "Zode (Gateway)", modelField = "zodecodeModel", organizationIdField = "zodecodeOrganizationId"),
