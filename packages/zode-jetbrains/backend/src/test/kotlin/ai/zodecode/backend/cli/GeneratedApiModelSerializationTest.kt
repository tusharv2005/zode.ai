 ...
 * [ai.zodecode.jetbrains.api.model.*] serialize/deserialize correctly
 ...
 * spec — not our handwritten RPC DTOs in [ai.zodecode.rpc.dto.*].
 *
 * Tests here protect against:
 * - OpenAPI generator/schema drift producing incompatible Kotlin classes
 * - Generated enum mappings breaking (e.g. [ai.zodecode.jetbrains.api.model.Model.Status])
 * - Unknown CLI response fields causing deserialization failures
 * - Nested generated structures like model [ai.zodecode.jetbrains.api.model.Model.capabilities]
 *   not matching expected shapes
 *
 * Do not add assertions for Zode-specific fields here unless those fields
 ...
 * [ZodeCliDataParserTest] or workspace mapping tests.
 */
