...
import ai.zodecode.rpc.dto.AgentConfigPatchDto
...
import ai.zodecode.rpc.dto.PromptPartDto
...
/**
 * Pure unit tests for [ZodeCliDataParser].
 *
...
class ZodeCliDataParserTest {
    ...
    inner class SseEvents {
        ...
        fun `extractEventType - parses type from JSON data`() {
            val result = ZodeCliDataParser.extractEventType(
        ...
        fun `extractEventType - returns unknown for missing type`() {
            assertEquals("unknown", ZodeCliDataParser.extractEventType("""{"data":"something"}"""))
        }

        @Test
        fun `extractEventType - returns unknown for empty string`() {
            assertEquals("unknown", ZodeCliDataParser.extractEventType(""))
        }
        ...
        fun `parseChatEvent - message updated with GlobalEvent wrapper`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("message.updated", data)
        ...
        fun `parseChatEvent - message part delta`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("message.part.delta", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part updated`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("message.part.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - todowrite part parses typed todo metadata`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("message.part.updated", data) as ChatEventDto.PartUpdated
        ...
        fun `parseChatEvent - turn open`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.turn.open", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - turn close`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.turn.close", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session error`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.error", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message removed`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("message.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - message part removed`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("message.part.removed", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session idle`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = ZodeCliDataParser.parseChatEvent("session.idle", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session compacted`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            val result = ZodeCliDataParser.parseChatEvent("session.compacted", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session updated`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session created`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.created", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.diff", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session diff clamps large counts`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.diff", data) as ChatEventDto.SessionDiffChanged
        ...
        fun `parseChatEvent - todo updated`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("todo.updated", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - session status idle`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("session.status", data) as ChatEventDto.SessionStatusChanged
        ...
        fun `parseChatEvent - permission asked`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("permission.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - permission replied`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("permission.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question asked`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("question.asked", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question replied`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("question.replied", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - question rejected`() {
            ...
            val result = ZodeCliDataParser.parseChatEvent("question.rejected", data)
            assertNotNull(result)
        ...
        fun `parseChatEvent - unknown type returns null`() {
            val data = globalEvent("""
                ...
                "properties": { "sessionID": "ses_1" }
            """)
            assertNull(ZodeCliDataParser.parseChatEvent("some.unknown.event", data))
        }

        @Test
        fun `parseChatEvent - malformed JSON returns null`() {
            assertNull(ZodeCliDataParser.parseChatEvent("message.updated", "not json"))
        }

        @Test
        fun `parseChatEvent - missing properties returns null`() {
            assertNull(ZodeCliDataParser.parseChatEvent("message.updated", """{"payload":{"type":"x"}}"""))
        }
        ...
        fun `parseChatEvent - missing sessionID returns null`() {
            ...
            """)
            assertNull(ZodeCliDataParser.parseChatEvent("message.updated", data))
        }
        ...
        fun `parseSessionStatus - valid status event`() {
            ...
            val result = ZodeCliDataParser.parseSessionStatus(data)
            assertNotNull(result)
        ...
        fun `parseSessionStatus - missing sessionID returns null`() {
            ...
            assertNull(ZodeCliDataParser.parseSessionStatus(data))
        }
        ...
        fun `parsePermissionRequests - parses list`() {
            ...
            val result = ZodeCliDataParser.parsePermissionRequests(raw)
        ...
        fun `parsePermissionRequests - empty list`() {
            assertEquals(emptyList(), ZodeCliDataParser.parsePermissionRequests("[]"))
        }
        ...
        fun `parseQuestionRequests - parses list`() {
            ...
            val result = ZodeCliDataParser.parseQuestionRequests(raw)
            assertEquals(1, result.size)
    ...
    inner class HttpResponses {
        ...
        fun `parseSession - full session response`() {
            ...
            val result = ZodeCliDataParser.parseSession(raw)
        ...
        fun `parseMessages - empty array`() {
            assertEquals(emptyList(), ZodeCliDataParser.parseMessages("[]"))
        }
        ...
        fun `parseMessages - user and assistant messages`() {
            ...
            val result = ZodeCliDataParser.parseMessages(raw)
        ...
        fun `parseMessages - step finish part with tokens`() {
            ...
            val part = ZodeCliDataParser.parseMessages(raw)[0].parts[0]
        ...
        fun `parseMessages - malformed JSON returns empty`() {
            assertEquals(emptyList(), ZodeCliDataParser.parseMessages("not json"))
        }
        ...
        fun `parseCloudSessions maps cloud session list`() {
            ...
            val result = ZodeCliDataParser.parseCloudSessions(raw)
        ...
        fun `parseCloudSessions tolerates malformed response`() {
            assertEquals(emptyList(), ZodeCliDataParser.parseCloudSessions("not json").sessions)
            assertNull(ZodeCliDataParser.parseCloudSessions("{}").nextCursor)
        }
        ...
        fun `parseProviders - maps provider id, name, source, connected, and defaults`() {
            ...
            val result = ZodeCliDataParser.parseProviders(raw)
        ...
        fun `parseProviders - maps model capabilities, limit, and recommendedIndex`() {
            ...
            val provider = ZodeCliDataParser.parseProviders(raw).providers[0]
        ...
        fun `parseProviders - orders variants by effort rank then name`() {
            ...
            val model = ZodeCliDataParser.parseProviders(raw).providers[0].models["m"]
            assertNotNull(model)
        ...
        fun `parseProviders - missing collections default to empty`() {
            val result = ZodeCliDataParser.parseProviders("""{"all":[],"default":{},"connected":[]}""")
        ...
        fun `parseProviders - throws for malformed JSON`() {
            assertFailsWith<Exception> {
                ZodeCliDataParser.parseProviders("not json")
            }
        }
        ...
        fun `parseProviders - throws for non-object JSON`() {
            assertFailsWith<Exception> {
                ZodeCliDataParser.parseProviders("""[1,2,3]""")
            }
        }
        ...
        fun `parseCommands - maps name, description, source, and hints`() {
            ...
            val result = ZodeCliDataParser.parseCommands(raw)
        ...
        fun `parseCommands - empty array`() {
            assertEquals(emptyList<CommandInfo>(), ZodeCliDataParser.parseCommands("[]"))
        }
        ...
        fun `parsePathState - extracts state from valid path response`() {
            val raw = """{"home":"/home/user","state":"/home/user/.local/state/zode","config":"/home/user/.config/zode","worktree":"/project","directory":"/project"}"""
            assertEquals("/home/user/.local/state/zode", ZodeCliDataParser.parsePathState(raw))
        }

        @Test
        fun `parsePathState - returns null for missing state field`() {
            assertNull(ZodeCliDataParser.parsePathState("""{"home":"/home/user"}"""))
        }

        @Test
        fun `parsePathState - returns null for malformed JSON`() {
            assertNull(ZodeCliDataParser.parsePathState("not json"))
        }

        @Test
        fun `parsePathState - returns null for non-string state value`() {
            assertNull(ZodeCliDataParser.parsePathState("""{"state":42}"""))
            assertNull(ZodeCliDataParser.parsePathState("""{"state":null}"""))
            assertNull(ZodeCliDataParser.parsePathState("""{"state":{}}"""))
        }
    }
    ...
    inner class RequestBuilders {
        ...
        fun `buildPromptJson - text only`() {
            ...
            val result = ZodeCliDataParser.buildPromptJson(prompt)
        ...
        fun `buildSummarizeJson - writes provider and model`() {
            val result = ZodeCliDataParser.buildSummarizeJson(ModelSelectionDto("anthropic", "claude-4"))
        ...
        fun `buildConfigPartial - model only`() {
            val result = ZodeCliDataParser.buildConfigPartial(ConfigUpdateDto(model = "anthropic/claude-4"))
            assertEquals("""{"model":"anthropic/claude-4"}""", result)
        }

        @Test
        fun `buildConfigPartial - agent and temperature`() {
            val result = ZodeCliDataParser.buildConfigPartial(
        ...
        fun `buildConfigPartial - empty update`() {
            val result = ZodeCliDataParser.buildConfigPartial(ConfigUpdateDto())
            assertEquals("{}", result)
        }
        ...
        fun `buildConfigPatch - top-level model set`() {
            ...
            assertEquals("{\"model\":\"anthropic/claude\"}", ZodeCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - top-level model clear emits null`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to null))
            assertEquals("{\"model\":null}", ZodeCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - small and subagent values`() {
            val patch = ConfigPatchDto(values = linkedMapOf("small_model" to "zode/auto-small", "subagent_model" to null, "subagent_variant" to null))
            assertEquals("{\"small_model\":\"zode/auto-small\",\"subagent_model\":null,\"subagent_variant\":null}", ZodeCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - per-agent model set`() {
            val patch = ConfigPatchDto(agents = linkedMapOf("code" to AgentConfigPatchDto(model = "zode/gpt-5")))
            assertEquals("{\"agent\":{\"code\":{\"model\":\"zode/gpt-5\"}}}", ZodeCliDataParser.buildConfigPatch(patch))
        }
        ...
        fun `buildConfigPatch - per-agent model clear emits null`() {
            ...
            assertEquals("{\"agent\":{\"code\":{\"model\":null}}}", ZodeCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPatch - empty patch`() {
            assertEquals("{}", ZodeCliDataParser.buildConfigPatch(ConfigPatchDto()))
        }

        @Test
        fun `buildConfigPatch - escapes special characters`() {
            val patch = ConfigPatchDto(values = linkedMapOf("model" to "zode/a\\b\"c"))
            assertEquals("{\"model\":\"zode/a\\\\b\\\"c\"}", ZodeCliDataParser.buildConfigPatch(patch))
        }

        @Test
        fun `buildConfigPartial - temperature without agent defaults to ask`() {
            val result = ZodeCliDataParser.buildConfigPartial(ConfigUpdateDto(temperature = 0.5))
        ...
        fun `buildPermissionReplyJson - once reply`() {
            val result = ZodeCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "once"))
            assertEquals("""{"reply":"once"}""", result)
        }

        @Test
        fun `buildPermissionReplyJson - always reply with message`() {
            val result = ZodeCliDataParser.buildPermissionReplyJson(PermissionReplyDto(reply = "always", message = "approved"))
        ...
        fun `buildPermissionAlwaysRulesJson - approved list`() {
            val result = ZodeCliDataParser.buildPermissionAlwaysRulesJson(
        ...
        fun `buildQuestionReplyJson - single question single answer`() {
            val result = ZodeCliDataParser.buildQuestionReplyJson(QuestionReplyDto(answers = listOf(listOf("A"))))
            assertEquals("""{"answers":[["A"]]}""", result)
        }

        @Test
        fun `buildQuestionReplyJson - multiple questions`() {
            val result = ZodeCliDataParser.buildQuestionReplyJson(
        ...
        fun `parseModelState - parses favorites`() {
            val result = ZodeCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"zode","modelID":"auto"},{"providerID":"openai","modelID":"gpt"}]}""",
            )
            assertEquals(listOf("zode/auto", "openai/gpt"), result.favorite.map { "${it.providerID}/${it.modelID}" })
        }
        ...
        fun `parseModelState - parses model selections and variants`() {
            val result = ZodeCliDataParser.parseModelState(
                """{"model":{"code":{"providerID":"zode","modelID":"auto"}},"variant":{"zode/auto":"medium"}}""",
            )
            assertEquals("zode", result.model["code"]?.providerID)
            assertEquals("auto", result.model["code"]?.modelID)
            assertEquals("medium", result.variant["zode/auto"])
        }

        @Test
        fun `parseModelState - drops malformed favorites`() {
            val result = ZodeCliDataParser.parseModelState(
                """{"favorite":[{"providerID":"zode"},false,{"providerID":"openai","modelID":"gpt"}]}""",
            )
        ...
        fun `parseModelState - malformed inputs return empty favorites`() {
            for (raw in listOf("", "not-json", "[]", "42", "null")) {
                assertTrue(ZodeCliDataParser.parseModelState(raw).favorite.isEmpty(), raw)
            }
        }
        ...
        fun `parseModelState - drops malformed model selections and variants`() {
            val result = ZodeCliDataParser.parseModelState(
                """{"model":{"bad":false,"ok":{"providerID":"zode","modelID":"auto"}},"variant":{"":"low","zode/auto":false,"openai/gpt":"high"}}""",
            )
        ...
        fun `buildModelStateJson - preserves unrelated keys and replaces favorites`() {
            val raw = """{"model":{"code":{"providerID":"zode","modelID":"auto"}},"recent":[{"providerID":"old","modelID":"recent"}],"variant":{"zode/auto":"fast"},"extra":true,"favorite":[]}"""
            val result = ZodeCliDataParser.buildModelStateJson(raw, listOf(ModelSelectionDto("anthropic", "claude")))
            ...
            assertEquals(listOf("anthropic/claude"), ZodeCliDataParser.parseModelState(result).favorite.map { "${it.providerID}/${it.modelID}" })
        }

        @Test
        fun `buildModelStateJson - writes model selections and variants`() {
            val raw = """{"recent":[],"extra":true}"""
            val result = ZodeCliDataParser.buildModelStateJson(
                raw,
                ModelStateDto(
                    model = mapOf("code" to ModelSelectionDto("zode", "auto")),
                    variant = mapOf("zode/auto" to "medium"),
                    recent = listOf(ModelSelectionDto("anthropic", "claude")),
                ),
            )

            val state = ZodeCliDataParser.parseModelState(result)
