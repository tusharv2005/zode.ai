...
import ai.zodecode.jetbrains.api.model.AppSkills200ResponseInner
import ai.zodecode.jetbrains.api.model.Command
import ai.zodecode.jetbrains.api.model.ProviderList200Response
...
class ProjectModelSerializationTest {
    ...
    fun `provider list with isFree and status`() {
        ...
        assertEquals(
            ai.zodecode.jetbrains.api.model.Model.Status.BETA,
            model.status,
        )
    }
