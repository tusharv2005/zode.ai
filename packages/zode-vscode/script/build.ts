...
const version = process.env.ZODE_VERSION ? process.env.ZODE_VERSION : packageJson.version
const prerelease = process.env.ZODE_PRE_RELEASE === "true"
...
const targets = [
  { target: "linux-x64", cliDir: "@zodecode/cli-linux-x64", binary: "zode" },
  { target: "linux-arm64", cliDir: "@zodecode/cli-linux-arm64", binary: "zode" },
  { target: "alpine-x64", cliDir: "@zodecode/cli-linux-x64-musl", binary: "zode" },
  { target: "alpine-arm64", cliDir: "@zodecode/cli-linux-arm64-musl", binary: "zode" },
  { target: "darwin-x64", cliDir: "@zodecode/cli-darwin-x64", binary: "zode" },
  { target: "darwin-arm64", cliDir: "@zodecode/cli-darwin-arm64", binary: "zode" },
  { target: "win32-x64", cliDir: "@zodecode/cli-windows-x64", binary: "zode.exe" },
  { target: "win32-arm64", cliDir: "@zodecode/cli-windows-arm64", binary: "zode.exe" },
]
...
for (const config of targets) {
  ...
  const vsixPath = join(outDir, `zode-vscode-${config.target}.vsix`)
