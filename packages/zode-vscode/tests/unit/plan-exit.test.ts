...
describe("planDisplayPath", () => {
  it("returns a relative path unchanged", () => {
    expect(planDisplayPath(".zode/plans/my-plan.md", "/repo")).toBe(".zode/plans/my-plan.md")
  })

  it("returns absolute path inside repo as repo-relative", () => {
    expect(planDisplayPath("/repo/.zode/plans/my-plan.md", "/repo")).toBe(".zode/plans/my-plan.md")
  })
  ...
  it("handles Windows absolute paths inside root", () => {
    expect(planDisplayPath("C:\\repo\\.zode\\plans\\plan.md", "C:\\repo")).toBe(".zode\\plans\\plan.md")
  })
