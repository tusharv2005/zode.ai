...
describe("buildFeedbackProperties — non-Zode providers", () => {
...
describe("buildFeedbackProperties — Zode Gateway", () => {
  it("includes sessionID, messageID, parentMessageID", () => {
    const props = buildFeedbackProperties({ ...baseInput, providerID: "zode", next: "up" })
    expect(props).toEqual({
      providerID: "zode",
      modelID: "claude-sonnet-4-5",
      rating: "up",
