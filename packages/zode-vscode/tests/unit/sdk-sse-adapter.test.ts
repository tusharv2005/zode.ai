...
import { ZodeConnectionService } from "../../src/services/cli-backend/connection-service"
...
function client(open: (opts: Opts) => Stream): ZodeClient {
  return {
    global: {
...
describe("ZodeConnectionService backend crash", () => {
...
describe("ZodeConnectionService SSE startup", () => {
