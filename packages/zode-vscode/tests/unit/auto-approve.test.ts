...
import { createAutoApproveBridge } from "../../src/zode-provider/auto-approve"
import type { Event, ZodeClient } from "@zodecode/sdk/v2/client"
import type { ZodeConnectionService } from "../../src/services/cli-backend/connection-service"
...
function config(initial: boolean, info: Record<string, unknown> = {}) {
  ...
  return {
    ...
    emit(key = "zode-code.new.autoApprove.enabled") {
...
function connection(client: ZodeClient | null) {
  ...
  } as unknown as ZodeConnectionService
