 ...
 *   - Webview (sidebar + agent manager): merged from app, ui, zode-i18n, agent-manager dicts
...
// Layer 2: upstream UI (@opencode-ai/ui re-exported via @zodecode/zode-ui)
...
// Layer 3: zode-i18n overrides
import { dict as zodeEn } from "../../../zode-i18n/src/en"
import { dict as zodeZh } from "../../../zode-i18n/src/zh"
import { dict as zodeZht } from "../../../zode-i18n/src/zht"
import { dict as zodeKo } from "../../../zode-i18n/src/ko"
import { dict as zodeDe } from "../../../zode-i18n/src/de"
import { dict as zodeEs } from "../../../zode-i18n/src/es"
import { dict as zodeFr } from "../../../zode-i18n/src/fr"
import { dict as zodeDa } from "../../../zode-i18n/src/da"
import { dict as zodeJa } from "../../../zode-i18n/src/ja"
import { dict as zodePl } from "../../../zode-i18n/src/pl"
import { dict as zodeRu } from "../../../zode-i18n/src/ru"
import { dict as zodeAr } from "../../../zode-i18n/src/ar"
import { dict as zodeNo } from "../../../zode-i18n/src/no"
import { dict as zodeBr } from "../../../zode-i18n/src/br"
import { dict as zodeTh } from "../../../zode-i18n/src/th"
import { dict as zodeBs } from "../../../zode-i18n/src/bs"
import { dict as zodeTr } from "../../../zode-i18n/src/tr"
import { dict as zodeNl } from "../../../zode-i18n/src/nl"
import { dict as zodeUk } from "../../../zode-i18n/src/uk"
import { dict as zodeIt } from "../../../zode-i18n/src/it"
...
const zodeLocales: Record<string, Record<string, string>> = {
  en: zodeEn,
  zh: zodeZh,
  zht: zodeZht,
  ko: zodeKo,
...
const webviewKeys = new Set(Object.keys({ ...appEn, ...uiEn, ...zodeEn, ...amEn }))
...
describe("i18n locale completeness — every English key exists in all locales", () => {
  ...
  it("zode-i18n: every English key has a translation in all locales", () => {
    const missing = findMissingLocaleKeys(zodeEn, zodeLocales)
    if (missing.length > 0) {
      expect(
        missing,
        `Found ${missing.length} missing zode-i18n translation(s):\n${formatLocaleReport(missing)}`,
      ).toEqual([])
    }
    expect(missing).toEqual([])
  })
