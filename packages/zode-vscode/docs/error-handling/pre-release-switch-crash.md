...
**Priority:** P0
**Issue:** [#6083](https://github.com/Zode-Org/zodecode/issues/6083)
...
- Check if both versions attempt to spawn `zode serve` simultaneously causing port/race conflicts
