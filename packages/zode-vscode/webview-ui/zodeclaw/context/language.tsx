// ZodeClaw lightweight language context
//
// Self-contained i18n for the ZodeClaw panel. Does not depend on
...
export function ZodeClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useZodeClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useZodeClawLanguage must be used within ZodeClawLanguageProvider")
  return ctx
}
