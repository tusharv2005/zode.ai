export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen aangeboden door Zode",
  ...
  "provider.connect.apiKey.description":
    "Voer uw {{provider}} API-sleutel in om uw account te verbinden en {{provider}} modellen te gebruiken in Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om uw autorisatiecode op te halen waarmee u uw account kunt verbinden en {{provider}} modellen kunt gebruiken in Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om uw account te verbinden en {{provider}} modellen te gebruiken in Zode.",
  ...
  "speechToText.tooltip.start": "Spraakinvoer starten met Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Meld u aan bij Zode om spraakinvoer te gebruiken.",
  ...
  "dialog.server.description": "Wissel met welke Zode-server deze app verbinding maakt.",
  ...
  "toast.update.description": "Een nieuwe versie van Zode ({{version}}) is nu beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Meld deze fout alsjeblieft aan het Zode team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op, Zode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "Zode bevat gratis modellen, zodat je meteen kunt beginnen.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Zode",
  "settings.general.row.appearance.title": "Uiterlijk",
  "settings.general.row.appearance.description": "Pas aan hoe Zode eruitziet op je apparaat",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Zode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Zode start",
  ...
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Zode.",
  ...
  "settings.providers.betaNotice":
    "Momenteel kan alleen de Zode Gateway-provider worden geconfigureerd in de instellingeninterface. Ondersteuning voor het configureren van andere providers komt binnenkort tijdens de bèta-periode. In de tussentijd kun je providers configureren met behulp van de CLI of het configuratiebestand. We zijn toegewijd om Zode open te houden, geen lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Zode-configuratiebestand",
  ...
  "settings.config.noWorkspace": "Open een werkruimtemap om het lokale Zode-configuratiebestand te bewerken.",
  "settings.config.openFailed": "Kan {{scope}} Zode-configuratiebestand niet openen: {{message}}",
  "settings.config.source.xdg": "XDG globale configuratie",
  "settings.config.source.homeZode": "Home .zode-configuratie",
  "settings.config.source.homeZodecode": "Home .zodecode-configuratie",
  "settings.config.source.homeOpencode": "Home .opencode-configuratie",
  "settings.config.source.envFile": "ZODE_CONFIG omgevingsbestand",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Inline omgevingsconfiguratie",
  "settings.config.source.projectZode": "Project .zode-configuratie",
  "settings.config.source.projectRoot": "Project root configuratie",
  "settings.config.source.projectZodecode": "Verouderde .zodecode-configuratie",
  ...
  "session.cloud.import.placeholder": "Sessie-ID, URL, of zode import commando",
  ...
  "deviceAuth.title": "Meld je aan bij Zode Code",
  ...
  "profile.action.login": "Inloggen met Zode Code",
  ...
  "settings.aboutZodeCode.title": "Over Zode Code",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "Zode Code is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutZodeCode.status.connected": "Verbonden",
  "settings.aboutZodeCode.status.connecting": "Verbinden...",
  "settings.aboutZodeCode.status.disconnected": "Verbinding verbroken",
  "settings.aboutZodeCode.status.error": "Fout",
  "settings.aboutZodeCode.cliServer": "CLI Server",
  "settings.aboutZodeCode.status.label": "Status:",
  "settings.aboutZodeCode.port.label": "Poort:",
  "settings.aboutZodeCode.versionInfo": "Versie-informatie",
  "settings.aboutZodeCode.version.label": "Versie:",
  "settings.aboutZodeCode.extensionName": "Zode Code Extensie",
  "settings.aboutZodeCode.community": "Community & Ondersteuning",
  "settings.aboutZodeCode.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutZodeCode.feedback.or": "of",
  "settings.aboutZodeCode.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutZodeCode.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutZodeCode.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutZodeCode.exportSettings": "Exporteren",
  "settings.aboutZodeCode.importSettings": "Importeren",
  "settings.aboutZodeCode.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Het bestand bevat geen geldige Zode-instellingen.",
  ...
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Dit bestand is geëxporteerd vanuit een nieuwere versie van Zode. Sommige instellingen worden mogelijk genegeerd.",
  ...
  "settings.aboutZodeCode.telemetry.title": "Telemetrie",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de Zode Code UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.experimental.speechToText.description":
    "Schakel spraakinvoer in promptvelden in met uw Zode-account via Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Schakel de Zode-provider in en meld u aan om Speech to Text te gebruiken. Speech to Text wordt momenteel alleen ondersteund met Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Spraak-naar-tekst-model",
  "settings.experimental.speechToTextModel.description": "Kies het Zode Gateway-transcriptiemodel voor spraakinvoer.",
  ...
  "settings.experimental.remote.description":
    "Schakel Remote-bediening van sessies in via Zode Cloud. Dit heeft ook invloed op CLI's op deze machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Laad CLAUDE.md instructies en vaardigheden uit je Claude Code configuratiemap in sessies. Schakel dit in als je wilt dat Zode je Claude Code instructies en vaardigheden gebruikt. Herstart vereist.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Geen MCP-servers geconfigureerd. Voeg MCP-servers toe in zode.jsonc of vraag de agent om ze toe te voegen.",
  ...
  "settings.display.fontSize.description": "Pas de lettergrootte van de Zode webview UI onafhankelijk van VS Code aan.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Legacy Migratie",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Zode Code, inclusief provider API-sleutels en standaard model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Één kleine, efficiënte kern voor elk Zode-product. Een vertrouwde ervaring, hoe je ook wilt werken.",
  ...
  "settings.indexing.zodeModel.title": "Zode-model voorinstelling",
  "settings.indexing.zodeModel.description": "Kies een ondersteund Zode-hosted embeddings model.",
  "settings.indexing.zodeSignIn.title": "Zode-aanmelding vereist",
  "settings.indexing.zodeSignIn.description": "Log in op Zode om hosted embeddings te gebruiken.",
  ...
  "diffViewer.source.session.tooltip":
    "Bestanden die door Zode tijdens de huidige sessie zijn gewijzigd, gebaseerd op snapshots per beurt. Wordt gereset bij het starten van een nieuwe sessie.",
