export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Zode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la tua API key {{provider}} per connettere l'account e usare i modelli {{provider}} in Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere l'account e usare i modelli {{provider}} in Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere l'account e usare i modelli {{provider}} in Zode.",
  ...
  "dialog.server.description": "Cambia il server Zode a cui si connette questa app.",
  ...
  "toast.update.description": "Una nuova versione di Zode ({{version}}) è disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team Zode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" non riuscito. Nota: Zode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zode include modelli gratuiti, così puoi iniziare subito.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione di Zode",
  "settings.general.row.appearance.title": "Aspetto",
  "settings.general.row.appearance.description": "Personalizza l'aspetto di Zode sul tuo dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di Zode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti quando Zode si avvia",
  ...
  "settings.updates.toast.latest.description": "Stai usando la versione più recente di Zode.",
  ...
  "settings.providers.betaNotice":
    "Al momento solo il provider Zode Gateway può essere configurato dall'interfaccia delle impostazioni. Il supporto per altri provider arriverà durante il periodo beta. Nel frattempo puoi configurare i provider con la CLI o il file di configurazione. Ci impegniamo a mantenere Zode aperto, senza lock-in.",
  ...
  "settings.config.title": "Apri file config Zode {{scope}}",
  "settings.config.placeholder":
    "I file config vengono uniti in ordine; i file marcati come caricati influenzano attualmente le impostazioni.",
  "settings.config.noWorkspace": "Apri una cartella workspace per modificare il file config Zode locale.",
  "settings.config.openFailed": "Apertura file config Zode {{scope}} non riuscita: {{message}}",
  "settings.config.source.xdg": "Config globale XDG",
  "settings.config.source.homeZode": "Config home .zode",
  "settings.config.source.homeZodecode": "Config home .zodecode",
  "settings.config.source.homeOpencode": "Config home .opencode",
  "settings.config.source.envFile": "File ambiente ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Config ambiente inline",
  "settings.config.source.projectZode": "Config progetto .zode",
  "settings.config.source.projectRoot": "Config root progetto",
  "settings.config.source.projectZodecode": "Config legacy progetto .zodecode",
  ...
  "session.cloud.import.placeholder": "ID sessione, URL o comando zode import",
  ...
  "deviceAuth.title": "Accedi a Zode Code",
  ...
  "profile.action.login": "Accedi con Zode Code",
  ...
  "settings.aboutZodeCode.title": "Informazioni su Zode Code",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "Zode Code è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutZodeCode.status.connected": "Connesso",
  "settings.aboutZodeCode.status.connecting": "Connessione...",
  "settings.aboutZodeCode.status.disconnected": "Disconnesso",
  "settings.aboutZodeCode.status.error": "Errore",
  "settings.aboutZodeCode.cliServer": "Server CLI",
  "settings.aboutZodeCode.status.label": "Stato:",
  "settings.aboutZodeCode.port.label": "Porta:",
  "settings.aboutZodeCode.versionInfo": "Informazioni versione",
  "settings.aboutZodeCode.version.label": "Versione:",
  "settings.aboutZodeCode.extensionName": "Estensione Zode Code",
  "settings.aboutZodeCode.community": "Community e supporto",
  "settings.aboutZodeCode.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutZodeCode.feedback.or": "oppure",
  "settings.aboutZodeCode.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutZodeCode.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutZodeCode.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutZodeCode.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutZodeCode.exportSettings": "Esporta",
  "settings.aboutZodeCode.importSettings": "Importa",
  "settings.aboutZodeCode.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Il file non contiene impostazioni Zode valide.",
  "settings.aboutZodeCode.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Questo file è stato esportato da una versione più recente di Zode. Alcune impostazioni potrebbero essere ignorate.",
  "settings.aboutZodeCode.importSettings.success":
    "Impostazioni importate. Controlla le modifiche sopra, poi fai clic su Salva.",
  "settings.aboutZodeCode.telemetry.title": "Telemetria",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia Zode Code. "Auto" usa la lingua di VS Code.',
  ...
  "settings.experimental.remote.description":
    "Abilita controllo remoto delle sessioni tramite Zode Cloud. Influenzerà anche le CLI su questa macchina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carica istruzioni CLAUDE.md e skill dalla directory di configurazione Claude Code nelle sessioni. Abilitalo se vuoi che Zode usi istruzioni e skill di Claude Code. Richiede riavvio.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nessun server MCP configurato. Aggiungi server MCP in zode.jsonc, o chiedi all'agente di aggiungerli per te.",
  ...
  "settings.display.fontSize.description":
    "Regola la dimensione del font della webview Zode indipendentemente da VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migrazione legacy",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di Zode Code, incluse API key dei provider e modello predefinito.",
  "migration.whatsNew.title": "Novità in Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un core piccolo ed efficiente per ogni prodotto Zode. Un'esperienza familiare comunque tu scelga di lavorare.",
  ...
  "diffViewer.source.session.tooltip":
    "File modificati da Zode durante la sessione corrente, basati su snapshot per turno. Si resetta quando inizi una nuova sessione.",
  ...
  "settings.experimental.speechToText.description":
    "Abilita input vocale nei campi prompt usando il tuo account Zode tramite Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Abilita e accedi al provider Zode per usare Da voce a testo. Da voce a testo è attualmente supportato solo tramite Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Modello Da voce a testo",
  "settings.experimental.speechToTextModel.description":
    "Scegli il modello di trascrizione Zode Gateway per l'input vocale.",
  ...
  "settings.indexing.zodeModel.title": "Preset modello Zode",
  "settings.indexing.zodeModel.description": "Scegli un modello embedding ospitato da Zode.",
  "settings.indexing.zodeSignIn.title": "Accesso Zode richiesto",
  "settings.indexing.zodeSignIn.description": "Accedi a Zode per usare gli embedding ospitati.",
  ...
  "speechToText.tooltip.start": "Avvia input vocale con Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Accedi a Zode per usare l'input vocale.",
