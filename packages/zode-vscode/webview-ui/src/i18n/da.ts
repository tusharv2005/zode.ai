export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Zode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Zode.",
  ...
  "speechToText.tooltip.start": "Start stemmeinput med Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Log ind på Zode for at bruge stemmeinput.",
  ...
  "dialog.server.description": "Skift hvilken Zode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Zode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Zode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Zode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Zode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Zode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Zode ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Zode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Zode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Zode.",
  ...
  "settings.indexing.zodeModel.title": "Zode-modelpreset",
  "settings.indexing.zodeModel.description": "Vælg en understøttet Zode-hostet embedding-model.",
  "settings.indexing.zodeSignIn.title": "Zode-login kræves",
  "settings.indexing.zodeSignIn.description": "Log ind på Zode for at bruge hostede embeddings.",
  ...
  "settings.providers.betaNotice":
    "I øjeblikket kan kun Zode Gateway-udbyderen konfigureres i indstillingsgrænsefladen. Understøttelse af konfiguration af andre udbydere kommer snart i løbet af betaperioden. I mellemtiden kan du konfigurere udbydere via CLI eller konfigurationsfilen. Vi er dedikerede til at holde Zode åben, ingen lock-in.",
  ...
  "settings.config.title": "Åbn {{scope}} Zode konfigurationsfil",
  "settings.config.placeholder":
    "Konfigurationsfiler flettes i rækkefølge; filer markeret som indlæst påvirker i øjeblikket indstillingerne.",
  "settings.config.noWorkspace": "Åbn en arbejdsområdemappe for at redigere den lokale Zode konfigurationsfil.",
  "settings.config.openFailed": "Kunne ikke åbne {{scope}} Zode konfigurationsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfiguration",
  "settings.config.source.homeZode": "Home .zode konfiguration",
  "settings.config.source.homeZodecode": "Home .zodecode konfiguration",
  ...
  "settings.config.source.projectZode": "Projekt .zode konfiguration",
  "settings.config.source.projectRoot": "Projekt rodkonfiguration",
  "settings.config.source.projectZodecode": "Forældet .zodecode konfiguration",
  ...
  "session.cloud.import.placeholder": "Sessions-ID, URL eller zode import-kommando",
  ...
  "deviceAuth.title": "Log ind på Zode Code",
  ...
  "profile.action.login": "Log ind med Zode Code",
  ...
  "session.messages.welcome":
    "Zode Code er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutZodeCode.status.connected": "Forbundet",
  "settings.aboutZodeCode.status.connecting": "Forbinder...",
  "settings.aboutZodeCode.status.disconnected": "Afbrudt",
  "settings.aboutZodeCode.status.error": "Fejl",
  ...
  "settings.aboutZodeCode.versionInfo": "Versionsinformation",
  "settings.aboutZodeCode.version.label": "Version:",
  "settings.aboutZodeCode.extensionName": "Zode Code-udvidelse",
  "settings.aboutZodeCode.community": "Fællesskab og support",
  ...
  "settings.aboutZodeCode.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutZodeCode.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutZodeCode.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutZodeCode.exportSettings": "Eksportér",
  "settings.aboutZodeCode.importSettings": "Importér",
  "settings.aboutZodeCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Filen indeholder ikke gyldige Zode-indstillinger.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Denne fil blev eksporteret fra en nyere version af Zode. Nogle indstillinger kan blive ignoreret.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til Zode Code-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivér stemmeinput i prompt-felter ved hjælp af din Zode-konto gennem Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Aktivér og log ind på Zode-udbyderen for at bruge Speech to Text. Speech to Text understøttes i øjeblikket kun med Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Model til tale til tekst",
  "settings.experimental.speechToTextModel.description": "Vælg Zode Gateway-transskriptionsmodellen til stemmeinput.",
  ...
  "settings.experimental.remote.description":
    "Aktivér Remote-styring af sessioner via Zode Cloud. Dette vil også påvirke CLI'er på denne maskine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Indlæs CLAUDE.md-instruktioner og -færdigheder fra din Claude Code-konfigurationsmappe i sessioner. Aktivér dette, hvis du vil have Zode til at bruge dine Claude Code-instruktioner og -færdigheder. Kræver genstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigureret. Tilføj MCP-servere i zode.jsonc, eller bed agenten om at tilføje dem.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Zode webview UI uafhængigt af VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Legacy-migrering",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af Zode Code, herunder udbyder API-nøgler og standardmodel.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én lille, effektiv kerne på tværs af alle Zode-produkter. En velkendt oplevelse uanset hvordan du vælger at arbejde.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer ændret af Zode i den aktuelle session, baseret på snapshots pr. tur. Nulstilles, når du starter en ny session.",
