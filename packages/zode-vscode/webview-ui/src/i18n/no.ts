...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Zode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Zode.",
  ...
  "speechToText.tooltip.start": "Start taleinndata med Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Logg på Zode for å bruke taleinndata.",
  ...
  "dialog.server.description": "Bytt hvilken Zode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Zode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Zode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Zode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Zode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Zode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Zode ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Zode er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Zode starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Zode.",
  ...
  "settings.providers.betaNotice":
    "For øyeblikket kan kun Zode Gateway-leverandøren konfigureres i innstillingsgrensesnittet. Støtte for konfigurering av andre leverandører kommer snart i løpet av betaperioden. I mellomtiden kan du konfigurere leverandører via CLI eller konfigurasjonsfilen. Vi er forpliktet til å holde Zode åpent, ingen lock-in.",
  ...
  "settings.config.title": "Åpne {{scope}} Zode-konfigurasjonsfil",
  "settings.config.placeholder":
    "Konfigurasjonsfiler slås sammen i rekkefølge; filer merket som lastet påvirker for øyeblikket innstillingene.",
  "settings.config.noWorkspace": "Åpne en arbeidsområdemappe for å redigere den lokale Zode-konfigurasjonsfilen.",
  "settings.config.openFailed": "Klarte ikke å åpne {{scope}} Zode-konfigurasjonsfil: {{message}}",
  "settings.config.source.xdg": "XDG global konfigurasjon",
  "settings.config.source.homeZode": "Home .zode-konfigurasjon",
  "settings.config.source.homeZodecode": "Home .zodecode-konfigurasjon",
  "settings.config.source.homeOpencode": "Home .opencode-konfigurasjon",
  "settings.config.source.envFile": "ZODE_CONFIG miljøfil",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Innebygd miljøkonfigurasjon",
  "settings.config.source.projectZode": "Prosjekt .zode-konfigurasjon",
  "settings.config.source.projectRoot": "Prosjektets rotkonfigurasjon",
  "settings.config.source.projectZodecode": "Eldre .zodecode-konfigurasjon",
  ...
  "session.cloud.import.placeholder": "Økt-ID, URL eller zode import-kommando",
  ...
  "deviceAuth.title": "Logg inn på Zode Code",
  ...
  "profile.action.login": "Logg inn med Zode Code",
  ...
  "settings.aboutZodeCode.title": "Om Zode Code",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "Zode Code er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutZodeCode.status.connected": "Tilkoblet",
  "settings.aboutZodeCode.status.connecting": "Kobler til...",
  "settings.aboutZodeCode.status.disconnected": "Frakoblet",
  "settings.aboutZodeCode.status.error": "Feil",
  "settings.aboutZodeCode.cliServer": "CLI-server",
  "settings.aboutZodeCode.status.label": "Status:",
  "settings.aboutZodeCode.port.label": "Port:",
  "settings.aboutZodeCode.versionInfo": "Versjonsinformasjon",
  "settings.aboutZodeCode.version.label": "Versjon:",
  "settings.aboutZodeCode.extensionName": "Zode Code-utvidelse",
  "settings.aboutZodeCode.community": "Fellesskap og støtte",
  "settings.aboutZodeCode.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutZodeCode.feedback.or": "eller",
  "settings.aboutZodeCode.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutZodeCode.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutZodeCode.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutZodeCode.exportSettings": "Eksporter",
  "settings.aboutZodeCode.importSettings": "Importer",
  "settings.aboutZodeCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Filen inneholder ikke gyldige Zode-innstillinger.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Denne filen ble eksportert fra en nyere versjon av Zode. Noen innstillinger kan bli ignorert.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for Zode Code-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.speechToText.description":
    "Aktiver taleinndata i prompt-felt ved å bruke din Zode-konto gjennom Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Aktiver og logg på Zode-leverandøren for å bruke Speech to Text. Speech to Text støttes for øyeblikket bare med Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Tale-til-tekst-modell",
  "settings.experimental.speechToTextModel.description": "Velg Zode Gateway-transkripsjonsmodellen for taleinndata.",
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Zode Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.indexing.zodeModel.title": "Zode-modellforhåndsvalg",
  "settings.indexing.zodeModel.description": "Velg en støttet Zode-hostet embedding-modell.",
  "settings.indexing.zodeSignIn.title": "Zode-pålogging kreves",
  "settings.indexing.zodeSignIn.description": "Logg inn på Zode for å bruke hostede embeddings.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Last inn CLAUDE.md-instruksjoner og ferdigheter fra Claude Code-konfigurasjonsmappen din i økter. Aktiver dette hvis du vil at Zode skal bruke dine Claude Code-instruksjoner og ferdigheter. Krever omstart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Ingen MCP-servere konfigurert. Legg til MCP-servere i zode.jsonc, eller be agenten om å legge dem til.",
  ...
  "settings.display.fontSize.description": "Juster skriftstørrelsen for Zode webview UI uavhengig av VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Zode Code, inkludert API-nøkler for leverandører og standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Én liten, effektiv kjerne på tvers av alle Zode-produkter. En kjent opplevelse uansett hvordan du velger å jobbe.",
  ...
  "diffViewer.source.session.tooltip":
    "Filer endret av Zode i løpet av gjeldende økt, basert på øyeblikksbilder per tur. Tilbakestilles når du starter en ny økt.",
