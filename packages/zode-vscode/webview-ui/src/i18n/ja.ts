export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Zodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Zodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してZodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Zodeで{{provider}}モデルを使用してください。",
  ...
  "speechToText.tooltip.start": "Zode Gatewayで音声入力を開始",
  ...
  "speechToText.error.loginRequired": "音声入力を使用するにはZodeにサインインしてください。",
  ...
  "dialog.server.description": "このアプリが接続するZodeサーバーを切り替えます。",
  ...
  "toast.update.description": "Zodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをZodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: ZodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Zodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.general.row.language.description": "Zodeの表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでのZodeの表示をカスタマイズします",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Zodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Zode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Zode は最新バージョンです。",
  ...
  "settings.indexing.zodeModel.title": "Zodeモデルプリセット",
  "settings.indexing.zodeModel.description": "サポートされているZodeホスト型埋め込みモデルを選択します。",
  "settings.indexing.zodeSignIn.title": "Zodeへのサインインが必要です",
  "settings.indexing.zodeSignIn.description": "ホスト型埋め込みを使用するにはZodeにサインインしてください。",
  ...
  "settings.providers.betaNotice":
    "現在、設定画面で設定できるのはZode Gatewayプロバイダーのみです。他のプロバイダーの設定については、ベータ期間中にまもなく対応予定です。それまでの間は、CLIまたは設定ファイルを使用してプロバイダーを設定できます。私たちはZodeをオープンに保ち、ロックインのない状態を維持することをお約束します。",
  ...
  "settings.config.title": "{{scope}}のZode構成ファイルを開く",
  "settings.config.placeholder":
    "構成ファイルは順番にマージされます。読み込み済みとしてマークされているファイルが現在設定に影響しています。",
  "settings.config.noWorkspace": "ローカルのZode構成ファイルを編集するには、ワークスペースフォルダーを開いてください。",
  "settings.config.openFailed": "{{scope}}のZode構成ファイルを開けませんでした: {{message}}",
  "settings.config.source.xdg": "XDGグローバル構成",
  "settings.config.source.homeZode": "Homeの.zode構成",
  "settings.config.source.homeZodecode": "Homeの.zodecode構成",
  "settings.config.source.homeOpencode": "Homeの.opencode構成",
  "settings.config.source.envFile": "ZODE_CONFIG環境ファイル",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "インライン環境構成",
  "settings.config.source.projectZode": "プロジェクトの.zode構成",
  "settings.config.source.projectRoot": "プロジェクトルート構成",
  "settings.config.source.projectZodecode": "旧.zodecode構成",
  ...
  "session.cloud.import.placeholder": "セッションID、URL、またはzode importコマンド",
  ...
  "deviceAuth.title": "Zode Codeにサインイン",
  ...
  "profile.action.login": "Zode Codeでログイン",
  ...
  "settings.aboutZodeCode.title": "Zode Codeについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "Zode CodeはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutZodeCode.status.connected": "接続済み",
  "settings.aboutZodeCode.status.connecting": "接続中...",
  "settings.aboutZodeCode.status.disconnected": "切断",
  "settings.aboutZodeCode.status.error": "エラー",
  "settings.aboutZodeCode.cliServer": "CLIサーバー",
  "settings.aboutZodeCode.status.label": "ステータス：",
  "settings.aboutZodeCode.port.label": "ポート：",
  "settings.aboutZodeCode.versionInfo": "バージョン情報",
  "settings.aboutZodeCode.version.label": "バージョン：",
  "settings.aboutZodeCode.extensionName": "Zode Code拡張機能",
  "settings.aboutZodeCode.community": "コミュニティとサポート",
  "settings.aboutZodeCode.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutZodeCode.feedback.or": "または",
  "settings.aboutZodeCode.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutZodeCode.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutZodeCode.resetSettings.button": "すべての設定をリセット",
  "settings.aboutZodeCode.settingsTransfer.title": "設定の移行",
  "settings.aboutZodeCode.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutZodeCode.exportSettings": "エクスポート",
  "settings.aboutZodeCode.importSettings": "インポート",
  "settings.aboutZodeCode.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutZodeCode.importSettings.invalidConfig": "ファイルに有効な Zode の設定が含まれていません。",
  "settings.aboutZodeCode.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "このファイルはより新しいバージョンの Zode からエクスポートされたものです。一部の設定が無視される場合があります。",
  "settings.aboutZodeCode.importSettings.success":
    "設定をインポートしました。上記の変更内容を確認してから、保存をクリックしてください。",

  "settings.aboutZodeCode.telemetry.title": "テレメトリ",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "Zode Code UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.experimental.speechToText.description":
    "Zode Gateway経由でZodeアカウントを使用して、プロンプトフィールドでの音声入力を有効にします。",
  "settings.experimental.speechToText.disabledDescription":
    "Speech to Text を使用するには、Zode プロバイダーを有効にしてサインインしてください。現在、Speech to Text は Zode Gateway でのみサポートされています。",
  "settings.experimental.speechToTextModel.title": "音声認識モデル",
  "settings.experimental.speechToTextModel.description": "音声入力に使用するZode Gateway文字起こしモデルを選択します。",
  ...
  "settings.experimental.remote.description":
    "Zode Cloud 経由でのセッションの Remote コントロールを有効にします。これはこのマシンの CLI にも影響します。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code の設定ディレクトリから CLAUDE.md のインストラクションとスキルをセッションに読み込みます。Zode に Claude Code のインストラクションとスキルを使用させる場合は、これを有効にしてください。再起動が必要です。",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCPサーバーが設定されていません。zode.jsoncでMCPサーバーを追加するか、エージェントに追加を依頼してください。",
  ...
  "settings.display.fontSize.description": "VS Code とは独立して Zode webview UI のフォントサイズを調整します。",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "レガシー移行",
  "settings.aboutZodeCode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたZode Codeから設定を移行します。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Zode Codeの新機能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "すべてのZode製品で共有される小さく効率的なコア。どのような作業スタイルでも馴染みのある体験を提供します。",
  ...
  "diffViewer.source.session.tooltip":
    "現在のセッション中に Zode が変更したファイル。ターンごとのスナップショットに基づきます。新しいセッションを開始するとリセットされます。",
