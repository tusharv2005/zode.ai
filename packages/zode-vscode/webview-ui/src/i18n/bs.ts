export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Zode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Zode-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Zode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Zode-u.",
  ...
  "speechToText.tooltip.start": "Započni glasovni unos sa Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Prijavite se na Zode da koristite glasovni unos.",
  ...
  "dialog.server.description": "Promijeni na koji se Zode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Zode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Zode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Zode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Zode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Zode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Zode izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Zode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Zode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Zode-a.",
  ...
  "settings.indexing.zodeModel.title": "Preset Zode modela",
  "settings.indexing.zodeModel.description": "Odaberite podržani model embeddinga hostovan na Zode.",
  "settings.indexing.zodeSignIn.title": "Potrebna je prijava na Zode",
  "settings.indexing.zodeSignIn.description": "Prijavite se na Zode za korištenje hostovanih embeddinga.",
  ...
  "settings.providers.betaNotice":
    "Trenutno se samo Zode Gateway provajder može konfigurisati u interfejsu za postavke. Podrška za konfigurisanje drugih provajdera stiže uskoro tokom beta perioda. U međuvremenu, provajdere možete konfigurisati koristeći CLI ili konfiguracijsku datoteku. Posvećeni smo tome da Zode ostane otvoren, bez vezivanja.",
  ...
  "settings.config.title": "Otvori {{scope}} Zode konfiguracijsku datoteku",
  "settings.config.placeholder":
    "Konfiguracijske datoteke se spajaju po redu; datoteke označene kao učitane trenutno utiču na postavke.",
  "settings.config.noWorkspace": "Otvorite fasciklu radnog prostora da uredite lokalnu Zode konfiguracijsku datoteku.",
  "settings.config.openFailed": "Nije uspjelo otvaranje {{scope}} Zode konfiguracijske datoteke: {{message}}",
  "settings.config.source.xdg": "XDG globalna konfiguracija",
  "settings.config.source.homeZode": "Home .zode konfiguracija",
  "settings.config.source.homeZodecode": "Home .zodecode konfiguracija",
  "settings.config.source.homeOpencode": "Home .opencode konfiguracija",
  "settings.config.source.envFile": "ZODE_CONFIG datoteka okruženja",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Ugrađena konfiguracija okruženja",
  "settings.config.source.projectZode": "Projektna .zode konfiguracija",
  "settings.config.source.projectRoot": "Konfiguracija korijena projekta",
  "settings.config.source.projectZodecode": "Zastarjela .zodecode konfiguracija",
  ...
  "session.cloud.import.placeholder": "ID sesije, URL ili zode import naredba",
  ...
  "deviceAuth.title": "Prijavite se u Zode Code",
  ...
  "profile.action.login": "Prijavite se putem Zode Code",
  ...
  "settings.aboutZodeCode.title": "O Zode Code-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "Zode Code je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutZodeCode.status.connected": "Povezano",
  "settings.aboutZodeCode.status.connecting": "Povezivanje...",
  "settings.aboutZodeCode.status.disconnected": "Odspojeno",
  "settings.aboutZodeCode.status.error": "Greška",
  ...
  "settings.aboutZodeCode.versionInfo": "Informacije o verziji",
  "settings.aboutZodeCode.version.label": "Verzija:",
  "settings.aboutZodeCode.extensionName": "Zode Code ekstenzija",
  "settings.aboutZodeCode.community": "Zajednica i podrška",
  "settings.aboutZodeCode.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutZodeCode.feedback.or": "ili",
  "settings.aboutZodeCode.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutZodeCode.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutZodeCode.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutZodeCode.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutZodeCode.exportSettings": "Izvezi",
  "settings.aboutZodeCode.importSettings": "Uvezi",
  "settings.aboutZodeCode.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Fajl ne sadrži važeće Zode postavke.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Ovaj fajl je izvezen iz novije verzije Zode-a. Neke postavke mogu biti zanemarene.",
  "settings.aboutZodeCode.importSettings.success":
    "Postavke su uvezene. Pregledajte promjene iznad, a zatim kliknite Sačuvaj.",

  "settings.aboutZodeCode.telemetry.title": "Telemetrija",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za Zode Code sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.experimental.speechToText.description":
    "Omogućite glasovni unos u poljima za promptove koristeći vaš Zode račun preko Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Omogućite i prijavite se na Zode provajder da biste koristili Speech to Text. Speech to Text je trenutno podržan samo uz Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Model govora u tekst",
  "settings.experimental.speechToTextModel.description":
    "Odaberite Zode Gateway model za transkripciju za glasovni unos.",
  ...
  "settings.experimental.remote.description":
    "Omogućite Remote kontrolu sesija putem Zode Cloud. Ovo će također utjecati na CLI-jeve na ovoj mašini.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Učitajte CLAUDE.md instrukcije i vještine iz vašeg Claude Code konfiguracijskog direktorija u sesije. Omogućite ovo ako želite da Zode koristi vaše Claude Code instrukcije i vještine. Zahtijeva ponovno pokretanje.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nema konfiguriranih MCP servera. Dodajte MCP servere u zode.jsonc ili zamolite agenta da ih doda.",
  ...
  "settings.display.fontSize.description": "Prilagodite veličinu fonta za Zode webview UI nezavisno od VS Code-a.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije Zode Code, uključujući API ključeve provajdera i podrazumijevani model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno malo, efikasno jezgro kroz sve Zode proizvode. Poznato iskustvo bez obzira na to kako odaberete raditi.",
  ...
  "diffViewer.source.session.tooltip":
    "Datoteke koje je Zode promijenio tokom trenutne sesije, na osnovu snapshota po koraku. Resetuje se kada pokrenete novu sesiju.",
