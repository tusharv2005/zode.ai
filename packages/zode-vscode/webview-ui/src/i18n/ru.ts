export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от Zode",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Zode.",
  ...
  "speechToText.tooltip.start": "Начать голосовой ввод с Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Войдите в Zode, чтобы использовать голосовой ввод.",
  ...
  "dialog.server.description": "Переключите сервер Zode к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия Zode ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Zode",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что Zode пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Zode включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Zode",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как Zode выглядит на вашем устройстве",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Zode.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Zode",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Zode.",
  ...
  "settings.indexing.zodeModel.title": "Предустановка модели Zode",
  "settings.indexing.zodeModel.description": "Выберите поддерживаемую модель эмбеддингов, размещенную в Zode.",
  "settings.indexing.zodeSignIn.title": "Требуется вход в Zode",
  "settings.indexing.zodeSignIn.description": "Войдите в Zode, чтобы использовать размещенные эмбеддинги.",
  ...
  "settings.providers.betaNotice":
    "В настоящее время в интерфейсе настроек можно настроить только провайдер Zode Gateway. Поддержка настройки других провайдеров скоро появится в период бета-тестирования. А пока вы можете настраивать провайдеров с помощью CLI или конфигурационного файла. Мы стремимся сохранить Zode открытым — без привязки к поставщикам.",
  ...
  "settings.config.title": "Открыть файл конфигурации Zode ({{scope}})",
  ...
  "settings.config.noWorkspace":
    "Откройте папку рабочей области для редактирования локального файла конфигурации Zode.",
  "settings.config.openFailed": "Не удалось открыть файл конфигурации Zode ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальная конфигурация XDG",
  "settings.config.source.homeZode": "Конфигурация .zode (Home)",
  "settings.config.source.homeZodecode": "Конфигурация .zodecode (Home)",
  "settings.config.source.homeOpencode": "Конфигурация .opencode (Home)",
  "settings.config.source.envFile": "Файл среды ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Встроенная конфигурация среды",
  "settings.config.source.projectZode": "Конфигурация .zode проекта",
  "settings.config.source.projectRoot": "Корневая конфигурация проекта",
  "settings.config.source.projectZodecode": "Устаревшая конфигурация .zodecode",
  ...
  "session.cloud.import.placeholder": "ID сессии, URL или команда zode import",
  ...
  "deviceAuth.title": "Войти в Zode Code",
  ...
  "profile.action.login": "Войти через Zode Code",
  ...
  "settings.aboutZodeCode.title": "О Zode Code",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "Zode Code — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutZodeCode.status.connected": "Подключено",
  "settings.aboutZodeCode.status.connecting": "Подключение...",
  "settings.aboutZodeCode.status.disconnected": "Отключено",
  "settings.aboutZodeCode.status.error": "Ошибка",
  "settings.aboutZodeCode.cliServer": "CLI-сервер",
  "settings.aboutZodeCode.status.label": "Статус:",
  "settings.aboutZodeCode.port.label": "Порт:",
  "settings.aboutZodeCode.versionInfo": "Информация о версии",
  "settings.aboutZodeCode.version.label": "Версия:",
  "settings.aboutZodeCode.extensionName": "Расширение Zode Code",
  "settings.aboutZodeCode.community": "Сообщество и поддержка",
  "settings.aboutZodeCode.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutZodeCode.feedback.or": "или",
  "settings.aboutZodeCode.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutZodeCode.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Сбросить все настройки",
  "settings.aboutZodeCode.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutZodeCode.exportSettings": "Экспорт",
  "settings.aboutZodeCode.importSettings": "Импорт",
  "settings.aboutZodeCode.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Файл не содержит допустимых настроек Zode.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Этот файл был экспортирован из более новой версии Zode. Некоторые настройки могут быть проигнорированы.",
  "settings.aboutZodeCode.importSettings.success":
    "Настройки импортированы. Просмотрите изменения выше и нажмите «Сохранить».",

  "settings.aboutZodeCode.telemetry.title": "Телеметрия",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса Zode Code. «Авто» использует язык отображения VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Включите голосовой ввод в полях запросов, используя вашу учетную запись Zode через Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Включите провайдер Zode и выполните вход, чтобы использовать Speech to Text. В настоящее время Speech to Text поддерживается только с Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Модель речи в текст",
  "settings.experimental.speechToTextModel.description":
    "Выберите модель транскрипции Zode Gateway для голосового ввода.",
  ...
  "settings.experimental.remote.description":
    "Включите управление Remote сеансами через Zode Cloud. Это также повлияет на CLI на этом компьютере.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Загружать инструкции CLAUDE.md и навыки из каталога конфигурации Claude Code в сессии. Включите эту опцию, если хотите, чтобы Zode использовал ваши инструкции и навыки Claude Code. Требуется перезапуск.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверы не настроены. Добавьте MCP-серверы в zode.jsonc или попросите агента добавить их.",
  ...
  "settings.display.fontSize.description": "Настройте размер шрифта webview UI для Zode независимо от VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutZodeCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки Zode Code, включая API-ключи провайдеров и модель по умолчанию.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Одно компактное и эффективное ядро для всех продуктов Zode. Знакомый опыт независимо от выбранного способа работы.",
  ...
  "diffViewer.source.session.tooltip":
    "Файлы, изменённые Zode в текущей сессии, на основе снимков по ходу. Сбрасывается при начале новой сессии.",
