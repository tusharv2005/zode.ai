...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Zode 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Zode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Zode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 並輸入以下程式碼，以連線你的帳戶並在 Zode 中使用 {{provider}} 模型。",
  ...
  "speechToText.tooltip.start": "使用 Zode Gateway 開始語音輸入",
  ...
  "speechToText.error.loginRequired": "登入 Zode 以使用語音輸入。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Zode 伺服器。",
  ...
  "toast.update.description": "Zode 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Zode 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意：Zode 暫不支援 MCP 認證。',
  ...
  "sidebar.gettingStarted.line1": "Zode 提供免費模型，你可以立即開始使用。",
  ...
  "settings.general.row.language.description": "變更 Zode 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 Zode 在你的裝置上的外觀",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Zode 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Zode 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Zode。",
  ...
  "settings.providers.betaNotice":
    "目前在設定介面中僅能配置 Zode Gateway 供應商。在測試期間，即將推出配置其他供應商的支援。在此期間，您可以使用 CLI 或設定檔來配置供應商。我們致力於保持 Zode 開放，絕不綁定。",
  ...
  "settings.config.title": "開啟 {{scope}} Zode 設定檔",
  "settings.config.placeholder": "設定檔會按順序合併；標記為已載入的檔案目前會影響設定。",
  "settings.config.noWorkspace": "開啟工作區資料夾以編輯本地 Zode 設定檔。",
  "settings.config.openFailed": "無法開啟 {{scope}} Zode 設定檔：{{message}}",
  "settings.config.source.xdg": "XDG 全域設定",
  "settings.config.source.homeZode": "主目錄 .zode 設定",
  "settings.config.source.homeZodecode": "主目錄 .zodecode 設定",
  "settings.config.source.homeOpencode": "主目錄 .opencode 設定",
  "settings.config.source.envFile": "ZODE_CONFIG 環境變數檔案",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "內聯環境設定",
  "settings.config.source.projectZode": "專案 .zode 設定",
  "settings.config.source.projectRoot": "專案根目錄設定",
  "settings.config.source.projectZodecode": "舊版 .zodecode 設定",
  ...
  "session.cloud.import.placeholder": "工作階段 ID、URL 或 zode import 指令",
  ...
  "profile.action.login": "使用 Zode Code 登入",
  ...
  "settings.aboutZodeCode.title": "關於 Zode Code",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "Zode Code 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutZodeCode.status.connected": "已連線",
  "settings.aboutZodeCode.status.connecting": "連線中...",
  "settings.aboutZodeCode.status.disconnected": "已中斷",
  "settings.aboutZodeCode.status.error": "錯誤",
  "settings.aboutZodeCode.cliServer": "CLI 伺服器",
  "settings.aboutZodeCode.status.label": "狀態：",
  "settings.aboutZodeCode.port.label": "連接埠：",
  "settings.aboutZodeCode.versionInfo": "版本資訊",
  "settings.aboutZodeCode.version.label": "版本：",
  "settings.aboutZodeCode.extensionName": "Zode Code 擴充功能",
  "settings.aboutZodeCode.community": "社群與支援",
  "settings.aboutZodeCode.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutZodeCode.feedback.or": "或",
  "settings.aboutZodeCode.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutZodeCode.resetSettings.title": "重置設定",
  "settings.aboutZodeCode.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutZodeCode.resetSettings.button": "重置所有設定",
  "settings.aboutZodeCode.settingsTransfer.title": "設定轉移",
  "settings.aboutZodeCode.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutZodeCode.exportSettings": "匯出",
  "settings.aboutZodeCode.importSettings": "匯入",
  "settings.aboutZodeCode.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutZodeCode.importSettings.invalidConfig": "檔案不包含有效的 Zode 設定。",
  "settings.aboutZodeCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutZodeCode.importSettings.newerVersion": "此檔案由較新版本的 Zode 匯出。部分設定可能會被忽略。",
  "settings.aboutZodeCode.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutZodeCode.telemetry.title": "遙測",
  "settings.aboutZodeCode.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutZodeCode.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 Zode Code 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.speechToText.description": "透過 Zode Gateway 使用您的 Zode 帳戶在提示詞欄位中啟用語音輸入。",
  "settings.experimental.speechToText.disabledDescription":
    "啟用並登入 Zode 供應商以使用 Speech to Text。Speech to Text 目前僅支援透過 Zode Gateway 使用。",
  "settings.experimental.speechToTextModel.title": "語音轉文字模型",
  "settings.experimental.speechToTextModel.description": "選擇用於語音輸入的 Zode Gateway 轉錄模型。",
  ...
  "settings.experimental.remote.description": "透過 Zode Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "從您的 Claude Code 設定目錄將 CLAUDE.md 指示與技能載入至工作階段中。如果您希望 Zode 使用您的 Claude Code 指示與技能，請啟用此選項。需要重新啟動。",
  ...
  "settings.agentBehaviour.mcpEmpty": "未設定 MCP 伺服器。在 zode.jsonc 中新增 MCP 伺服器，或請代理為您新增。",
  ...
  "settings.display.fontSize.description": "獨立於 VS Code 調整 Zode webview UI 的字體大小。",
  ...
  "settings.indexing.zodeModel.title": "Zode 模型預設",
  "settings.indexing.zodeModel.description": "選擇支援的 Zode 託管嵌入模型。",
  "settings.indexing.zodeSignIn.title": "需要登入 Zode",
  "settings.indexing.zodeSignIn.description": "登入 Zode 以使用託管嵌入。",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "舊版遷移",
  "settings.aboutZodeCode.legacyMigration.description":
    "從舊版 Zode Code 安裝遷移設定，包括供應商 API 金鑰和預設模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Zode Code 新功能",
  ...
  "migration.whatsNew.features.foundation.detail":
    "所有 Zode 產品共享一個小巧高效的核心。無論你選擇哪種方式工作，都能獲得熟悉的體驗。",
  ...
  "diffViewer.source.session.tooltip": "Zode 在目前工作階段中變更的檔案，依據每輪快照。開始新工作階段時重置。",
