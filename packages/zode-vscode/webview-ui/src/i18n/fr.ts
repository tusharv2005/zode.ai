export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Zode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Zode.",
  ...
  "speechToText.tooltip.start": "Démarrer la saisie vocale avec Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Connectez-vous à Zode pour utiliser la saisie vocale.",
  ...
  "dialog.server.description": "Changez le serveur Zode auquel cette application se connecte.",
  ...
  "toast.update.description": "Une nouvelle version d'Zode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Zode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Zode ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "Zode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Zode",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Zode sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Zode.",
  ...
  "settings.indexing.zodeModel.title": "Préréglage de modèle Zode",
  "settings.indexing.zodeModel.description": "Choisissez un modèle d'embedding hébergé par Zode pris en charge.",
  "settings.indexing.zodeSignIn.title": "Connexion à Zode requise",
  "settings.indexing.zodeSignIn.description": "Connectez-vous à Zode pour utiliser les embeddings hébergés.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Zode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Zode.",
  ...
  "settings.providers.betaNotice":
    "Actuellement, seul le fournisseur Zode Gateway peut être configuré dans l'interface des paramètres. La prise en charge de la configuration d'autres fournisseurs sera bientôt disponible pendant la période bêta. En attendant, vous pouvez configurer les fournisseurs à l'aide de la CLI ou du fichier de configuration. Nous nous engageons à maintenir Zode ouvert, sans enfermement propriétaire.",
  ...
  "settings.config.title": "Ouvrir le fichier de configuration Zode {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Ouvrez un dossier d'espace de travail pour modifier le fichier de configuration Zode local.",
  "settings.config.openFailed": "Échec de l'ouverture du fichier de configuration Zode {{scope}} : {{message}}",
  "settings.config.source.xdg": "Configuration globale XDG",
  "settings.config.source.homeZode": "Configuration .zode de Home",
  "settings.config.source.homeZodecode": "Configuration .zodecode de Home",
  "settings.config.source.homeOpencode": "Configuration .opencode de Home",
  "settings.config.source.envFile": "Fichier d'environnement ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Configuration d'environnement en ligne",
  "settings.config.source.projectZode": "Configuration .zode du projet",
  "settings.config.source.projectRoot": "Configuration racine du projet",
  "settings.config.source.projectZodecode": "Configuration obsolète .zodecode",
  ...
  "session.cloud.import.placeholder": "ID de session, URL ou commande zode import",
  ...
  "deviceAuth.title": "Se connecter à Zode Code",
  ...
  "profile.action.login": "Se connecter avec Zode Code",
  ...
  "settings.aboutZodeCode.title": "À propos de Zode Code",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "Zode Code est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutZodeCode.status.connected": "Connecté",
  "settings.aboutZodeCode.status.connecting": "Connexion en cours...",
  "settings.aboutZodeCode.status.disconnected": "Déconnecté",
  "settings.aboutZodeCode.status.error": "Erreur",
  "settings.aboutZodeCode.cliServer": "Serveur CLI",
  "settings.aboutZodeCode.status.label": "Statut :",
  "settings.aboutZodeCode.port.label": "Port :",
  "settings.aboutZodeCode.versionInfo": "Informations de version",
  "settings.aboutZodeCode.version.label": "Version :",
  "settings.aboutZodeCode.extensionName": "Extension Zode Code",
  "settings.aboutZodeCode.community": "Communauté et support",
  "settings.aboutZodeCode.feedback.prefix":
    "Si vous avez des questions ou des commentaires, n'hésitez pas à ouvrir un ticket sur",
  "settings.aboutZodeCode.feedback.or": "ou",
  "settings.aboutZodeCode.support.prefix":
    "Pour les questions de facturation ou de compte, contactez le support client à",
  "settings.aboutZodeCode.resetSettings.title": "Réinitialiser les paramètres",
  "settings.aboutZodeCode.resetSettings.description":
  ...
  "settings.aboutZodeCode.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutZodeCode.settingsTransfer.title": "Transfert des paramètres",
  "settings.aboutZodeCode.settingsTransfer.description":
    "Exportez ou importez vos paramètres pour les transférer entre instances VS Code.",
  "settings.aboutZodeCode.exportSettings": "Exporter",
  "settings.aboutZodeCode.importSettings": "Importer",
  ...
  "settings.aboutZodeCode.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Zode valides.",
  "settings.aboutZodeCode.importSettings.tooLarge":
    "Le fichier est trop volumineux. Les fichiers de paramètres doivent faire moins de 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Ce fichier a été exporté depuis une version plus récente de Zode. Certains paramètres pourraient être ignorés.",
  "settings.aboutZodeCode.importSettings.success":
    "Paramètres importés. Vérifiez les modifications ci-dessus, puis cliquez sur Enregistrer.",

  "settings.aboutZodeCode.telemetry.title": "Télémétrie",
  "settings.aboutZodeCode.telemetry.description":
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Zode Code. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.speechToText.description":
    "Activez la saisie vocale dans les champs de prompt en utilisant votre compte Zode via Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Activez et connectez-vous au fournisseur Zode pour utiliser Speech to Text. Speech to Text n'est actuellement pris en charge qu'avec Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Modèle de transcription vocale",
  "settings.experimental.speechToTextModel.description":
    "Choisissez le modèle de transcription Zode Gateway pour la saisie vocale.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Zode Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Charge les instructions et les compétences de CLAUDE.md depuis votre répertoire de configuration Claude Code dans les sessions. Activez cette option si vous souhaitez que Zode utilise vos instructions et compétences Claude Code. Nécessite un redémarrage.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Aucun serveur MCP configuré. Ajoutez des serveurs MCP dans zode.jsonc ou demandez à l'agent de les ajouter.",
  ...
  "settings.display.fontSize.description":
    "Ajustez la taille de la police de la webview UI de Zode indépendamment de VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Zode Code, y compris les clés d'API des fournisseurs et le modèle par défaut.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un noyau petit et efficace partagé par tous les produits Zode. Une expérience familière quelle que soit votre façon de travailler.",
  ...
  "diffViewer.source.session.tooltip":
    "Fichiers modifiés par Zode pendant la session actuelle, basé sur des snapshots par tour. Réinitialisé lors du démarrage d'une nouvelle session.",
