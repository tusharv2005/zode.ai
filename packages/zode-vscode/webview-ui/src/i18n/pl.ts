export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Zode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Zode.",
  ...
  "speechToText.tooltip.start": "Rozpocznij wprowadzanie głosowe z Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Zaloguj się do Zode, aby korzystać z wprowadzania głosowego.",
  ...
  "dialog.server.description": "Przełącz serwer Zode, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Zode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Zode",
  ...
  "error.chain.mcpFailed":
    'Serwer MCP "{{name}}" nie powiódł się. Uwaga, Zode nie obsługuje jeszcze uwierzytelniania MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Zode",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Zode na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Zode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Zode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Zode.",
  ...
  "settings.providers.betaNotice":
    "Obecnie w interfejsie ustawień można skonfigurować tylko dostawcę Zode Gateway. Obsługa konfiguracji innych dostawców pojawi się wkrótce w fazie beta. W międzyczasie możesz konfigurować dostawców za pomocą CLI lub pliku konfiguracyjnego. Zależy nam na zachowaniu otwartości Zode, bez lock-inu.",
  ...
  "settings.config.title": "Otwórz plik konfiguracyjny Zode ({{scope}})",
  "settings.config.placeholder":
    "Pliki konfiguracyjne są scalane po kolei; pliki oznaczone jako wczytane mają obecnie wpływ na ustawienia.",
  "settings.config.noWorkspace": "Otwórz folder obszaru roboczego, aby edytować lokalny plik konfiguracyjny Zode.",
  "settings.config.openFailed": "Nie udało się otworzyć pliku konfiguracyjnego Zode ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Globalna konfiguracja XDG",
  "settings.config.source.homeZode": "Konfiguracja .zode (Home)",
  "settings.config.source.homeZodecode": "Konfiguracja .zodecode (Home)",
  "settings.config.source.homeOpencode": "Konfiguracja .opencode (Home)",
  "settings.config.source.envFile": "Plik środowiskowy ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Wbudowana konfiguracja środowiska",
  "settings.config.source.projectZode": "Konfiguracja .zode projektu",
  "settings.config.source.projectRoot": "Konfiguracja główna projektu",
  "settings.config.source.projectZodecode": "Przestarzała konfiguracja .zodecode",
  ...
  "session.cloud.import.placeholder": "ID sesji, URL lub polecenie zode import",
  ...
  "deviceAuth.title": "Zaloguj się do Zode Code",
  ...
  "profile.action.login": "Zaloguj się przez Zode Code",
  ...
  "settings.aboutZodeCode.title": "O Zode Code",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "Zode Code to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutZodeCode.status.connected": "Połączono",
  "settings.aboutZodeCode.status.connecting": "Łączenie...",
  "settings.aboutZodeCode.status.disconnected": "Rozłączono",
  "settings.aboutZodeCode.status.error": "Błąd",
  "settings.aboutZodeCode.cliServer": "Serwer CLI",
  "settings.aboutZodeCode.status.label": "Status:",
  "settings.aboutZodeCode.port.label": "Port:",
  "settings.aboutZodeCode.versionInfo": "Informacje o wersji",
  "settings.aboutZodeCode.version.label": "Wersja:",
  "settings.aboutZodeCode.extensionName": "Rozszerzenie Zode Code",
  "settings.aboutZodeCode.community": "Społeczność i wsparcie",
  "settings.aboutZodeCode.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutZodeCode.feedback.or": "lub",
  "settings.aboutZodeCode.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutZodeCode.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutZodeCode.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutZodeCode.exportSettings": "Eksportuj",
  "settings.aboutZodeCode.importSettings": "Importuj",
  "settings.aboutZodeCode.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Zode.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Ten plik został wyeksportowany z nowszej wersji Zode. Niektóre ustawienia mogą zostać zignorowane.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu Zode Code. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Włącz wprowadzanie głosowe w polach promptów przy użyciu konta Zode za pośrednictwem Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Włącz i zaloguj się do dostawcy Zode, aby korzystać ze Speech to Text. Speech to Text jest obecnie obsługiwane tylko z Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Model mowy na tekst",
  "settings.experimental.speechToTextModel.description":
    "Wybierz model transkrypcji Zode Gateway dla wprowadzania głosowego.",
  ...
  "settings.experimental.remote.description":
    "Włącz sterowanie Remote sesjami za pośrednictwem Zode Cloud. Wpłynie to również na CLI na tej maszynie.",
  ...
  "settings.indexing.zodeModel.title": "Preset modelu Zode",
  "settings.indexing.zodeModel.description": "Wybierz obsługiwany model osadzania hostowany przez Zode.",
  "settings.indexing.zodeSignIn.title": "Wymagane logowanie do Zode",
  "settings.indexing.zodeSignIn.description": "Zaloguj się do Zode, aby używać hostowanych osadzeń.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Wczytuje instrukcje CLAUDE.md oraz umiejętności z katalogu konfiguracyjnego Claude Code do sesji. Włącz tę opcję, jeśli chcesz, aby Zode korzystał z Twoich instrukcji i umiejętności Claude Code. Wymaga ponownego uruchomienia.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Brak skonfigurowanych serwerów MCP. Dodaj serwery MCP w zode.jsonc lub poproś agenta o ich dodanie.",
  ...
  "settings.display.fontSize.description": "Dostosuj rozmiar czcionki webview UI Zode niezależnie od VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji Zode Code, w tym klucze API dostawców i domyślny model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Jedno małe, wydajne jądro we wszystkich produktach Zode. Znajome doświadczenie niezależnie od sposobu pracy.",
  ...
  "diffViewer.source.session.tooltip":
    "Pliki zmienione przez Zode w trakcie bieżącej sesji, na podstawie snapshotów na turę. Resetowane przy rozpoczęciu nowej sesji.",
