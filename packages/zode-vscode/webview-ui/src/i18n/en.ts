export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Zode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Zode.",
  ...
  "speechToText.tooltip.start": "Start voice input with Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Sign in to Zode to use speech input.",
  ...
  "dialog.server.description": "Switch which Zode server this app connects to.",
  ...
  "toast.update.description": "A new version of Zode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Zode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Zode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Zode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for Zode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how Zode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Zode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Zode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Zode.",
  ...
  "settings.providers.betaNotice":
    "Currently only the Zode Gateway provider can be configured in the settings interface. Support for configuring other providers is coming soon during the beta period. In the interim you can configure providers using the CLI or config file. We're committed to keeping Zode open, no lock-in.",
  ...
  "settings.config.title": "Open {{scope}} Zode config file",
  "settings.config.placeholder": "Config files are merged in order; files marked loaded currently affect settings.",
  "settings.config.noWorkspace": "Open a workspace folder to edit the local Zode config file.",
  "settings.config.openFailed": "Failed to open {{scope}} Zode config file: {{message}}",
  "settings.config.source.xdg": "XDG global config",
  "settings.config.source.homeZode": "Home .zode config",
  "settings.config.source.homeZodecode": "Home .zodecode config",
  "settings.config.source.homeOpencode": "Home .opencode config",
  "settings.config.source.envFile": "ZODE_CONFIG environment file",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Inline environment config",
  "settings.config.source.projectZode": "Project .zode config",
  "settings.config.source.projectRoot": "Project root config",
  "settings.config.source.projectZodecode": "Legacy .zodecode config",
  ...
  "session.cloud.import.placeholder": "Session ID, URL, or zode import command",
  ...
  "deviceAuth.title": "Sign in to Zode Code",
  ...
  "profile.action.login": "Login with Zode Code",
  ...
  "settings.indexing.zodeModel.title": "Zode model preset",
  "settings.indexing.zodeModel.description": "Choose a supported Zode-hosted embedding model.",
  "settings.indexing.zodeSignIn.title": "Zode sign-in required",
  "settings.indexing.zodeSignIn.description": "Sign in to Zode to use hosted embeddings.",
  ...
  "settings.aboutZodeCode.title": "About Zode Code",
  ...
  "settings.aboutZodeCode.status.connected": "Connected",
  "settings.aboutZodeCode.status.connecting": "Connecting...",
  "settings.aboutZodeCode.status.disconnected": "Disconnected",
  ...
  "settings.aboutZodeCode.versionInfo": "Version Information",
  "settings.aboutZodeCode.version.label": "Version:",
  "settings.aboutZodeCode.extensionName": "Zode Code Extension",
  "settings.aboutZodeCode.community": "Community & Support",
  "settings.aboutZodeCode.feedback.prefix": "If you have any questions or feedback, feel free to open an issue on",
  "settings.aboutZodeCode.feedback.or": "or",
  "settings.aboutZodeCode.support.prefix": "For billing or account questions, contact Customer Support at",
  "settings.aboutZodeCode.resetSettings.title": "Reset Settings",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Reset All Settings",
  "settings.aboutZodeCode.settingsTransfer.title": "Settings Transfer",
  ...
  "settings.aboutZodeCode.exportSettings": "Export",
  "settings.aboutZodeCode.importSettings": "Import",
  "settings.aboutZodeCode.importSettings.invalidJson": "Invalid JSON file. Please select a valid settings file.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "File does not contain valid Zode settings.",
  "settings.aboutZodeCode.importSettings.tooLarge": "File is too large. Settings files must be under 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "This file was exported from a newer version of Zode. Some settings may be ignored.",
  "settings.aboutZodeCode.importSettings.success": "Settings imported. Review the changes above, then click Save.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Open Telemetry Settings",
  ...
  "settings.language.description":
    'Choose the language for the Zode Code UI. "Auto" uses your VS Code display language.',
  ...
  "settings.experimental.speechToText.description":
    "Enable voice input in prompt fields using your Zode account through Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Enable and sign in to the Zode provider to use Speech to Text. Speech to Text is currently only supported through Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Speech to Text Model",
  "settings.experimental.speechToTextModel.description": "Choose the Zode Gateway transcription model for voice input.",
  ...
  "settings.experimental.remote.description":
    "Enable remote control of sessions via Zode Cloud. This will also affect CLIs on this machine.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Load CLAUDE.md instructions and skills from your Claude Code configuration directory into sessions. Enable this if you want Zode to use your Claude Code instructions and skills. Requires restart.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No MCP servers configured. Add MCP servers in zode.jsonc, or ask the agent to add them for you.",
  ...
  "settings.display.fontSize.description": "Adjust the Zode webview UI font size independently from VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.description":
    "Migrate settings from a previous installation of Zode Code, including provider API keys and default model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "One small, efficient core across every Zode product. A familiar experience however you choose to work.",
  ...
  "diffViewer.source.session.tooltip":
    "Files changed by Zode during the current session, based on per-turn snapshots. Resets when you start a new session.",
