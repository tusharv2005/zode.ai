export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من Zode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Zode.",
  ...
  "speechToText.tooltip.start": "بدء الإدخال الصوتي باستخدام Zode Gateway",
  ...
  "speechToText.error.loginRequired": "قم بتسجيل الدخول إلى Zode لاستخدام الإدخال الصوتي.",
  ...
  "dialog.server.description": "تبديل خادم Zode الذي يتصل به هذا التطبيق.",
  ...
  "toast.update.description": "نسخة جديدة من Zode ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Zode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Zode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن Zode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Zode",
  "settings.general.row.appearance.title": "المظهر",
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Zode على جهازك",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Zode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Zode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Zode.",
  ...
  "settings.providers.betaNotice":
    "حالياً، يمكن إعداد مزود Zode Gateway فقط في واجهة الإعدادات. سيتوفر دعم إعداد المزودين الآخرين قريباً خلال الفترة التجريبية. في غضون ذلك، يمكنك إعداد المزودين باستخدام CLI أو ملف التكوين. نحن ملتزمون بإبقاء Zode مفتوحاً، دون تقييد.",
  ...
  "settings.config.title": "فتح ملف تكوين Zode {{scope}}",
  "settings.config.placeholder": "يتم دمج ملفات التكوين بالترتيب؛ الملفات المحددة كمحملة تؤثر حاليًا على الإعدادات.",
  "settings.config.noWorkspace": "افتح مجلد مساحة عمل لتحرير ملف تكوين Zode المحلي.",
  "settings.config.openFailed": "فشل فتح ملف تكوين Zode {{scope}}: {{message}}",
  "settings.config.source.xdg": "تكوين XDG العالمي",
  "settings.config.source.homeZode": "تكوين .zode في Home",
  "settings.config.source.homeZodecode": "تكوين .zodecode في Home",
  "settings.config.source.homeOpencode": "تكوين .opencode في Home",
  "settings.config.source.envFile": "ملف بيئة ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "تكوين البيئة المضمن",
  "settings.config.source.projectZode": "تكوين .zode للمشروع",
  "settings.config.source.projectRoot": "تكوين جذر المشروع",
  "settings.config.source.projectZodecode": "تكوين .zodecode القديم",
  ...
  "session.cloud.import.placeholder": "معرّف الجلسة أو الرابط أو أمر zode import",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى Zode Code",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام Zode Code",
  ...
  "settings.indexing.zodeModel.title": "إعداد مسبق لنموذج Zode",
  "settings.indexing.zodeModel.description": "اختر نموذج تضمين مدعومًا ومستضافًا بواسطة Zode.",
  "settings.indexing.zodeSignIn.title": "تسجيل الدخول إلى Zode مطلوب",
  "settings.indexing.zodeSignIn.description": "سجّل الدخول إلى Zode لاستخدام التضمينات المستضافة.",
  ...
  "settings.aboutZodeCode.title": "حول Zode Code",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "Zode Code هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutZodeCode.status.connected": "متصل",
  "settings.aboutZodeCode.status.connecting": "جارٍ الاتصال...",
  "settings.aboutZodeCode.status.disconnected": "غير متصل",
  "settings.aboutZodeCode.status.error": "خطأ",
  "settings.aboutZodeCode.cliServer": "خادم CLI",
  "settings.aboutZodeCode.status.label": "الحالة:",
  "settings.aboutZodeCode.port.label": "المنفذ:",
  "settings.aboutZodeCode.versionInfo": "معلومات الإصدار",
  "settings.aboutZodeCode.version.label": "الإصدار:",
  "settings.aboutZodeCode.extensionName": "إضافة Zode Code",
  "settings.aboutZodeCode.community": "المجتمع والدعم",
  "settings.aboutZodeCode.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutZodeCode.feedback.or": "أو",
  "settings.aboutZodeCode.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutZodeCode.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutZodeCode.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutZodeCode.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutZodeCode.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutZodeCode.exportSettings": "تصدير",
  "settings.aboutZodeCode.importSettings": "استيراد",
  "settings.aboutZodeCode.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Zode صالحة.",
  "settings.aboutZodeCode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Zode. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutZodeCode.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة Zode Code. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "تمكين الإدخال الصوتي في حقول المطالبة باستخدام حساب Zode الخاص بك من خلال Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "قم بتمكين وتسجيل الدخول إلى مزود Zode لاستخدام Speech to Text. ميزة Speech to Text مدعومة حاليًا فقط مع Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "نموذج تحويل الصوت إلى نص",
  "settings.experimental.speechToTextModel.description": "اختر نموذج نسخ Zode Gateway للإدخال الصوتي.",
  ...
  "settings.experimental.remote.description":
    "قم بتمكين التحكم Remote في الجلسات عبر Zode Cloud. سيؤثر هذا أيضًا على واجهات سطر الأوامر (CLIs) على هذا الجهاز.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "تحميل تعليمات ومهارات CLAUDE.md من مجلد إعدادات Claude Code إلى الجلسات. قم بتمكين هذا الخيار إذا كنت ترغب في أن يستخدم Zode مهارات وتعليمات Claude Code الخاصة بك. يتطلب إعادة التشغيل.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "لم يتم تهيئة خوادم MCP. أضف خوادم MCP في zode.jsonc، أو اطلب من الوكيل إضافتها لك.",
  ...
  "settings.display.fontSize.description": "اضبط حجم خط webview UI الخاص بـ Zode بشكل مستقل عن VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutZodeCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ Zode Code، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "نواة صغيرة وفعالة واحدة عبر كل منتجات Zode. تجربة مألوفة بغض النظر عن طريقة عملك.",
  ...
  "diffViewer.source.session.tooltip":
    "الملفات التي غيّرها Zode خلال الجلسة الحالية، بناءً على لقطات لكل دور. يُعاد ضبطها عند بدء جلسة جديدة.",
