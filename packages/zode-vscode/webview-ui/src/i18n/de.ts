...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Zode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Zode zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Zode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Zode zu nutzen.",
  ...
  "speechToText.tooltip.start": "Spracheingabe mit Zode Gateway starten",
  ...
  "speechToText.error.loginRequired": "Melden Sie sich bei Zode an, um die Spracheingabe zu verwenden.",
  ...
  "dialog.server.description": "Wechseln Sie den Zode-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Zode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Zode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Zode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Zode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Zode ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Zode auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Zode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Zode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Zode.",
  ...
  "settings.indexing.zodeModel.title": "Zode-Modellvoreinstellung",
  "settings.indexing.zodeModel.description": "Wählen Sie ein unterstütztes von Zode gehostetes Embedding-Modell.",
  "settings.indexing.zodeSignIn.title": "Zode-Anmeldung erforderlich",
  "settings.indexing.zodeSignIn.description": "Melden Sie sich bei Zode an, um gehostete Embeddings zu verwenden.",
  ...
  "settings.config.title": "{{scope}} Zode-Konfigurationsdatei öffnen",
  ...
  "settings.config.noWorkspace":
    "Öffnen Sie einen Arbeitsbereichsordner, um die lokale Zode-Konfigurationsdatei zu bearbeiten.",
  "settings.config.openFailed": "Fehler beim Öffnen der {{scope}} Zode-Konfigurationsdatei: {{message}}",
  ...
  "settings.config.source.envFile": "ZODE_CONFIG Umgebungsdatei",
  ...
  "settings.config.source.projectZodecode": "Veraltete .zodecode-Konfiguration",
  ...
  "session.cloud.import.placeholder": "Sitzungs-ID, URL oder zode import-Befehl",
  ...
  "deviceAuth.title": "Bei Zode Code anmelden",
  ...
  "profile.action.login": "Mit Zode Code anmelden",
  ...
  "settings.aboutZodeCode.title": "Über Zode Code",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "Zode Code ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutZodeCode.status.connected": "Verbunden",
  "settings.aboutZodeCode.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutZodeCode.status.disconnected": "Getrennt",
  "settings.aboutZodeCode.status.error": "Fehler",
  ...
  "settings.aboutZodeCode.versionInfo": "Versionsinformationen",
  "settings.aboutZodeCode.version.label": "Version:",
  "settings.aboutZodeCode.extensionName": "Zode Code Erweiterung",
  "settings.aboutZodeCode.community": "Community & Support",
  "settings.aboutZodeCode.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutZodeCode.feedback.or": "oder",
  "settings.aboutZodeCode.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutZodeCode.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutZodeCode.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutZodeCode.exportSettings": "Exportieren",
  "settings.aboutZodeCode.importSettings": "Importieren",
  ...
  "settings.aboutZodeCode.importSettings.invalidConfig": "Die Datei enthält keine gültigen Zode-Einstellungen.",
  ...
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Diese Datei wurde mit einer neueren Version von Zode exportiert. Einige Einstellungen werden möglicherweise ignoriert.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die Zode Code Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.experimental.speechToText.description":
    "Aktivieren Sie die Spracheingabe in Prompt-Feldern mit Ihrem Zode-Konto über Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Aktivieren Sie den Zode-Anbieter und melden Sie sich an, um Speech to Text zu verwenden. Speech to Text wird derzeit nur mit Zode Gateway unterstützt.",
  "settings.experimental.speechToTextModel.title": "Sprache-zu-Text-Modell",
  "settings.experimental.speechToTextModel.description":
    "Wählen Sie das Zode Gateway-Transkriptionsmodell für die Spracheingabe.",
  ...
  "settings.experimental.remote.description":
    "Aktivieren Sie die Remote-Steuerung von Sitzungen über Zode Cloud. Dies betrifft auch CLIs auf diesem Computer.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Lädt CLAUDE.md-Anweisungen und Skills aus Ihrem Claude Code-Konfigurationsverzeichnis in Sitzungen. Aktivieren Sie dies, wenn Zode Ihre Claude Code-Anweisungen und Skills verwenden soll. Neustart erforderlich.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Keine MCP-Server konfiguriert. Fügen Sie MCP-Server in zode.jsonc hinzu oder bitten Sie den Agenten, sie hinzuzufügen.",
  ...
  "settings.display.fontSize.description": "Passen Sie die Schriftgröße der Zode webview UI unabhängig von VS Code an.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Legacy-Migration",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von Zode Code, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Ein kleiner, effizienter Kern über alle Zode-Produkte hinweg. Ein vertrautes Erlebnis, egal wie Sie arbeiten.",
  ...
  "diffViewer.source.session.tooltip":
    "Von Zode während der aktuellen Sitzung geänderte Dateien, basierend auf Snapshots pro Runde. Wird beim Start einer neuen Sitzung zurückgesetzt.",
