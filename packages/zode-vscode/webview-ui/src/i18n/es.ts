export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Zode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Zode.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz con Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Inicia sesión en Zode para usar la entrada de voz.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Zode se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Zode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Zode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Zode no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Zode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Zode",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Zode en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Zode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Zode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Zode.",
  ...
  "settings.indexing.zodeModel.title": "Preajuste de modelo de Zode",
  "settings.indexing.zodeModel.description": "Elige un modelo de embeddings alojado por Zode compatible.",
  "settings.indexing.zodeSignIn.title": "Se requiere iniciar sesión en Zode",
  "settings.indexing.zodeSignIn.description": "Inicia sesión en Zode para usar embeddings alojados.",
  ...
  "settings.providers.betaNotice":
    "Actualmente, solo el proveedor Zode Gateway se puede configurar en la interfaz de ajustes. El soporte para configurar otros proveedores llegará pronto durante el período beta. Mientras tanto, puedes configurar proveedores usando la CLI o el archivo de configuración. Estamos comprometidos a mantener Zode abierto, sin ataduras.",
  ...
  "settings.config.title": "Abrir archivo de configuración Zode {{scope}}",
  ...
  "settings.config.noWorkspace":
    "Abre una carpeta de espacio de trabajo para editar el archivo de configuración Zode local.",
  "settings.config.openFailed": "Error al abrir el archivo de configuración Zode {{scope}}: {{message}}",
  "settings.config.source.xdg": "Configuración global XDG",
  "settings.config.source.homeZode": "Configuración .zode de Home",
  "settings.config.source.homeZodecode": "Configuración .zodecode de Home",
  "settings.config.source.homeOpencode": "Configuración .opencode de Home",
  "settings.config.source.envFile": "Archivo de entorno ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Configuración de entorno en línea",
  "settings.config.source.projectZode": "Configuración .zode del proyecto",
  "settings.config.source.projectRoot": "Configuración raíz del proyecto",
  "settings.config.source.projectZodecode": "Configuración heredada .zodecode",
  ...
  "session.cloud.import.placeholder": "ID de sesión, URL o comando zode import",
  ...
  "deviceAuth.title": "Iniciar sesión en Zode Code",
  ...
  "profile.action.login": "Iniciar sesión con Zode Code",
  ...
  "settings.aboutZodeCode.title": "Acerca de Zode Code",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "Zode Code es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutZodeCode.status.connected": "Conectado",
  "settings.aboutZodeCode.status.connecting": "Conectando...",
  "settings.aboutZodeCode.status.disconnected": "Desconectado",
  "settings.aboutZodeCode.status.error": "Error",
  "settings.aboutZodeCode.cliServer": "Servidor CLI",
  "settings.aboutZodeCode.status.label": "Estado:",
  "settings.aboutZodeCode.port.label": "Puerto:",
  "settings.aboutZodeCode.versionInfo": "Información de versión",
  "settings.aboutZodeCode.version.label": "Versión:",
  "settings.aboutZodeCode.extensionName": "Extensión Zode Code",
  "settings.aboutZodeCode.community": "Comunidad y soporte",
  "settings.aboutZodeCode.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutZodeCode.feedback.or": "o",
  "settings.aboutZodeCode.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutZodeCode.resetSettings.title": "Restablecer configuración",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutZodeCode.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutZodeCode.exportSettings": "Exportar",
  "settings.aboutZodeCode.importSettings": "Importar",
  "settings.aboutZodeCode.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Zode.",
  ...
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Este archivo fue exportado desde una versión más reciente de Zode. Algunos ajustes podrían ignorarse.",
  ...
  "settings.aboutZodeCode.telemetry.title": "Telemetría",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de Zode Code. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Habilita la entrada de voz en los campos de prompt usando tu cuenta de Zode a través de Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Habilita e inicia sesión en el proveedor Zode para usar Speech to Text. Actualmente, Speech to Text solo es compatible con Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Modelo de voz a texto",
  "settings.experimental.speechToTextModel.description":
    "Elige el modelo de transcripción de Zode Gateway para la entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite el control Remote de las sesiones a través de Zode Cloud. Esto también afectará a las CLI de este equipo.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carga las instrucciones y habilidades de CLAUDE.md desde tu directorio de configuración de Claude Code en las sesiones. Activa esta opción si quieres que Zode utilice tus instrucciones y habilidades de Claude Code. Requiere reiniciar.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "No hay servidores MCP configurados. Añada servidores MCP en zode.jsonc o pida al agente que los añada.",
  ...
  "settings.display.fontSize.description":
    "Ajusta el tamaño de fuente de la webview UI de Zode de forma independiente a VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migración heredada",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de Zode Code, incluyendo las claves API de proveedores y el modelo predeterminado.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Un núcleo pequeño y eficiente en todos los productos Zode. Una experiencia familiar sin importar cómo elijas trabajar.",
  ...
  "diffViewer.source.session.tooltip":
    "Archivos modificados por Zode durante la sesión actual, basado en snapshots por turno. Se reinicia al empezar una nueva sesión.",
