export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Zode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Zode.",
  ...
  "speechToText.tooltip.start": "Iniciar entrada de voz com o Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Faça login no Zode para usar a entrada de voz.",
  ...
  "dialog.server.description": "Trocar para qual servidor Zode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Zode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Zode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Zode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Zode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Zode aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Zode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Zode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Zode.",
  ...
  "settings.providers.betaNotice":
    "Atualmente, apenas o provedor Zode Gateway pode ser configurado na interface de configurações. O suporte para a configuração de outros provedores estará disponível em breve durante o período beta. Enquanto isso, você pode configurar provedores usando a CLI ou o arquivo de configuração. Estamos comprometidos em manter o Zode aberto, sem lock-in.",
  ...
  "settings.config.title": "Abrir arquivo de configuração {{scope}} do Zode",
  ...
  "settings.config.noWorkspace":
    "Abra uma pasta de espaço de trabalho para editar o arquivo de configuração local do Zode.",
  "settings.config.openFailed": "Falha ao abrir o arquivo de configuração {{scope}} do Zode: {{message}}",
  "settings.config.source.xdg": "Configuração global do XDG",
  "settings.config.source.homeZode": "Configuração .zode da Home",
  "settings.config.source.homeZodecode": "Configuração .zodecode da Home",
  "settings.config.source.homeOpencode": "Configuração .opencode da Home",
  "settings.config.source.envFile": "Arquivo de ambiente ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Configuração de ambiente embutida",
  "settings.config.source.projectZode": "Configuração .zode do projeto",
  "settings.config.source.projectRoot": "Configuração raiz do projeto",
  "settings.config.source.projectZodecode": "Configuração .zodecode legada",
  ...
  "session.cloud.import.placeholder": "ID da sessão, URL ou comando zode import",
  ...
  "deviceAuth.title": "Entrar no Zode Code",
  ...
  "profile.action.login": "Entrar com Zode Code",
  ...
  "settings.indexing.zodeModel.title": "Predefinição de modelo do Zode",
  "settings.indexing.zodeModel.description": "Escolha um modelo de embedding hospedado pelo Zode compatível.",
  "settings.indexing.zodeSignIn.title": "Login no Zode necessário",
  "settings.indexing.zodeSignIn.description": "Entre no Zode para usar embeddings hospedados.",
  ...
  "settings.aboutZodeCode.title": "Sobre o Zode Code",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "Zode Code é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutZodeCode.status.error": "Erro",
  ...
  "settings.aboutZodeCode.versionInfo": "Informações da Versão",
  "settings.aboutZodeCode.version.label": "Versão:",
  "settings.aboutZodeCode.extensionName": "Extensão Zode Code",
  "settings.aboutZodeCode.community": "Comunidade e Suporte",
  "settings.aboutZodeCode.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutZodeCode.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutZodeCode.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutZodeCode.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Zode.",
  ...
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Este arquivo foi exportado de uma versão mais recente do Zode. Algumas configurações podem ser ignoradas.",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do Zode Code. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.experimental.speechToText.description":
    "Ative a entrada de voz nos campos de prompt usando sua conta do Zode por meio do Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Ative e faça login no provedor Zode para usar o Speech to Text. Atualmente, o Speech to Text é compatível apenas com o Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Modelo de fala para texto",
  "settings.experimental.speechToTextModel.description":
    "Escolha o modelo de transcrição do Zode Gateway para entrada de voz.",
  ...
  "settings.experimental.remote.description":
    "Habilite o controle Remote de sessões via Zode Cloud. Isso também afetará as CLIs nesta máquina.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Carrega as instruções e skills do CLAUDE.md a partir do seu diretório de configuração do Claude Code para as sessões. Ative esta opção se deseja que o Zode utilize suas instruções e skills do Claude Code. Requer reinicialização.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Nenhum servidor MCP configurado. Adicione servidores MCP em zode.jsonc ou peça ao agente para adicioná-los.",
  ...
  "settings.display.fontSize.description":
    "Ajuste o tamanho da fonte da webview UI do Zode independentemente do VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Migração Legada",
  "settings.aboutZodeCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do Zode Code, incluindo chaves de API de provedor e modelo padrão.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Um núcleo pequeno e eficiente em todos os produtos Zode. Uma experiência familiar independentemente de como você escolha trabalhar.",
  ...
  "diffViewer.source.session.tooltip":
    "Arquivos modificados pelo Zode durante a sessão atual, com base em snapshots por turno. Reinicia ao começar uma nova sessão.",
