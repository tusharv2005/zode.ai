export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від Zode",
  ...
  "provider.connect.apiKey.description":
    "Введіть свій API-ключ {{provider}}, щоб підключити акаунт {{provider}} і використовувати моделі {{provider}} в Zode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " щоб отримати код авторизації для підключення акаунта та використання моделей {{provider}} у Zode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " та введіть код нижче, щоб підключити акаунт і використовувати моделі {{provider}} у Zode.",
  ...
  "speechToText.tooltip.start": "Почати голосове введення з Zode Gateway",
  ...
  "speechToText.error.loginRequired": "Увійдіть до Zode, щоб використовувати голосове введення.",
  ...
  "dialog.server.description": "Змінити, до якого сервера Zode підключається цей додаток.",
  ...
  "toast.update.description": "Нова версія Zode ({{version}}) готова до встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді Zode",
  ...
  "error.chain.mcpFailed": 'MCP-сервер "{{name}}" зазнав помилки. Примітка: Zode поки не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "Zode включає безкоштовні моделі, тому ви можете почати відразу.",
  ...
  "settings.general.row.language.description": "Змінити мову відображення Zode",
  "settings.general.row.appearance.title": "Вигляд",
  "settings.general.row.appearance.description": "Налаштувати вигляд Zode на вашому пристрої",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштувати тему Zode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти оновлення при запуску Zode",
  ...
  "settings.updates.toast.latest.description": "У вас встановлена остання версія Zode.",
  ...
  "settings.providers.betaNotice":
    "Наразі в інтерфейсі налаштувань можна налаштувати лише провайдера Zode Gateway. Підтримка інших провайдерів з'явиться в бета-версії найближчим часом. Тим часом ви можете налаштовувати провайдерів через CLI або файл конфігурації. Zode залишається відкритим — без прив'язки.",
  ...
  "settings.config.title": "Відкрити файл конфігурації Zode ({{scope}})",
  "settings.config.placeholder":
    "Файли конфігурації об'єднуються по порядку; файли, позначені як завантажені, наразі впливають на налаштування.",
  "settings.config.noWorkspace": "Відкрийте папку робочої області, щоб відредагувати локальний файл конфігурації Zode.",
  "settings.config.openFailed": "Не вдалося відкрити файл конфігурації Zode ({{scope}}): {{message}}",
  "settings.config.source.xdg": "Глобальна конфігурація XDG",
  "settings.config.source.homeZode": "Конфігурація .zode (Home)",
  "settings.config.source.homeZodecode": "Конфігурація .zodecode (Home)",
  "settings.config.source.homeOpencode": "Конфігурація .opencode (Home)",
  "settings.config.source.envFile": "Файл середовища ZODE_CONFIG",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Вбудована конфігурація середовища",
  "settings.config.source.projectZode": "Конфігурація .zode проєкту",
  "settings.config.source.projectRoot": "Коренева конфігурація проєкту",
  "settings.config.source.projectZodecode": "Застаріла конфігурація .zodecode",
  ...
  "session.cloud.import.placeholder": "Ідентифікатор сесії, URL або команда zode import",
  ...
  "deviceAuth.title": "Увійти до Zode Code",
  ...
  "profile.action.login": "Увійти через Zode Code",
  ...
  "settings.aboutZodeCode.title": "Про Zode Code",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "Zode Code — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutZodeCode.status.connected": "Підключено",
  "settings.aboutZodeCode.status.connecting": "Підключення...",
  "settings.aboutZodeCode.status.disconnected": "Відключено",
  "settings.aboutZodeCode.status.error": "Помилка",
  ...
  "settings.aboutZodeCode.versionInfo": "Інформація про версію",
  "settings.aboutZodeCode.version.label": "Версія:",
  "settings.aboutZodeCode.extensionName": "Розширення Zode Code",
  "settings.aboutZodeCode.community": "Спільнота і підтримка",
  "settings.aboutZodeCode.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutZodeCode.feedback.or": "або",
  "settings.aboutZodeCode.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutZodeCode.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutZodeCode.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutZodeCode.exportSettings": "Експортувати",
  "settings.aboutZodeCode.importSettings": "Імпортувати",
  "settings.aboutZodeCode.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Zode.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Цей файл було експортовано з новішої версії Zode. Деякі налаштування можуть бути проігноровані.",
  "settings.aboutZodeCode.importSettings.success":
    "Налаштування імпортовано. Перегляньте зміни вище, потім натисніть Зберегти.",

  "settings.aboutZodeCode.telemetry.title": "Телеметрія",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу Zode Code.',
  ...
  "settings.experimental.speechToText.description":
    "Увімкніть голосове введення в полях запитів, використовуючи ваш обліковий запис Zode через Zode Gateway.",
  "settings.experimental.speechToText.disabledDescription":
    "Увімкніть провайдер Zode та виконайте вхід, щоб використовувати Speech to Text. Наразі Speech to Text підтримується лише з Zode Gateway.",
  "settings.experimental.speechToTextModel.title": "Модель мовлення в текст",
  "settings.experimental.speechToTextModel.description":
    "Виберіть модель транскрипції Zode Gateway для голосового введення.",
  ...
  "settings.experimental.remote.description":
    "Увімкніть керування Remote сеансами через Zode Cloud. Це також вплине на CLI на цьому комп'ютері.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Завантажувати інструкції та навички CLAUDE.md з вашого каталогу конфігурації Claude Code у сесії. Увімкніть це, якщо ви хочете, щоб Zode використовував ваші інструкції та навички Claude Code. Потребує перезапуску.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "MCP-серверів не налаштовано. Додайте MCP-сервери до zode.jsonc або попросіть агента додати їх.",
  ...
  "settings.display.fontSize.description": "Налаштуйте розмір шрифту webview UI для Zode незалежно від VS Code.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutZodeCode.legacyMigration.description":
    "Перенести налаштування з попередньої версії Zode Code, включаючи API-ключі провайдерів та стандартну модель.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в Zode Code",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Малий та ефективний ядерний модуль у кожному продукті Zode. Знайомий досвід незалежно від того, як ви вважаєте за краще працювати.",
  ...
  "settings.indexing.zodeModel.title": "Пресет моделі Zode",
  "settings.indexing.zodeModel.description": "Виберіть підтримувану модель Zode-hosted embeddings.",
  "settings.indexing.zodeSignIn.title": "Потрібен вхід у Zode",
  "settings.indexing.zodeSignIn.description": "Увійдіть у Zode, щоб використовувати hosted embeddings.",
  ...
  "diffViewer.source.session.tooltip":
    "Файли, змінені Zode під час поточної сесії, на основі знімків по ходу. Скидається при старті нової сесії.",
