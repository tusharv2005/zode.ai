export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Zode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Zode'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix": "Hesabınızı bağlamak ve Zode'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Zode'da {{provider}} modellerini kullanın.",
  ...
  "speechToText.tooltip.start": "Zode Gateway ile sesli girişi başlatın",
  ...
  "speechToText.error.loginRequired": "Sesli girişi kullanmak için Zode'ya giriş yapın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Zode sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Zode'nun yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Zode ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Zode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Zode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Zode Masaüstü",
  ...
  "settings.general.row.language.description": "Zode'nun görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Zode'nun cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Zode'nun temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Zode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Zode'nun en son sürümünü kullanıyorsunuz.",
  ...
  "settings.providers.betaNotice":
    "Şu anda yalnızca Zode Gateway sağlayıcısı ayarlar arayüzünde yapılandırılabilir. Diğer sağlayıcılar için destek beta döneminde yakında gelecek. Bu arada CLI veya yapılandırma dosyası ile sağlayıcıları yapılandırabilirsiniz. Zode'yu açık tutmaya kararlıyız, kilitlenme yok.",
  ...
  "settings.config.title": "{{scope}} Zode yapılandırma dosyasını aç",
  "settings.config.placeholder":
    "Yapılandırma dosyaları sırayla birleştirilir; yüklendi olarak işaretlenen dosyalar şu anda ayarları etkiler.",
  "settings.config.noWorkspace": "Yerel Zode yapılandırma dosyasını düzenlemek için bir çalışma alanı klasörü açın.",
  "settings.config.openFailed": "{{scope}} Zode yapılandırma dosyası açılamadı: {{message}}",
  "settings.config.source.xdg": "XDG küresel yapılandırma",
  "settings.config.source.homeZode": "Home .zode yapılandırması",
  "settings.config.source.homeZodecode": "Home .zodecode yapılandırması",
  "settings.config.source.homeOpencode": "Home .opencode yapılandırması",
  "settings.config.source.envFile": "ZODE_CONFIG ortam dosyası",
  "settings.config.source.envDir": "ZODE_CONFIG_DIR",
  "settings.config.source.envContent": "Satır içi ortam yapılandırması",
  "settings.config.source.projectZode": "Proje .zode yapılandırması",
  "settings.config.source.projectRoot": "Proje kök yapılandırması",
  "settings.config.source.projectZodecode": "Eski .zodecode yapılandırması",
  ...
  "session.cloud.import.placeholder": "Oturum kimliği, URL veya zode import komutu",
  ...
  "deviceAuth.title": "Zode Code'a giriş yap",
  ...
  "profile.action.login": "Zode Code ile giriş yap",
  ...
  "settings.aboutZodeCode.title": "Zode Code Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "Zode Code bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutZodeCode.status.connected": "Bağlı",
  "settings.aboutZodeCode.status.connecting": "Bağlanıyor...",
  "settings.aboutZodeCode.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutZodeCode.status.error": "Hata",
  "settings.aboutZodeCode.cliServer": "CLI Sunucusu",
  "settings.aboutZodeCode.status.label": "Durum:",
  "settings.aboutZodeCode.port.label": "Port:",
  "settings.aboutZodeCode.versionInfo": "Sürüm Bilgisi",
  "settings.aboutZodeCode.version.label": "Sürüm:",
  "settings.aboutZodeCode.extensionName": "Zode Code Uzantısı",
  "settings.aboutZodeCode.community": "Topluluk ve Destek",
  "settings.aboutZodeCode.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutZodeCode.feedback.or": "veya",
  "settings.aboutZodeCode.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutZodeCode.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutZodeCode.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutZodeCode.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutZodeCode.exportSettings": "Dışa Aktar",
  "settings.aboutZodeCode.importSettings": "İçe Aktar",
  "settings.aboutZodeCode.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutZodeCode.importSettings.invalidConfig": "Dosya geçerli Zode ayarları içermiyor.",
  "settings.aboutZodeCode.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  "settings.aboutZodeCode.importSettings.newerVersion":
    "Bu dosya Zode'nun daha yeni bir sürümünden dışa aktarılmış. Bazı ayarlar göz ardı edilebilir.",
  ...
  "settings.aboutZodeCode.telemetry.title": "Telemetri",
  ...
  "settings.aboutZodeCode.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. Zode Code arayüzü için dil seçin.',
  ...
  "settings.experimental.speechToText.description":
    "Zode Gateway üzerinden Zode hesabınızı kullanarak komut alanlarında sesli girişi etkinleştirin.",
  "settings.experimental.speechToText.disabledDescription":
    "Speech to Text kullanmak için Zode sağlayıcısını etkinleştirin ve giriş yapın. Speech to Text şu anda yalnızca Zode Gateway ile desteklenmektedir.",
  "settings.experimental.speechToTextModel.title": "Sesten metne modeli",
  "settings.experimental.speechToTextModel.description": "Sesli giriş için Zode Gateway transkripsiyon modelini seçin.",
  ...
  "settings.experimental.remote.description":
    "Zode Cloud üzerinden oturumların Remote kontrolünü etkinleştirin. Bu, bu makinedeki CLI'leri de etkileyecektir.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code yapılandırma dizininizdeki CLAUDE.md talimatlarını ve becerilerini oturumlara yükleyin. Zode'nun Claude Code talimatlarınızı ve becerilerinizi kullanmasını istiyorsanız bunu etkinleştirin. Yeniden başlatma gerektirir.",
  ...
  "settings.agentBehaviour.mcpEmpty":
    "Yapılandırılmış MCP sunucusu yok. zode.jsonc dosyasına MCP sunucuları ekleyin veya ajanın eklemesini isteyin.",
  ...
  "settings.display.fontSize.description": "Zode webview UI yazı tipi boyutunu VS Code'dan bağımsız olarak ayarlayın.",
  ...
  "settings.aboutZodeCode.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutZodeCode.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere Zode Code'un önceki yüklemesinden ayarları taşıyın.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Zode Code'daki Yenilikler",
  ...
  "migration.whatsNew.features.foundation.detail":
    "Her Zode ürününde küçük ve verimli bir çekirdek. Nasıl çalışmayı tercih ederseniz edin, tanıdık bir deneyim.",
  ...
  "settings.indexing.zodeModel.title": "Zode model önayarı",
  "settings.indexing.zodeModel.description": "Desteklenen bir Zode-hosted embeddings modeli seçin.",
  "settings.indexing.zodeSignIn.title": "Zode oturumu açmak gerekiyor",
  "settings.indexing.zodeSignIn.description": "Hosted embeddings kullanmak için Zode'da oturum açın.",
  ...
  "diffViewer.source.session.tooltip":
    "Geçerli oturum sırasında Zode tarafından değiştirilen dosyalar, tur başı anlık görüntülere dayanır. Yeni bir oturum başlatıldığında sıfırlanır.",
