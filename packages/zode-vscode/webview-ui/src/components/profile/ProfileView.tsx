...
const ProfileView: Component<ProfileViewProps> = (props) => {
  ...
  const handleDashboard = () => {
    vscode.postMessage({ type: "openExternal", url: "https://app.__PRESERVE_ZODE_AI__/profile" })
  }
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%" }}>
      ...
      >
        <h2 style={{ "font-size": "var(--zode-font-size-16)", "font-weight": "600", margin: 0 }}>
                ...
                {(balance) => (
                  ...
                  >
                    <div>
                      ...
                      <p
                        style={{
                          "font-size": "var(--zode-font-size-18)",
                          "font-weight": "600",
                          color: "var(--vscode-foreground)",
                          margin: 0,
                        }}
