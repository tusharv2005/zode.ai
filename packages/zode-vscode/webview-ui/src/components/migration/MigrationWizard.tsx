...
// ---------------------------------------------------------------------------
// ZodeLogo — replicates the pattern from MessageList.tsx
// ---------------------------------------------------------------------------
...
const ZodeLogo = (): JSX.Element => {
  ...
  const icon = isLight ? "zode-light.svg" : "zode-dark.svg"
  return (
    <div class="migration-wizard__logo">
      <img src={`${iconsBaseUri}/${icon}`} alt="Zode Code" />
    </div>
  )
}
      ...
      <div class="migration-wizard__container">
        ...
        <div class={screen() === "whats-new" ? "migration-wizard__screen--active" : "migration-wizard__screen--hidden"}>
          ...
          <div class="migration-wizard__blog-link">
            <a href="https://blog.__PRESERVE_ZODE_AI__/p/new-zode-for-vs-code-is-live">
              {language.t("migration.whatsNew.blogLink")} <span>&rarr;</span>
            </a>
            <a href="https://__PRESERVE_ZODE_AI__/docs/code-with-ai/platforms/vscode/whats-new">
