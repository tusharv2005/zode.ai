...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@zodecode/sdk/v2/client"
    ...
    return (
      ...
      >
              ...
              <Match when={prompt.type === "select"}>
                <div style={{ display: "flex", "flex-direction": "column", gap: "4px" }}>
                  ...
                  <Show when={state.field === prompt.key && state.error}>
                    <span style={{ "font-size": "var(--zode-font-size-12)", color: "var(--vscode-errorForeground)" }}>
                      {state.error}
                    </span>
                  </Show>
                </div>
        ...
        <Show when={state.error && !state.field}>
          <div style={{ color: "var(--vscode-errorForeground)", "font-size": "var(--zode-font-size-13)" }}>
            {state.error}
          </div>
        </Show>
        <div class="dialog-confirm-actions provider-connect-actions">
          <div class="provider-connect-byok">
            ...
            >
              {language.t("provider.connect.zodeGateway.byok.link")}
            </a>
            {language.t("provider.connect.zodeGateway.byok.suffix")}
          </div>
