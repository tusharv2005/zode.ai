...
import { Tabs } from "@zodecode/zode-ui/tabs"
...
import AboutZodeCodeTab from "./AboutZodeCodeTab"
...
const Settings: Component<SettingsProps> = (props) => {
  ...
  const open = (scope: "local" | "global") => {
    ...
    vscode.postMessage({
      ...
      labels: {
        ...
        sourceHomeZode: language.t("settings.config.source.homeZode"),
        sourceHomeZodecode: language.t("settings.config.source.homeZodecode"),
        ...
        sourceProjectZode: language.t("settings.config.source.projectZode"),
        sourceProjectRoot: language.t("settings.config.source.projectRoot"),
        sourceProjectZodecode: language.t("settings.config.source.projectZodecode"),
  ...
  return (
    <div style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0 }}>
      ...
      >
        <h2 style={{ "font-size": "var(--zode-font-size-16)", "font-weight": "600", margin: 0, flex: 1 }}>
      ...
      >
        <Tabs.List>
          ...
          <Tabs.Trigger value="aboutZodeCode">
            <Icon name="help" />
            <span class="label">{language.t("settings.aboutZodeCode.title")}</span>
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutZodeCode">
          <h3>{language.t("settings.aboutZodeCode.title")}</h3>
          <AboutZodeCodeTab
