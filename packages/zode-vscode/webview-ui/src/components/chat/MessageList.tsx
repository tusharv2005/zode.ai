...
import { ZodeNotifications } from "./ZodeNotifications"
        ...
        <div ref={autoScroll.contentRef} class={isEmpty() ? "message-list-content-empty" : "message-list-content"}>
          ...
          <Show when={isEmpty() && props.readonly}>
            <div class="message-list-empty">
              <p class="zode-about-text">{language.t("session.messages.initializing")}</p>
            </div>
          </Show>
          <Show when={isEmpty() && !props.readonly}>
            <div class="message-list-empty">
              <ZodeLogo />
              <p class="zode-about-text">{language.t("session.messages.welcome")}</p>
