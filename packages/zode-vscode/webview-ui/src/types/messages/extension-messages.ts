...
import type { BrowserSettings, Config, FeatureFlags, IndexingStatus, ZodeEmbeddingModelCatalog } from "./config"
import type { ZodecodeNotification, ProfileData } from "./profile"
import type {
...
export interface ZodeEmbeddingModelsLoadedMessage {
  type: "zodeEmbeddingModelsLoaded"
  catalog: ZodeEmbeddingModelCatalog
}
...
export type ExtensionMessage =
  ...
  | ZodeEmbeddingModelsLoadedMessage
