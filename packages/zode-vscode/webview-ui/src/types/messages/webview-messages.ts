...
export interface OpenConfigFileRequest {
  ...
  labels: {
    ...
    openFailed: string
    sourceXdg: string
    sourceHomeZode: string
    sourceHomeZodecode: string
    sourceHomeOpencode: string
    sourceEnvFile: string
    sourceEnvDir: string
    sourceEnvContent: string
    sourceProjectZode: string
    sourceProjectRoot: string
    sourceProjectZodecode: string
...
export interface RequestZodeEmbeddingModelsMessage {
  type: "requestZodeEmbeddingModels"
}
...
export interface UpdateConfigMessage {
  type: "updateConfig"
  /** Global config patch written to ~/.config/zode/zode.json. */
  config: Partial<Config>
  /** Project config patch written to the workspace's .zode/zode.json or existing project config. */
...
export type WebviewMessage =
  ...
  | RequestZodeEmbeddingModelsMessage
  | UpdateConfigMessage
