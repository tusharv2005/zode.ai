...
import type { AssistantMessage, ToolPart } from "@zodecode/sdk/v2"
...
const shellPart: ToolPart = {
  ...
  state: {
    ...
    input: {
      ...
      command: `grep -n "migration\\|openMigration" packages/zode-vscode/webview-ui/src/types/messages.ts`,
    },
