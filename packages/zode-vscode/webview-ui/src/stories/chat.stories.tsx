  ...
  [toolAssistantID]: [
    {
      ...
      state: {
        ...
        output: "/Users/marius/Documents/git/zodecode/.zode/worktrees/zest-kettledrum",
        title: "pwd",
        metadata: {},
...
// ---------------------------------------------------------------------------
// Welcome screen with AccountSwitcher + ZodeNotifications
// ---------------------------------------------------------------------------
...
const mockServer = {
  ...
  profileData: () => ({
    profile: {
      email: "dev@zode.dev",
      name: "Dev User",
      organizations: [{ id: "org-1", name: "Zode Org", role: "member" }],
    },
    balance: { balance: 5.0 },
    currentOrgId: "org-1",
  }),
