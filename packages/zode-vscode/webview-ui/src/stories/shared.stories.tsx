  ...
  render: () => (
    <StoryProviders>
      <div style={{ display: "flex", "align-items": "center", gap: "8px" }}>
        <ModelSelectorBase
          value={{ providerID: "zode", modelID: "zode-auto/frontier" }}
          onSelect={() => {}}
...
const ACCESSIBLE_MODELS: EnrichedModel[] = [
  { id: "alpha", name: "Alpha", providerID: "zode", providerName: "Zode" },
  { id: "bravo", name: "Bravo", providerID: "zode", providerName: "Zode" },
  { id: "charlie", name: "Charlie", providerID: "zode", providerName: "Zode" },
]

const AccessibleModelSelector = () => {
  const [value, setValue] = createSignal<ModelSelection | null>({ providerID: "zode", modelID: "alpha" })
...
export const ModelSelectorSelectedFavorite: Story = {
  ...
  render: () => {
    const session = {
      ...mockSessionValue(),
      favoriteModels: () => [{ providerID: "zode", modelID: "alpha" }],
    }
