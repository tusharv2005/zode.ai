...
import type { ZodecodeNotification, ExtensionMessage } from "../types/messages"

interface NotificationsContextValue {
  notifications: Accessor<ZodecodeNotification[]>
  filteredNotifications: Accessor<ZodecodeNotification[]>
