...
import { DialogProvider, useDialog } from "@zodecode/zode-ui/context/dialog"
import { Dialog } from "@zodecode/zode-ui/dialog"
import { DropdownMenu } from "@zodecode/zode-ui/dropdown-menu"
import { ContextMenu } from "@zodecode/zode-ui/context-menu"
...
import { Toast, showToast } from "@zodecode/zode-ui/toast"
import { ResizeHandle } from "@zodecode/zode-ui/resize-handle"
import { Icon } from "@zodecode/zode-ui/icon"
import { Button } from "@zodecode/zode-ui/button"
import { IconButton } from "@zodecode/zode-ui/icon-button"
import { Spinner } from "@zodecode/zode-ui/spinner"
import { Tooltip, TooltipKeybind } from "@zodecode/zode-ui/tooltip"
import { Popover } from "@zodecode/zode-ui/popover"
...
import { ZodeEmbeddingModelsProvider } from "../src/context/zode-embedding-models"
  ...
  onMount(() => {
    ...
    const unsub = vscode.onMessage((msg) => {
      ...
      if (msg.type === "agentManager.state") {
        ...
        // When not a git repo, also mark sessions as loaded since the Zode
      ...
      // to send the prompt through the normal ZodeProvider sendMessage path.
