 ...
 * ## Why this exists
 *
 * The sidebar ZodeProvider always uses `getWorkspaceDirectory()`, which returns
 ...
 *
 * ## How ZodeProvider uses this
 *
 * Each ZodeProvider instance can receive an explicit `projectDirectory` via
 * `ZodeProviderOptions`. When set:
 *
...
/**
 * Resolve the effective project directory for a ZodeProvider instance.
 *
 * @param override - Explicit directory from ZodeProviderOptions. `undefined`
 ...
 *   `getWorkspaceDirectory(sessionId)` from ZodeProvider).
 */
