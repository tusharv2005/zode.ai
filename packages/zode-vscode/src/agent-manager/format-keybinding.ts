...
const AM_PREFIX = "zode-code.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "zode-code.new.agentManagerOpen": "agentManagerOpen",
  "zode-code.new.cycleAgentMode": "cycleAgentMode",
  "zode-code.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
