...
async function prompt(client: ZodeClient, sid: string, dir: string, task: ToolTask) {
...
async function local(deps: ToolDeps, client: ZodeClient, task: ToolTask, directory?: string) {
