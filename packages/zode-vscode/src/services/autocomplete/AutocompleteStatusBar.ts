...
const SUPPORTED_PROVIDER_DISPLAY_NAME = "Zode Gateway"
const SETTINGS_COMMAND = `command:zode-code.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
...
export class AutocompleteStatusBar {
  ...
  private init() {
    this.statusBar.text = t("zodecode:autocomplete.statusBar.enabled")
    this.statusBar.tooltip = this.createMarkdownTooltip(t("zodecode:autocomplete.statusBar.tooltip.basic"))
    this.statusBar.show()
  }
  ...
  private renderDefault() {
    ...
    const snoozedSuffix = this.props.snoozed ? ` (${t("zodecode:autocomplete.statusBar.snoozed")})` : ""
    this.statusBar.text = `${t("zodecode:autocomplete.statusBar.enabled")} (${this.props.completionCount})${snoozedSuffix}`

    this.statusBar.tooltip = this.createMarkdownTooltip(
      [
        t("zodecode:autocomplete.statusBar.tooltip.completionSummary", {
        ...
        this.props.model && this.props.provider
          ? t("zodecode:autocomplete.statusBar.tooltip.providerInfo", {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("zodecode:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("zodecode:autocomplete.statusBar.tooltip.noUsableProvider", {
