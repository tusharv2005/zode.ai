...
const INLINE_COMPLETION_ACCEPTED_COMMAND = "zode-code.new.autocomplete.nextEdit.accepted"
const DEFAULT_DEBOUNCE_MS = 250

export interface NextEditProviderDeps {
  /** Routes Mercury calls through the local Zode gateway (handles auth + BYOK). */
  connectionService: ZodeConnectionService
  /** Optional source of recently-viewed snippets (zodecode's VisibleCodeTracker can adapt to this). */
