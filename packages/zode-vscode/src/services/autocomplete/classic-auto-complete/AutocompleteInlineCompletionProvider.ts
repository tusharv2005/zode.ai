 ...
 */
export const INLINE_COMPLETION_ACCEPTED_COMMAND = "zodecode.autocomplete.inline-completion.accepted"
...
export class AutocompleteInlineCompletionProvider implements vscode.InlineCompletionItemProvider {
  ...
  private connectionService: ZodeConnectionService
  ...
  public async provideInlineCompletionItems_Internal(
    ...
    try {
      ...
      if (matchingResult !== null) {
        ...
        vscode.commands.executeCommand("setContext", "zode-code.new.autocomplete.hasSuggestions", true)
  ...
  private async hasBalance(): Promise<boolean> {
    try {
      ...
      const result = await client.zode.profile().catch(() => null)
