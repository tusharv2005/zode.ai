...
export class InstallationDetector {
   ...
   *
   * Agents are detected from .zode/agents/*.md files.
   * MCP servers and modes are detected from zode.json config files.
  ...
  /** Scan .zode/agents/*.md files to detect installed marketplace agents. */
  ...
  /** Read mcp and agent entries from a zode.json config file. */
