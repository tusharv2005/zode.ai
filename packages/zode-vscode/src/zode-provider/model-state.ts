 ...
 *
 * Reads/writes ~/.local/state/zode/model.json (same file the CLI TUI uses)
...
async function resolve(client: ZodeClient | null): Promise<string | undefined> {
...
async function read(client: ZodeClient | null): Promise<Record<string, unknown>> {
...
function write(client: ZodeClient | null, key: string, value: unknown): Promise<void> {
...
export async function reset(client: ZodeClient | null, post: PostMessage): Promise<void> {
